...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000f02:	2a2080e7          	jalr	674(ra) # 800061a0 <plicinithart>
  }
  ...
  scheduler();        
    ...
    80000f82:	20c080e7          	jalr	524(ra) # 8000618a <plicinit>
    plicinithart();  // ask PLIC for device interrupts
    80000f86:	00005097          	auipc	ra,0x5
    80000f8a:	21a080e7          	jalr	538(ra) # 800061a0 <plicinithart>
    binit();         // buffer cache
    80000f8e:	00002097          	auipc	ra,0x2
    80000f92:	37c080e7          	jalr	892(ra) # 8000330a <binit>
    iinit();         // inode cache
    80000f96:	00003097          	auipc	ra,0x3
    80000f9a:	a0c080e7          	jalr	-1524(ra) # 800039a2 <iinit>
    fileinit();      // file table
    80000f9e:	00004097          	auipc	ra,0x4
    80000fa2:	9c0080e7          	jalr	-1600(ra) # 8000495e <fileinit>
    virtio_disk_init(); // emulated hard disk
    80000fa6:	00005097          	auipc	ra,0x5
    80000faa:	31c080e7          	jalr	796(ra) # 800062c2 <virtio_disk_init>
    userinit();      // first user process
...
0000000080001a46 <forkret>:
{
  ...
  usertrapret();
    ...
    80001a86:	ea0080e7          	jalr	-352(ra) # 80003922 <fsinit>
...
0000000080001d26 <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001d9c:	5ba080e7          	jalr	1466(ra) # 80004352 <namei>
...
0000000080001e46 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001f0a:	aea080e7          	jalr	-1302(ra) # 800049f0 <filedup>
  ...
  np->cwd = idup(p->cwd);
    ...
    80001f22:	c3e080e7          	jalr	-962(ra) # 80003b5c <idup>
...
000000008000215e <exit>:
{
  ...
  if(p == initproc)
    ...
    800021aa:	89c080e7          	jalr	-1892(ra) # 80004a42 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    800021c2:	3b0080e7          	jalr	944(ra) # 8000456e <begin_op>
  iput(p->cwd);
    ...
    800021d2:	b86080e7          	jalr	-1146(ra) # 80003d54 <iput>
  end_op();
    800021d6:	00002097          	auipc	ra,0x2
    800021da:	418080e7          	jalr	1048(ra) # 800045ee <end_op>
  p->cwd = 0;
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002724:	9b078793          	addi	a5,a5,-1616 # 800060d0 <kernelvec>
...
usertrapret(void)
{
  ...
  p->trapframe->kernel_trap = (uint64)usertrap;
    ...
    80002786:	23268693          	addi	a3,a3,562 # 800029b4 <usertrap>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    8000284e:	98e080e7          	jalr	-1650(ra) # 800061d8 <plic_claim>
    ...
    8000287c:	984080e7          	jalr	-1660(ra) # 800061fc <plic_complete>
    return 1;
    ...
    80002892:	e00080e7          	jalr	-512(ra) # 8000668e <virtio_disk_intr>
...
00000000800028ba <store_thrd_context>:
...
void store_thrd_context(int context_id){
  ...
  struct trapframe* mytrapframe = myproc()->trapframe;
    ...
    800028cc:	146080e7          	jalr	326(ra) # 80001a0e <myproc>
    800028d0:	6785                	lui	a5,0x1
    800028d2:	953e                	add	a0,a0,a5
    800028d4:	0a853903          	ld	s2,168(a0)
  struct thrd_context_data* mythrd_context = myproc()->thrdstop_context;
    800028d8:	fffff097          	auipc	ra,0xfffff
    800028dc:	136080e7          	jalr	310(ra) # 80001a0e <myproc>
    800028e0:	05050513          	addi	a0,a0,80

  mythrd_context[context_id].s_regs[0] = mytrapframe->s0;
    800028e4:	04a2                	slli	s1,s1,0x8
    800028e6:	9526                	add	a0,a0,s1
    800028e8:	06093783          	ld	a5,96(s2)
    800028ec:	e11c                	sd	a5,0(a0)
  mythrd_context[context_id].s_regs[1] = mytrapframe->s1;
    800028ee:	06893783          	ld	a5,104(s2)
    800028f2:	e51c                	sd	a5,8(a0)
  mythrd_context[context_id].s_regs[2] = mytrapframe->s2;
    800028f4:	0b093783          	ld	a5,176(s2)
    800028f8:	e91c                	sd	a5,16(a0)
  mythrd_context[context_id].s_regs[3] = mytrapframe->s3;
    800028fa:	0b893783          	ld	a5,184(s2)
    800028fe:	ed1c                	sd	a5,24(a0)
  mythrd_context[context_id].s_regs[4] = mytrapframe->s4;
    80002900:	0c093783          	ld	a5,192(s2)
    80002904:	f11c                	sd	a5,32(a0)
  mythrd_context[context_id].s_regs[5] = mytrapframe->s5;
    80002906:	0c893783          	ld	a5,200(s2)
    8000290a:	f51c                	sd	a5,40(a0)
  mythrd_context[context_id].s_regs[6] = mytrapframe->s6;
    8000290c:	0d093783          	ld	a5,208(s2)
    80002910:	f91c                	sd	a5,48(a0)
  mythrd_context[context_id].s_regs[7] = mytrapframe->s7;
    80002912:	0d893783          	ld	a5,216(s2)
    80002916:	fd1c                	sd	a5,56(a0)
  mythrd_context[context_id].s_regs[8] = mytrapframe->s8;
    80002918:	0e093783          	ld	a5,224(s2)
    8000291c:	e13c                	sd	a5,64(a0)
  mythrd_context[context_id].s_regs[9] = mytrapframe->s9;
    8000291e:	0e893783          	ld	a5,232(s2)
    80002922:	e53c                	sd	a5,72(a0)
  mythrd_context[context_id].s_regs[10] = mytrapframe->s10;
    80002924:	0f093783          	ld	a5,240(s2)
    80002928:	e93c                	sd	a5,80(a0)
  mythrd_context[context_id].s_regs[11] = mytrapframe->s11;
    8000292a:	0f893783          	ld	a5,248(s2)
    8000292e:	ed3c                	sd	a5,88(a0)

  mythrd_context[context_id].ra = mytrapframe->ra;
    80002930:	02893783          	ld	a5,40(s2)
    80002934:	f13c                	sd	a5,96(a0)
  mythrd_context[context_id].sp = mytrapframe->sp;
    80002936:	03093783          	ld	a5,48(s2)
    8000293a:	f53c                	sd	a5,104(a0)

  mythrd_context[context_id].t_regs[0] = mytrapframe->t0;
    8000293c:	04893783          	ld	a5,72(s2)
    80002940:	f93c                	sd	a5,112(a0)
  mythrd_context[context_id].t_regs[1] = mytrapframe->t1;
    80002942:	05093783          	ld	a5,80(s2)
    80002946:	fd3c                	sd	a5,120(a0)
  mythrd_context[context_id].t_regs[2] = mytrapframe->t2;
    80002948:	05893783          	ld	a5,88(s2)
    8000294c:	e15c                	sd	a5,128(a0)
  mythrd_context[context_id].t_regs[3] = mytrapframe->t3;
    8000294e:	10093783          	ld	a5,256(s2)
    80002952:	e55c                	sd	a5,136(a0)
  mythrd_context[context_id].t_regs[4] = mytrapframe->t4;
    80002954:	10893783          	ld	a5,264(s2)
    80002958:	e95c                	sd	a5,144(a0)
  mythrd_context[context_id].t_regs[5] = mytrapframe->t5;
    8000295a:	11093783          	ld	a5,272(s2)
    8000295e:	ed5c                	sd	a5,152(a0)
  mythrd_context[context_id].t_regs[6] = mytrapframe->t6;
    80002960:	11893783          	ld	a5,280(s2)
    80002964:	f15c                	sd	a5,160(a0)

  mythrd_context[context_id].a_regs[0] = mytrapframe->a0;
    80002966:	07093783          	ld	a5,112(s2)
    8000296a:	f55c                	sd	a5,168(a0)
  mythrd_context[context_id].a_regs[1] = mytrapframe->a1;
    8000296c:	07893783          	ld	a5,120(s2)
    80002970:	f95c                	sd	a5,176(a0)
  mythrd_context[context_id].a_regs[2] = mytrapframe->a2;
    80002972:	08093783          	ld	a5,128(s2)
    80002976:	fd5c                	sd	a5,184(a0)
  mythrd_context[context_id].a_regs[3] = mytrapframe->a3;
    80002978:	08893783          	ld	a5,136(s2)
    8000297c:	e17c                	sd	a5,192(a0)
  mythrd_context[context_id].a_regs[4] = mytrapframe->a4;
    8000297e:	09093783          	ld	a5,144(s2)
    80002982:	e57c                	sd	a5,200(a0)
  mythrd_context[context_id].a_regs[5] = mytrapframe->a5;
    80002984:	09893783          	ld	a5,152(s2)
    80002988:	e97c                	sd	a5,208(a0)
  mythrd_context[context_id].a_regs[6] = mytrapframe->a6;
    8000298a:	0a093783          	ld	a5,160(s2)
    8000298e:	ed7c                	sd	a5,216(a0)
  mythrd_context[context_id].a_regs[7] = mytrapframe->a7;
    80002990:	0a893783          	ld	a5,168(s2)
    80002994:	f17c                	sd	a5,224(a0)

  mythrd_context[context_id].gp = mytrapframe->gp;
    80002996:	03893783          	ld	a5,56(s2)
    8000299a:	f57c                	sd	a5,232(a0)
  mythrd_context[context_id].tp = mytrapframe->tp;
    8000299c:	04093783          	ld	a5,64(s2)
    800029a0:	f97c                	sd	a5,240(a0)
  mythrd_context[context_id].epc = mytrapframe->epc;
    800029a2:	01893783          	ld	a5,24(s2)
...
00000000800029b4 <usertrap>:
{
  ...
  if((r_sstatus() & SSTATUS_SPP) != 0)
    ...
    800029c8:	e7ad                	bnez	a5,80002a32 <usertrap+0x7e>
  asm volatile("csrw stvec, %0" : : "r" (x));
    800029ca:	00003797          	auipc	a5,0x3
    800029ce:	70678793          	addi	a5,a5,1798 # 800060d0 <kernelvec>
    800029d2:	10579073          	csrw	stvec,a5
  struct proc *p = myproc();
    800029d6:	fffff097          	auipc	ra,0xfffff
    800029da:	038080e7          	jalr	56(ra) # 80001a0e <myproc>
    800029de:	84aa                	mv	s1,a0
  p->trapframe->epc = r_sepc();
    800029e0:	6785                	lui	a5,0x1
    800029e2:	97aa                	add	a5,a5,a0
    800029e4:	77dc                	ld	a5,168(a5)
  ...
  if(r_scause() == 8){
    ...
    800029f2:	04f71e63          	bne	a4,a5,80002a4e <usertrap+0x9a>
    if(p->killed)
    800029f6:	591c                	lw	a5,48(a0)
    800029f8:	e7a9                	bnez	a5,80002a42 <usertrap+0x8e>
    p->trapframe->epc += 4;
    800029fa:	6785                	lui	a5,0x1
    800029fc:	97a6                	add	a5,a5,s1
    800029fe:	77d8                	ld	a4,168(a5)
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002a16:	3da080e7          	jalr	986(ra) # 80002dec <syscall>
  if(p->killed)
    80002a1a:	589c                	lw	a5,48(s1)
    80002a1c:	e3d5                	bnez	a5,80002ac0 <usertrap+0x10c>
  usertrapret();
    80002a1e:	00000097          	auipc	ra,0x0
    80002a22:	d14080e7          	jalr	-748(ra) # 80002732 <usertrapret>
}
    ...
    80002a36:	8be50513          	addi	a0,a0,-1858 # 800082f0 <states.0+0x50>
    80002a3a:	ffffe097          	auipc	ra,0xffffe
    80002a3e:	b10080e7          	jalr	-1264(ra) # 8000054a <panic>
      exit(-1);
    80002a42:	557d                	li	a0,-1
    80002a44:	fffff097          	auipc	ra,0xfffff
    80002a48:	71a080e7          	jalr	1818(ra) # 8000215e <exit>
    80002a4c:	b77d                	j	800029fa <usertrap+0x46>
  } else if((which_dev = devintr()) != 0){
    80002a4e:	00000097          	auipc	ra,0x0
    80002a52:	dca080e7          	jalr	-566(ra) # 80002818 <devintr>
    80002a56:	892a                	mv	s2,a0
    80002a58:	c501                	beqz	a0,80002a60 <usertrap+0xac>
  if(p->killed)
    80002a5a:	589c                	lw	a5,48(s1)
    80002a5c:	c3a1                	beqz	a5,80002a9c <usertrap+0xe8>
    80002a5e:	a815                	j	80002a92 <usertrap+0xde>
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002a60:	142025f3          	csrr	a1,scause
    printf("usertrap(): unexpected scause %p pid=%d\n", r_scause(), p->pid);
    80002a64:	5c90                	lw	a2,56(s1)
    80002a66:	00006517          	auipc	a0,0x6
    80002a6a:	8aa50513          	addi	a0,a0,-1878 # 80008310 <states.0+0x70>
    80002a6e:	ffffe097          	auipc	ra,0xffffe
    80002a72:	b26080e7          	jalr	-1242(ra) # 80000594 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002a82:	8c250513          	addi	a0,a0,-1854 # 80008340 <states.0+0xa0>
    80002a86:	ffffe097          	auipc	ra,0xffffe
    80002a8a:	b0e080e7          	jalr	-1266(ra) # 80000594 <printf>
    p->killed = 1;
    80002a8e:	4785                	li	a5,1
    80002a90:	d89c                	sw	a5,48(s1)
    exit(-1);
    80002a92:	557d                	li	a0,-1
    80002a94:	fffff097          	auipc	ra,0xfffff
    80002a98:	6ca080e7          	jalr	1738(ra) # 8000215e <exit>
  if(which_dev == 2)
    80002a9c:	4789                	li	a5,2
    80002a9e:	f8f910e3          	bne	s2,a5,80002a1e <usertrap+0x6a>
    if (p->thrdstop_interval != -1){
    80002aa2:	40bc                	lw	a5,64(s1)
    80002aa4:	577d                	li	a4,-1
    80002aa6:	00e78563          	beq	a5,a4,80002ab0 <usertrap+0xfc>
      p->thrdstop_ticks += 1;
    80002aaa:	5cd8                	lw	a4,60(s1)
    80002aac:	2705                	addiw	a4,a4,1
    80002aae:	dcd8                	sw	a4,60(s1)
    if (p->thrdstop_ticks == p->thrdstop_interval){
    80002ab0:	5cd8                	lw	a4,60(s1)
    80002ab2:	00f70963          	beq	a4,a5,80002ac4 <usertrap+0x110>
    yield();
    80002ab6:	fffff097          	auipc	ra,0xfffff
    80002aba:	7be080e7          	jalr	1982(ra) # 80002274 <yield>
    80002abe:	b785                	j	80002a1e <usertrap+0x6a>
  int which_dev = 0;
    80002ac0:	4901                	li	s2,0
    80002ac2:	bfc1                	j	80002a92 <usertrap+0xde>
      store_thrd_context(p->thrdstop_context_id);
    80002ac4:	40e8                	lw	a0,68(s1)
    80002ac6:	00000097          	auipc	ra,0x0
    80002aca:	df4080e7          	jalr	-524(ra) # 800028ba <store_thrd_context>
      p->thrdstop_context_used[p->thrdstop_context_id] = 1;
    80002ace:	40fc                	lw	a5,68(s1)
    80002ad0:	41478793          	addi	a5,a5,1044 # 1414 <_entry-0x7fffebec>
    80002ad4:	078a                	slli	a5,a5,0x2
    80002ad6:	97a6                	add	a5,a5,s1
    80002ad8:	4705                	li	a4,1
    80002ada:	c398                	sw	a4,0(a5)
      p->thrdstop_interval = -1;
    80002adc:	57fd                	li	a5,-1
    80002ade:	c0bc                	sw	a5,64(s1)
      p->trapframe->epc = p->thrdstop_handler_pointer;
    80002ae0:	6785                	lui	a5,0x1
    80002ae2:	97a6                	add	a5,a5,s1
    80002ae4:	77dc                	ld	a5,168(a5)
    80002ae6:	64b8                	ld	a4,72(s1)
    80002ae8:	ef98                	sd	a4,24(a5)
    80002aea:	b7f1                	j	80002ab6 <usertrap+0x102>

0000000080002aec <kerneltrap>:
{
  ...
  asm volatile("csrr %0, sepc" : "=r" (x) );
    80002afa:	14102973          	csrr	s2,sepc
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002afe:	100024f3          	csrr	s1,sstatus
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002b02:	142029f3          	csrr	s3,scause
  if((sstatus & SSTATUS_SPP) == 0)
    80002b06:	1004f793          	andi	a5,s1,256
    80002b0a:	cb85                	beqz	a5,80002b3a <kerneltrap+0x4e>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002b0c:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80002b10:	8b89                	andi	a5,a5,2
  if(intr_get() != 0)
    80002b12:	ef85                	bnez	a5,80002b4a <kerneltrap+0x5e>
  if((which_dev = devintr()) == 0){
    80002b14:	00000097          	auipc	ra,0x0
    80002b18:	d04080e7          	jalr	-764(ra) # 80002818 <devintr>
    80002b1c:	cd1d                	beqz	a0,80002b5a <kerneltrap+0x6e>
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    80002b1e:	4789                	li	a5,2
    80002b20:	06f50a63          	beq	a0,a5,80002b94 <kerneltrap+0xa8>
  asm volatile("csrw sepc, %0" : : "r" (x));
    80002b24:	14191073          	csrw	sepc,s2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80002b28:	10049073          	csrw	sstatus,s1
}
    ...
    80002b3e:	82650513          	addi	a0,a0,-2010 # 80008360 <states.0+0xc0>
    80002b42:	ffffe097          	auipc	ra,0xffffe
    80002b46:	a08080e7          	jalr	-1528(ra) # 8000054a <panic>
    panic("kerneltrap: interrupts enabled");
    80002b4a:	00006517          	auipc	a0,0x6
    80002b4e:	83e50513          	addi	a0,a0,-1986 # 80008388 <states.0+0xe8>
    80002b52:	ffffe097          	auipc	ra,0xffffe
    80002b56:	9f8080e7          	jalr	-1544(ra) # 8000054a <panic>
    printf("scause %p\n", scause);
    80002b5a:	85ce                	mv	a1,s3
    80002b5c:	00006517          	auipc	a0,0x6
    80002b60:	84c50513          	addi	a0,a0,-1972 # 800083a8 <states.0+0x108>
    80002b64:	ffffe097          	auipc	ra,0xffffe
    80002b68:	a30080e7          	jalr	-1488(ra) # 80000594 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
    80002b6c:	141025f3          	csrr	a1,sepc
  asm volatile("csrr %0, stval" : "=r" (x) );
    80002b70:	14302673          	csrr	a2,stval
    printf("sepc=%p stval=%p\n", r_sepc(), r_stval());
    80002b74:	00006517          	auipc	a0,0x6
    80002b78:	84450513          	addi	a0,a0,-1980 # 800083b8 <states.0+0x118>
    80002b7c:	ffffe097          	auipc	ra,0xffffe
    80002b80:	a18080e7          	jalr	-1512(ra) # 80000594 <printf>
    panic("kerneltrap");
    80002b84:	00006517          	auipc	a0,0x6
    80002b88:	84c50513          	addi	a0,a0,-1972 # 800083d0 <states.0+0x130>
    80002b8c:	ffffe097          	auipc	ra,0xffffe
    80002b90:	9be080e7          	jalr	-1602(ra) # 8000054a <panic>
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    80002b94:	fffff097          	auipc	ra,0xfffff
    80002b98:	e7a080e7          	jalr	-390(ra) # 80001a0e <myproc>
    80002b9c:	d541                	beqz	a0,80002b24 <kerneltrap+0x38>
    80002b9e:	fffff097          	auipc	ra,0xfffff
    80002ba2:	e70080e7          	jalr	-400(ra) # 80001a0e <myproc>
    80002ba6:	4d18                	lw	a4,24(a0)
    80002ba8:	478d                	li	a5,3
    80002baa:	f6f71de3          	bne	a4,a5,80002b24 <kerneltrap+0x38>
    if (myproc()->thrdstop_interval != -1){
    80002bae:	fffff097          	auipc	ra,0xfffff
    80002bb2:	e60080e7          	jalr	-416(ra) # 80001a0e <myproc>
    80002bb6:	4138                	lw	a4,64(a0)
    80002bb8:	57fd                	li	a5,-1
    80002bba:	02f71463          	bne	a4,a5,80002be2 <kerneltrap+0xf6>
    if (myproc()->thrdstop_ticks == myproc()->thrdstop_interval){
    80002bbe:	fffff097          	auipc	ra,0xfffff
    80002bc2:	e50080e7          	jalr	-432(ra) # 80001a0e <myproc>
    80002bc6:	03c52983          	lw	s3,60(a0)
    80002bca:	fffff097          	auipc	ra,0xfffff
    80002bce:	e44080e7          	jalr	-444(ra) # 80001a0e <myproc>
    80002bd2:	413c                	lw	a5,64(a0)
    80002bd4:	01378f63          	beq	a5,s3,80002bf2 <kerneltrap+0x106>
    yield();
    80002bd8:	fffff097          	auipc	ra,0xfffff
    80002bdc:	69c080e7          	jalr	1692(ra) # 80002274 <yield>
    80002be0:	b791                	j	80002b24 <kerneltrap+0x38>
      myproc()->thrdstop_ticks += 1;
    80002be2:	fffff097          	auipc	ra,0xfffff
    80002be6:	e2c080e7          	jalr	-468(ra) # 80001a0e <myproc>
    80002bea:	5d5c                	lw	a5,60(a0)
    80002bec:	2785                	addiw	a5,a5,1
    80002bee:	dd5c                	sw	a5,60(a0)
    80002bf0:	b7f9                	j	80002bbe <kerneltrap+0xd2>
      store_thrd_context(myproc()->thrdstop_context_id);
    80002bf2:	fffff097          	auipc	ra,0xfffff
    80002bf6:	e1c080e7          	jalr	-484(ra) # 80001a0e <myproc>
    80002bfa:	4168                	lw	a0,68(a0)
    80002bfc:	00000097          	auipc	ra,0x0
    80002c00:	cbe080e7          	jalr	-834(ra) # 800028ba <store_thrd_context>
      myproc()->thrdstop_context_used[myproc()->thrdstop_context_id] = 1;
    80002c04:	fffff097          	auipc	ra,0xfffff
    80002c08:	e0a080e7          	jalr	-502(ra) # 80001a0e <myproc>
    80002c0c:	89aa                	mv	s3,a0
    80002c0e:	fffff097          	auipc	ra,0xfffff
    80002c12:	e00080e7          	jalr	-512(ra) # 80001a0e <myproc>
    80002c16:	417c                	lw	a5,68(a0)
    80002c18:	41478793          	addi	a5,a5,1044 # 1414 <_entry-0x7fffebec>
    80002c1c:	078a                	slli	a5,a5,0x2
    80002c1e:	99be                	add	s3,s3,a5
    80002c20:	4785                	li	a5,1
    80002c22:	00f9a023          	sw	a5,0(s3)
      myproc()->thrdstop_interval = -1;
    80002c26:	fffff097          	auipc	ra,0xfffff
    80002c2a:	de8080e7          	jalr	-536(ra) # 80001a0e <myproc>
    80002c2e:	57fd                	li	a5,-1
    80002c30:	c13c                	sw	a5,64(a0)
      myproc()->trapframe->epc = myproc()->thrdstop_handler_pointer;
    80002c32:	fffff097          	auipc	ra,0xfffff
    80002c36:	ddc080e7          	jalr	-548(ra) # 80001a0e <myproc>
    80002c3a:	89aa                	mv	s3,a0
    80002c3c:	fffff097          	auipc	ra,0xfffff
    80002c40:	dd2080e7          	jalr	-558(ra) # 80001a0e <myproc>
    80002c44:	6785                	lui	a5,0x1
    80002c46:	97aa                	add	a5,a5,a0
    80002c48:	77dc                	ld	a5,168(a5)
    80002c4a:	0489b703          	ld	a4,72(s3)
    80002c4e:	ef98                	sd	a4,24(a5)
    80002c50:	b761                	j	80002bd8 <kerneltrap+0xec>

0000000080002c52 <argraw>:
  return strlen(buf);
}
...
argraw(int n)
{
  ...
  struct proc *p = myproc();
    ...
    80002c62:	db0080e7          	jalr	-592(ra) # 80001a0e <myproc>
  switch (n) {
    80002c66:	4795                	li	a5,5
    80002c68:	0497ed63          	bltu	a5,s1,80002cc2 <argraw+0x70>
    80002c6c:	048a                	slli	s1,s1,0x2
    80002c6e:	00005717          	auipc	a4,0x5
    80002c72:	79a70713          	addi	a4,a4,1946 # 80008408 <states.0+0x168>
    80002c76:	94ba                	add	s1,s1,a4
  ...
  return -1;
    ...
    80002c98:	b7fd                	j	80002c86 <argraw+0x34>
    return p->trapframe->a2;
    80002c9a:	6785                	lui	a5,0x1
    80002c9c:	953e                	add	a0,a0,a5
    80002c9e:	755c                	ld	a5,168(a0)
    80002ca0:	63c8                	ld	a0,128(a5)
    80002ca2:	b7d5                	j	80002c86 <argraw+0x34>
    return p->trapframe->a3;
    80002ca4:	6785                	lui	a5,0x1
    80002ca6:	953e                	add	a0,a0,a5
    80002ca8:	755c                	ld	a5,168(a0)
    80002caa:	67c8                	ld	a0,136(a5)
    80002cac:	bfe9                	j	80002c86 <argraw+0x34>
    return p->trapframe->a4;
    80002cae:	6785                	lui	a5,0x1
    80002cb0:	953e                	add	a0,a0,a5
    80002cb2:	755c                	ld	a5,168(a0)
    80002cb4:	6bc8                	ld	a0,144(a5)
    80002cb6:	bfc1                	j	80002c86 <argraw+0x34>
    return p->trapframe->a5;
    80002cb8:	6785                	lui	a5,0x1
    80002cba:	953e                	add	a0,a0,a5
    80002cbc:	755c                	ld	a5,168(a0)
    80002cbe:	6fc8                	ld	a0,152(a5)
    80002cc0:	b7d9                	j	80002c86 <argraw+0x34>
  panic("argraw");
    80002cc2:	00005517          	auipc	a0,0x5
    80002cc6:	71e50513          	addi	a0,a0,1822 # 800083e0 <states.0+0x140>
    80002cca:	ffffe097          	auipc	ra,0xffffe
    80002cce:	880080e7          	jalr	-1920(ra) # 8000054a <panic>

0000000080002cd2 <fetchaddr>:
{
    ...
    80002ce0:	892e                	mv	s2,a1
  struct proc *p = myproc();
    80002ce2:	fffff097          	auipc	ra,0xfffff
    80002ce6:	d2c080e7          	jalr	-724(ra) # 80001a0e <myproc>
  if(addr >= p->sz || addr+sizeof(uint64) > p->sz)
    80002cea:	6785                	lui	a5,0x1
    80002cec:	97aa                	add	a5,a5,a0
    80002cee:	6fdc                	ld	a5,152(a5)
    80002cf0:	02f4fa63          	bgeu	s1,a5,80002d24 <fetchaddr+0x52>
    80002cf4:	00848713          	addi	a4,s1,8
    80002cf8:	02e7e863          	bltu	a5,a4,80002d28 <fetchaddr+0x56>
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    80002cfc:	6785                	lui	a5,0x1
    80002cfe:	97aa                	add	a5,a5,a0
    80002d00:	46a1                	li	a3,8
    80002d02:	8626                	mv	a2,s1
    80002d04:	85ca                	mv	a1,s2
    80002d06:	73c8                	ld	a0,160(a5)
    80002d08:	fffff097          	auipc	ra,0xfffff
    80002d0c:	a06080e7          	jalr	-1530(ra) # 8000170e <copyin>
    80002d10:	00a03533          	snez	a0,a0
    80002d14:	40a00533          	neg	a0,a0
}
    ...
    80002d26:	bfcd                	j	80002d18 <fetchaddr+0x46>
    80002d28:	557d                	li	a0,-1
    80002d2a:	b7fd                	j	80002d18 <fetchaddr+0x46>

0000000080002d2c <fetchstr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002d44:	cce080e7          	jalr	-818(ra) # 80001a0e <myproc>
  int err = copyinstr(p->pagetable, buf, addr, max);
    80002d48:	6785                	lui	a5,0x1
    80002d4a:	97aa                	add	a5,a5,a0
    80002d4c:	86ce                	mv	a3,s3
    80002d4e:	864a                	mv	a2,s2
    80002d50:	85a6                	mv	a1,s1
    80002d52:	73c8                	ld	a0,160(a5)
    80002d54:	fffff097          	auipc	ra,0xfffff
    80002d58:	a48080e7          	jalr	-1464(ra) # 8000179c <copyinstr>
  if(err < 0)
    80002d5c:	00054763          	bltz	a0,80002d6a <fetchstr+0x3e>
  return strlen(buf);
    80002d60:	8526                	mv	a0,s1
    80002d62:	ffffe097          	auipc	ra,0xffffe
    80002d66:	124080e7          	jalr	292(ra) # 80000e86 <strlen>
}
...
argint(int n, int *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002d88:	ece080e7          	jalr	-306(ra) # 80002c52 <argraw>
...
argaddr(int n, uint64 *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002daa:	eac080e7          	jalr	-340(ra) # 80002c52 <argraw>
...
argstr(int n, char *buf, int max)
{
  ...
  *ip = argraw(n);
    ...
    80002dd0:	e86080e7          	jalr	-378(ra) # 80002c52 <argraw>
  uint64 addr;
  if(argaddr(n, &addr) < 0)
    return -1;
  return fetchstr(addr, buf, max);
    ...
    80002ddc:	f54080e7          	jalr	-172(ra) # 80002d2c <fetchstr>
}
...
syscall(void)
{
  ...
  struct proc *p = myproc();
    ...
    80002dfc:	c16080e7          	jalr	-1002(ra) # 80001a0e <myproc>
    80002e00:	84aa                	mv	s1,a0

  num = p->trapframe->a7;
    80002e02:	6785                	lui	a5,0x1
    80002e04:	97aa                	add	a5,a5,a0
    80002e06:	0a87b903          	ld	s2,168(a5) # 10a8 <_entry-0x7fffef58>
    80002e0a:	0a893783          	ld	a5,168(s2)
    80002e0e:	0007869b          	sext.w	a3,a5
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80002e12:	37fd                	addiw	a5,a5,-1
    80002e14:	475d                	li	a4,23
    80002e16:	00f76f63          	bltu	a4,a5,80002e34 <syscall+0x48>
    80002e1a:	00369713          	slli	a4,a3,0x3
    80002e1e:	00005797          	auipc	a5,0x5
    80002e22:	60278793          	addi	a5,a5,1538 # 80008420 <syscalls>
    80002e26:	97ba                	add	a5,a5,a4
    80002e28:	639c                	ld	a5,0(a5)
    80002e2a:	c789                	beqz	a5,80002e34 <syscall+0x48>
    p->trapframe->a0 = syscalls[num]();
    80002e2c:	9782                	jalr	a5
    80002e2e:	06a93823          	sd	a0,112(s2)
    80002e32:	a015                	j	80002e56 <syscall+0x6a>
  } else {
    printf("%d %s: unknown sys call %d\n",
            p->pid, p->name, num);
    80002e34:	6905                	lui	s2,0x1
    80002e36:	1a890613          	addi	a2,s2,424 # 11a8 <_entry-0x7fffee58>
    printf("%d %s: unknown sys call %d\n",
    80002e3a:	9626                	add	a2,a2,s1
    80002e3c:	5c8c                	lw	a1,56(s1)
    80002e3e:	00005517          	auipc	a0,0x5
    80002e42:	5aa50513          	addi	a0,a0,1450 # 800083e8 <states.0+0x148>
    80002e46:	ffffd097          	auipc	ra,0xffffd
    80002e4a:	74e080e7          	jalr	1870(ra) # 80000594 <printf>
    p->trapframe->a0 = -1;
    80002e4e:	94ca                	add	s1,s1,s2
    80002e50:	74dc                	ld	a5,168(s1)
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002e74:	f08080e7          	jalr	-248(ra) # 80002d78 <argint>
    return -1;
  ...
  exit(n);
    ...
    80002e86:	2dc080e7          	jalr	732(ra) # 8000215e <exit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    ...
    80002ea2:	b70080e7          	jalr	-1168(ra) # 80001a0e <myproc>
}
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002ebc:	f8e080e7          	jalr	-114(ra) # 80001e46 <fork>
}
...
sys_wait(void)
{
  ...
  if(argaddr(0, &p) < 0)
    ...
    80002eda:	ec4080e7          	jalr	-316(ra) # 80002d9a <argaddr>
    80002ede:	87aa                	mv	a5,a0
    return -1;
    80002ee0:	557d                	li	a0,-1
  if(argaddr(0, &p) < 0)
    80002ee2:	0007c863          	bltz	a5,80002ef2 <sys_wait+0x2a>
  return wait(p);
    80002ee6:	fe843503          	ld	a0,-24(s0)
    80002eea:	fffff097          	auipc	ra,0xfffff
    80002eee:	444080e7          	jalr	1092(ra) # 8000232e <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002f0e:	e6e080e7          	jalr	-402(ra) # 80002d78 <argint>
    return -1;
    80002f12:	54fd                	li	s1,-1
  if(argint(0, &n) < 0)
    80002f14:	02054263          	bltz	a0,80002f38 <sys_sbrk+0x3e>
  addr = myproc()->sz;
    80002f18:	fffff097          	auipc	ra,0xfffff
    80002f1c:	af6080e7          	jalr	-1290(ra) # 80001a0e <myproc>
    80002f20:	6785                	lui	a5,0x1
    80002f22:	953e                	add	a0,a0,a5
    80002f24:	09852483          	lw	s1,152(a0)
  if(growproc(n) < 0)
    80002f28:	fdc42503          	lw	a0,-36(s0)
    80002f2c:	fffff097          	auipc	ra,0xfffff
    80002f30:	e94080e7          	jalr	-364(ra) # 80001dc0 <growproc>
    80002f34:	00054863          	bltz	a0,80002f44 <sys_sbrk+0x4a>
    return -1;
  return addr;
}
    ...
    80002f46:	bfcd                	j	80002f38 <sys_sbrk+0x3e>
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002f60:	e1c080e7          	jalr	-484(ra) # 80002d78 <argint>
    return -1;
    80002f64:	57fd                	li	a5,-1
  if(argint(0, &n) < 0)
    80002f66:	06054563          	bltz	a0,80002fd0 <sys_sleep+0x88>
  acquire(&tickslock);
    80002f6a:	00055517          	auipc	a0,0x55
    80002f6e:	53e50513          	addi	a0,a0,1342 # 800584a8 <tickslock>
    80002f72:	ffffe097          	auipc	ra,0xffffe
    80002f76:	c94080e7          	jalr	-876(ra) # 80000c06 <acquire>
  ticks0 = ticks;
    80002f7a:	00006917          	auipc	s2,0x6
    80002f7e:	0a692903          	lw	s2,166(s2) # 80009020 <ticks>
  while(ticks - ticks0 < n){
    80002f82:	fcc42783          	lw	a5,-52(s0)
    80002f86:	cf85                	beqz	a5,80002fbe <sys_sleep+0x76>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
    80002f88:	00055997          	auipc	s3,0x55
    80002f8c:	52098993          	addi	s3,s3,1312 # 800584a8 <tickslock>
    80002f90:	00006497          	auipc	s1,0x6
    80002f94:	09048493          	addi	s1,s1,144 # 80009020 <ticks>
    if(myproc()->killed){
    80002f98:	fffff097          	auipc	ra,0xfffff
    80002f9c:	a76080e7          	jalr	-1418(ra) # 80001a0e <myproc>
    80002fa0:	591c                	lw	a5,48(a0)
    80002fa2:	ef9d                	bnez	a5,80002fe0 <sys_sleep+0x98>
    sleep(&ticks, &tickslock);
    80002fa4:	85ce                	mv	a1,s3
    80002fa6:	8526                	mv	a0,s1
    80002fa8:	fffff097          	auipc	ra,0xfffff
    80002fac:	308080e7          	jalr	776(ra) # 800022b0 <sleep>
  while(ticks - ticks0 < n){
    80002fb0:	409c                	lw	a5,0(s1)
    80002fb2:	412787bb          	subw	a5,a5,s2
    80002fb6:	fcc42703          	lw	a4,-52(s0)
    80002fba:	fce7efe3          	bltu	a5,a4,80002f98 <sys_sleep+0x50>
  }
  release(&tickslock);
    80002fbe:	00055517          	auipc	a0,0x55
    80002fc2:	4ea50513          	addi	a0,a0,1258 # 800584a8 <tickslock>
    80002fc6:	ffffe097          	auipc	ra,0xffffe
    80002fca:	cf4080e7          	jalr	-780(ra) # 80000cba <release>
  return 0;
    ...
    80002fde:	8082                	ret
      release(&tickslock);
    80002fe0:	00055517          	auipc	a0,0x55
    80002fe4:	4c850513          	addi	a0,a0,1224 # 800584a8 <tickslock>
    80002fe8:	ffffe097          	auipc	ra,0xffffe
    80002fec:	cd2080e7          	jalr	-814(ra) # 80000cba <release>
      return -1;
    80002ff0:	57fd                	li	a5,-1
    80002ff2:	bff9                	j	80002fd0 <sys_sleep+0x88>
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    ...
    80003006:	d76080e7          	jalr	-650(ra) # 80002d78 <argint>
    8000300a:	87aa                	mv	a5,a0
    return -1;
    8000300c:	557d                	li	a0,-1
  if(argint(0, &pid) < 0)
    8000300e:	0007c863          	bltz	a5,8000301e <sys_kill+0x2a>
  return kill(pid);
    80003012:	fec42503          	lw	a0,-20(s0)
    80003016:	fffff097          	auipc	ra,0xfffff
    8000301a:	490080e7          	jalr	1168(ra) # 800024a6 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    80003030:	00055517          	auipc	a0,0x55
    80003034:	47850513          	addi	a0,a0,1144 # 800584a8 <tickslock>
    80003038:	ffffe097          	auipc	ra,0xffffe
    8000303c:	bce080e7          	jalr	-1074(ra) # 80000c06 <acquire>
  xticks = ticks;
    80003040:	00006497          	auipc	s1,0x6
    80003044:	fe04a483          	lw	s1,-32(s1) # 80009020 <ticks>
  release(&tickslock);
    80003048:	00055517          	auipc	a0,0x55
    8000304c:	46050513          	addi	a0,a0,1120 # 800584a8 <tickslock>
    80003050:	ffffe097          	auipc	ra,0xffffe
    80003054:	c6a080e7          	jalr	-918(ra) # 80000cba <release>
  return xticks;
}
...
sys_thrdstop(void)
{
  ...
  if (argint(0, &interval) < 0)
    80003074:	fdc40593          	addi	a1,s0,-36
    80003078:	4501                	li	a0,0
    8000307a:	00000097          	auipc	ra,0x0
    8000307e:	cfe080e7          	jalr	-770(ra) # 80002d78 <argint>
    return -1;
    80003082:	54fd                	li	s1,-1
  if (argint(0, &interval) < 0)
    80003084:	08054b63          	bltz	a0,8000311a <sys_thrdstop+0xb2>
  if (argint(1, &thrdstop_context_id) < 0)
    80003088:	fd840593          	addi	a1,s0,-40
    8000308c:	4505                	li	a0,1
    8000308e:	00000097          	auipc	ra,0x0
    80003092:	cea080e7          	jalr	-790(ra) # 80002d78 <argint>
    80003096:	08054263          	bltz	a0,8000311a <sys_thrdstop+0xb2>
    return -1;
  if (argaddr(2, &handler) < 0)
    8000309a:	fd040593          	addi	a1,s0,-48
    8000309e:	4509                	li	a0,2
    800030a0:	00000097          	auipc	ra,0x0
    800030a4:	cfa080e7          	jalr	-774(ra) # 80002d9a <argaddr>
    800030a8:	06054963          	bltz	a0,8000311a <sys_thrdstop+0xb2>
    return -1;
  myproc()->thrdstop_ticks = 0;
    800030ac:	fffff097          	auipc	ra,0xfffff
    800030b0:	962080e7          	jalr	-1694(ra) # 80001a0e <myproc>
    800030b4:	02052e23          	sw	zero,60(a0)
  ...
  if (thrdstop_context_id == -1){
    800030d4:	fd842703          	lw	a4,-40(s0)
    800030d8:	57fd                	li	a5,-1
    800030da:	02f71963          	bne	a4,a5,8000310c <sys_thrdstop+0xa4>
    for (int i = 0; i < MAX_THRD_NUM; i++){
    800030de:	4481                	li	s1,0
    800030e0:	4941                	li	s2,16
      if (myproc()->thrdstop_context_used[i] == 0){
    800030e2:	fffff097          	auipc	ra,0xfffff
    800030e6:	92c080e7          	jalr	-1748(ra) # 80001a0e <myproc>
    800030ea:	41448793          	addi	a5,s1,1044
    800030ee:	078a                	slli	a5,a5,0x2
    800030f0:	953e                	add	a0,a0,a5
    800030f2:	411c                	lw	a5,0(a0)
    800030f4:	c791                	beqz	a5,80003100 <sys_thrdstop+0x98>
    for (int i = 0; i < MAX_THRD_NUM; i++){
    800030f6:	2485                	addiw	s1,s1,1
    800030f8:	ff2495e3          	bne	s1,s2,800030e2 <sys_thrdstop+0x7a>
  ...
  return -1;
    800030fc:	54fd                	li	s1,-1
    800030fe:	a831                	j	8000311a <sys_thrdstop+0xb2>
        myproc()->thrdstop_context_id = i;
    80003100:	fffff097          	auipc	ra,0xfffff
    80003104:	90e080e7          	jalr	-1778(ra) # 80001a0e <myproc>
    80003108:	c164                	sw	s1,68(a0)
        return i;
    8000310a:	a801                	j	8000311a <sys_thrdstop+0xb2>
    myproc()->thrdstop_context_id = thrdstop_context_id;
    8000310c:	fffff097          	auipc	ra,0xfffff
    80003110:	902080e7          	jalr	-1790(ra) # 80001a0e <myproc>
    80003114:	fd842483          	lw	s1,-40(s0)
    80003118:	c164                	sw	s1,68(a0)
}
...
0000000080003128 <sys_cancelthrdstop>:
...
sys_cancelthrdstop(void)
{
  ...
  if (argint(0, &thrdstop_context_id) < 0)
    ...
    8000313a:	c42080e7          	jalr	-958(ra) # 80002d78 <argint>
    return -1;
    8000313e:	57fd                	li	a5,-1
  if (argint(0, &thrdstop_context_id) < 0)
    80003140:	02054163          	bltz	a0,80003162 <sys_cancelthrdstop+0x3a>

  myproc()->thrdstop_interval = -1;
    80003144:	fffff097          	auipc	ra,0xfffff
    80003148:	8ca080e7          	jalr	-1846(ra) # 80001a0e <myproc>
    8000314c:	57fd                	li	a5,-1
    8000314e:	c13c                	sw	a5,64(a0)
  if (thrdstop_context_id != -1){
    80003150:	fec42503          	lw	a0,-20(s0)
    80003154:	00f51c63          	bne	a0,a5,8000316c <sys_cancelthrdstop+0x44>
  ...
  return myproc()->thrdstop_ticks;
    ...
    8000315c:	8b6080e7          	jalr	-1866(ra) # 80001a0e <myproc>
    80003160:	5d5c                	lw	a5,60(a0)
}
    ...
    80003170:	74e080e7          	jalr	1870(ra) # 800028ba <store_thrd_context>
    myproc()->thrdstop_context_used[thrdstop_context_id] = 1;
    80003174:	fffff097          	auipc	ra,0xfffff
    80003178:	89a080e7          	jalr	-1894(ra) # 80001a0e <myproc>
    8000317c:	fec42783          	lw	a5,-20(s0)
    80003180:	41478793          	addi	a5,a5,1044 # 1414 <_entry-0x7fffebec>
    80003184:	078a                	slli	a5,a5,0x2
    80003186:	97aa                	add	a5,a5,a0
    80003188:	4705                	li	a4,1
    8000318a:	c398                	sw	a4,0(a5)
    8000318c:	b7f1                	j	80003158 <sys_cancelthrdstop+0x30>

000000008000318e <reload_thrd_context>:
...
void reload_thrd_context(int context_id){
  ...
  struct trapframe* mytrapframe = myproc()->trapframe;
    ...
    800031a0:	872080e7          	jalr	-1934(ra) # 80001a0e <myproc>
    800031a4:	6785                	lui	a5,0x1
    800031a6:	953e                	add	a0,a0,a5
    800031a8:	0a853903          	ld	s2,168(a0)
  struct thrd_context_data* mythrd_context = myproc()->thrdstop_context;
    800031ac:	fffff097          	auipc	ra,0xfffff
    800031b0:	862080e7          	jalr	-1950(ra) # 80001a0e <myproc>
    800031b4:	05050513          	addi	a0,a0,80

  mytrapframe->s0 = mythrd_context[context_id].s_regs[0];
    800031b8:	04a2                	slli	s1,s1,0x8
    800031ba:	9526                	add	a0,a0,s1
    800031bc:	611c                	ld	a5,0(a0)
    800031be:	06f93023          	sd	a5,96(s2)
  mytrapframe->s1 = mythrd_context[context_id].s_regs[1];
    800031c2:	651c                	ld	a5,8(a0)
    800031c4:	06f93423          	sd	a5,104(s2)
  mytrapframe->s2 = mythrd_context[context_id].s_regs[2];
    800031c8:	691c                	ld	a5,16(a0)
    800031ca:	0af93823          	sd	a5,176(s2)
  mytrapframe->s3 = mythrd_context[context_id].s_regs[3];
    800031ce:	6d1c                	ld	a5,24(a0)
    800031d0:	0af93c23          	sd	a5,184(s2)
  mytrapframe->s4 = mythrd_context[context_id].s_regs[4];
    800031d4:	711c                	ld	a5,32(a0)
    800031d6:	0cf93023          	sd	a5,192(s2)
  mytrapframe->s5 = mythrd_context[context_id].s_regs[5];
    800031da:	751c                	ld	a5,40(a0)
    800031dc:	0cf93423          	sd	a5,200(s2)
  mytrapframe->s6 = mythrd_context[context_id].s_regs[6];
    800031e0:	791c                	ld	a5,48(a0)
    800031e2:	0cf93823          	sd	a5,208(s2)
  mytrapframe->s7 = mythrd_context[context_id].s_regs[7];
    800031e6:	7d1c                	ld	a5,56(a0)
    800031e8:	0cf93c23          	sd	a5,216(s2)
  mytrapframe->s8 = mythrd_context[context_id].s_regs[8];
    800031ec:	613c                	ld	a5,64(a0)
    800031ee:	0ef93023          	sd	a5,224(s2)
  mytrapframe->s9 = mythrd_context[context_id].s_regs[9];
    800031f2:	653c                	ld	a5,72(a0)
    800031f4:	0ef93423          	sd	a5,232(s2)
  mytrapframe->s10 = mythrd_context[context_id].s_regs[10];
    800031f8:	693c                	ld	a5,80(a0)
    800031fa:	0ef93823          	sd	a5,240(s2)
  mytrapframe->s11 = mythrd_context[context_id].s_regs[11];
    800031fe:	6d3c                	ld	a5,88(a0)
    80003200:	0ef93c23          	sd	a5,248(s2)

  mytrapframe->ra = mythrd_context[context_id].ra;
    80003204:	713c                	ld	a5,96(a0)
    80003206:	02f93423          	sd	a5,40(s2)
  mytrapframe->sp = mythrd_context[context_id].sp;
    8000320a:	753c                	ld	a5,104(a0)
    8000320c:	02f93823          	sd	a5,48(s2)

  mytrapframe->t0 = mythrd_context[context_id].t_regs[0];
    80003210:	793c                	ld	a5,112(a0)
    80003212:	04f93423          	sd	a5,72(s2)
  mytrapframe->t1 = mythrd_context[context_id].t_regs[1];
    80003216:	7d3c                	ld	a5,120(a0)
    80003218:	04f93823          	sd	a5,80(s2)
  mytrapframe->t2 = mythrd_context[context_id].t_regs[2];
    8000321c:	615c                	ld	a5,128(a0)
    8000321e:	04f93c23          	sd	a5,88(s2)
  mytrapframe->t3 = mythrd_context[context_id].t_regs[3];
    80003222:	655c                	ld	a5,136(a0)
    80003224:	10f93023          	sd	a5,256(s2)
  mytrapframe->t4 = mythrd_context[context_id].t_regs[4];
    80003228:	695c                	ld	a5,144(a0)
    8000322a:	10f93423          	sd	a5,264(s2)
  mytrapframe->t5 = mythrd_context[context_id].t_regs[5];
    8000322e:	6d5c                	ld	a5,152(a0)
    80003230:	10f93823          	sd	a5,272(s2)
  mytrapframe->t6 = mythrd_context[context_id].t_regs[6];
    80003234:	715c                	ld	a5,160(a0)
    80003236:	10f93c23          	sd	a5,280(s2)

  mytrapframe->a0 = mythrd_context[context_id].a_regs[0];
    8000323a:	755c                	ld	a5,168(a0)
    8000323c:	06f93823          	sd	a5,112(s2)
  mytrapframe->a1 = mythrd_context[context_id].a_regs[1];
    80003240:	795c                	ld	a5,176(a0)
    80003242:	06f93c23          	sd	a5,120(s2)
  mytrapframe->a2 = mythrd_context[context_id].a_regs[2];
    80003246:	7d5c                	ld	a5,184(a0)
    80003248:	08f93023          	sd	a5,128(s2)
  mytrapframe->a3 = mythrd_context[context_id].a_regs[3];
    8000324c:	617c                	ld	a5,192(a0)
    8000324e:	08f93423          	sd	a5,136(s2)
  mytrapframe->a4 = mythrd_context[context_id].a_regs[4];
    80003252:	657c                	ld	a5,200(a0)
    80003254:	08f93823          	sd	a5,144(s2)
  mytrapframe->a5 = mythrd_context[context_id].a_regs[5];
    80003258:	697c                	ld	a5,208(a0)
    8000325a:	08f93c23          	sd	a5,152(s2)
  mytrapframe->a6 = mythrd_context[context_id].a_regs[6];
    8000325e:	6d7c                	ld	a5,216(a0)
    80003260:	0af93023          	sd	a5,160(s2)
  mytrapframe->a7 = mythrd_context[context_id].a_regs[7];
    80003264:	717c                	ld	a5,224(a0)
    80003266:	0af93423          	sd	a5,168(s2)

  mytrapframe->gp = mythrd_context[context_id].gp;
    8000326a:	757c                	ld	a5,232(a0)
    8000326c:	02f93c23          	sd	a5,56(s2)
  mytrapframe->tp = mythrd_context[context_id].tp;
    80003270:	797c                	ld	a5,240(a0)
    80003272:	04f93023          	sd	a5,64(s2)
  mytrapframe->epc = mythrd_context[context_id].epc;
    80003276:	7d7c                	ld	a5,248(a0)
    80003278:	00f93c23          	sd	a5,24(s2)
...
0000000080003288 <sys_thrdresume>:
{
  ...
  if (argint(0, &thrdstop_context_id) < 0)
    ...
    8000329a:	ae2080e7          	jalr	-1310(ra) # 80002d78 <argint>
    return -1;
    8000329e:	57fd                	li	a5,-1
  if (argint(0, &thrdstop_context_id) < 0)
    800032a0:	02054263          	bltz	a0,800032c4 <sys_thrdresume+0x3c>
  if (argint(1, &is_exit) < 0)
    800032a4:	fe840593          	addi	a1,s0,-24
    800032a8:	4505                	li	a0,1
    800032aa:	00000097          	auipc	ra,0x0
    800032ae:	ace080e7          	jalr	-1330(ra) # 80002d78 <argint>
    800032b2:	04054a63          	bltz	a0,80003306 <sys_thrdresume+0x7e>
  if (is_exit == 0){
    800032b6:	fe842703          	lw	a4,-24(s0)
    800032ba:	cb11                	beqz	a4,800032ce <sys_thrdresume+0x46>
  } else if (is_exit == 1){
    800032bc:	4685                	li	a3,1
    return -1;
    800032be:	57fd                	li	a5,-1
  } else if (is_exit == 1){
    800032c0:	00d70f63          	beq	a4,a3,800032de <sys_thrdresume+0x56>
}
    ...
    800032d6:	ebc080e7          	jalr	-324(ra) # 8000318e <reload_thrd_context>
    return -2;
    800032da:	57f9                	li	a5,-2
    800032dc:	b7e5                	j	800032c4 <sys_thrdresume+0x3c>
    myproc()->thrdstop_context_used[thrdstop_context_id] = 0;
    800032de:	ffffe097          	auipc	ra,0xffffe
    800032e2:	730080e7          	jalr	1840(ra) # 80001a0e <myproc>
    800032e6:	fec42783          	lw	a5,-20(s0)
    800032ea:	41478793          	addi	a5,a5,1044 # 1414 <_entry-0x7fffebec>
    800032ee:	078a                	slli	a5,a5,0x2
    800032f0:	97aa                	add	a5,a5,a0
    800032f2:	0007a023          	sw	zero,0(a5)
    myproc()->thrdstop_interval = -1;
    800032f6:	ffffe097          	auipc	ra,0xffffe
    800032fa:	718080e7          	jalr	1816(ra) # 80001a0e <myproc>
    800032fe:	57fd                	li	a5,-1
    80003300:	c13c                	sw	a5,64(a0)
  return 0;
    80003302:	4781                	li	a5,0
    80003304:	b7c1                	j	800032c4 <sys_thrdresume+0x3c>
    return -1;
    80003306:	57fd                	li	a5,-1
    80003308:	bf75                	j	800032c4 <sys_thrdresume+0x3c>

000000008000330a <binit>:
  struct buf head;
} bcache;
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    8000331a:	00005597          	auipc	a1,0x5
    8000331e:	1ce58593          	addi	a1,a1,462 # 800084e8 <syscalls+0xc8>
    80003322:	00055517          	auipc	a0,0x55
    80003326:	19e50513          	addi	a0,a0,414 # 800584c0 <bcache>
    8000332a:	ffffe097          	auipc	ra,0xffffe
    8000332e:	84c080e7          	jalr	-1972(ra) # 80000b76 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80003332:	0005d797          	auipc	a5,0x5d
    80003336:	18e78793          	addi	a5,a5,398 # 800604c0 <bcache+0x8000>
    8000333a:	0005d717          	auipc	a4,0x5d
    8000333e:	3ee70713          	addi	a4,a4,1006 # 80060728 <bcache+0x8268>
    80003342:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80003346:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    8000334a:	00055497          	auipc	s1,0x55
    8000334e:	18e48493          	addi	s1,s1,398 # 800584d8 <bcache+0x18>
    b->next = bcache.head.next;
    80003352:	893e                	mv	s2,a5
    b->prev = &bcache.head;
    80003354:	89ba                	mv	s3,a4
    initsleeplock(&b->lock, "buffer");
    80003356:	00005a17          	auipc	s4,0x5
    8000335a:	19aa0a13          	addi	s4,s4,410 # 800084f0 <syscalls+0xd0>
    b->next = bcache.head.next;
    8000335e:	2b893783          	ld	a5,696(s2)
    80003362:	e8bc                	sd	a5,80(s1)
    b->prev = &bcache.head;
    80003364:	0534b423          	sd	s3,72(s1)
    initsleeplock(&b->lock, "buffer");
    80003368:	85d2                	mv	a1,s4
    8000336a:	01048513          	addi	a0,s1,16
    8000336e:	00001097          	auipc	ra,0x1
    80003372:	4c6080e7          	jalr	1222(ra) # 80004834 <initsleeplock>
    bcache.head.next->prev = b;
    80003376:	2b893783          	ld	a5,696(s2)
    8000337a:	e7a4                	sd	s1,72(a5)
    bcache.head.next = b;
    8000337c:	2a993c23          	sd	s1,696(s2)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80003380:	45848493          	addi	s1,s1,1112
    80003384:	fd349de3          	bne	s1,s3,8000335e <binit+0x54>
  }
}
...
bread(uint dev, uint blockno)
{
    ...
    800033a8:	89ae                	mv	s3,a1
  acquire(&bcache.lock);
    800033aa:	00055517          	auipc	a0,0x55
    800033ae:	11650513          	addi	a0,a0,278 # 800584c0 <bcache>
    800033b2:	ffffe097          	auipc	ra,0xffffe
    800033b6:	854080e7          	jalr	-1964(ra) # 80000c06 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    800033ba:	0005d497          	auipc	s1,0x5d
    800033be:	3be4b483          	ld	s1,958(s1) # 80060778 <bcache+0x82b8>
    800033c2:	0005d797          	auipc	a5,0x5d
    800033c6:	36678793          	addi	a5,a5,870 # 80060728 <bcache+0x8268>
    800033ca:	02f48f63          	beq	s1,a5,80003408 <bread+0x70>
    800033ce:	873e                	mv	a4,a5
    800033d0:	a021                	j	800033d8 <bread+0x40>
    800033d2:	68a4                	ld	s1,80(s1)
    800033d4:	02e48a63          	beq	s1,a4,80003408 <bread+0x70>
    if(b->dev == dev && b->blockno == blockno){
    800033d8:	449c                	lw	a5,8(s1)
    800033da:	ff279ce3          	bne	a5,s2,800033d2 <bread+0x3a>
    800033de:	44dc                	lw	a5,12(s1)
    800033e0:	ff3799e3          	bne	a5,s3,800033d2 <bread+0x3a>
      b->refcnt++;
    800033e4:	40bc                	lw	a5,64(s1)
    800033e6:	2785                	addiw	a5,a5,1
    800033e8:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    800033ea:	00055517          	auipc	a0,0x55
    800033ee:	0d650513          	addi	a0,a0,214 # 800584c0 <bcache>
    800033f2:	ffffe097          	auipc	ra,0xffffe
    800033f6:	8c8080e7          	jalr	-1848(ra) # 80000cba <release>
      acquiresleep(&b->lock);
    800033fa:	01048513          	addi	a0,s1,16
    800033fe:	00001097          	auipc	ra,0x1
    80003402:	470080e7          	jalr	1136(ra) # 8000486e <acquiresleep>
      return b;
    80003406:	a8b9                	j	80003464 <bread+0xcc>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80003408:	0005d497          	auipc	s1,0x5d
    8000340c:	3684b483          	ld	s1,872(s1) # 80060770 <bcache+0x82b0>
    80003410:	0005d797          	auipc	a5,0x5d
    80003414:	31878793          	addi	a5,a5,792 # 80060728 <bcache+0x8268>
    80003418:	00f48863          	beq	s1,a5,80003428 <bread+0x90>
    8000341c:	873e                	mv	a4,a5
    if(b->refcnt == 0) {
    8000341e:	40bc                	lw	a5,64(s1)
    80003420:	cf81                	beqz	a5,80003438 <bread+0xa0>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80003422:	64a4                	ld	s1,72(s1)
    80003424:	fee49de3          	bne	s1,a4,8000341e <bread+0x86>
  panic("bget: no buffers");
    80003428:	00005517          	auipc	a0,0x5
    8000342c:	0d050513          	addi	a0,a0,208 # 800084f8 <syscalls+0xd8>
    80003430:	ffffd097          	auipc	ra,0xffffd
    80003434:	11a080e7          	jalr	282(ra) # 8000054a <panic>
      b->dev = dev;
    80003438:	0124a423          	sw	s2,8(s1)
      b->blockno = blockno;
    8000343c:	0134a623          	sw	s3,12(s1)
      b->valid = 0;
    80003440:	0004a023          	sw	zero,0(s1)
      b->refcnt = 1;
    80003444:	4785                	li	a5,1
    80003446:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    80003448:	00055517          	auipc	a0,0x55
    8000344c:	07850513          	addi	a0,a0,120 # 800584c0 <bcache>
    80003450:	ffffe097          	auipc	ra,0xffffe
    80003454:	86a080e7          	jalr	-1942(ra) # 80000cba <release>
      acquiresleep(&b->lock);
    80003458:	01048513          	addi	a0,s1,16
    8000345c:	00001097          	auipc	ra,0x1
    80003460:	412080e7          	jalr	1042(ra) # 8000486e <acquiresleep>
  struct buf *b;

  b = bget(dev, blockno);
  if(!b->valid) {
    80003464:	409c                	lw	a5,0(s1)
    80003466:	cb89                	beqz	a5,80003478 <bread+0xe0>
    virtio_disk_rw(b, 0);
    b->valid = 1;
  }
  return b;
    ...
    80003480:	f8a080e7          	jalr	-118(ra) # 80006406 <virtio_disk_rw>
    b->valid = 1;
    80003484:	4785                	li	a5,1
    80003486:	c09c                	sw	a5,0(s1)
  return b;
    80003488:	b7c5                	j	80003468 <bread+0xd0>

000000008000348a <bwrite>:
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    80003496:	0541                	addi	a0,a0,16
    80003498:	00001097          	auipc	ra,0x1
    8000349c:	470080e7          	jalr	1136(ra) # 80004908 <holdingsleep>
    800034a0:	cd01                	beqz	a0,800034b8 <bwrite+0x2e>
    panic("bwrite");
  virtio_disk_rw(b, 1);
    800034a2:	4585                	li	a1,1
    800034a4:	8526                	mv	a0,s1
    800034a6:	00003097          	auipc	ra,0x3
    800034aa:	f60080e7          	jalr	-160(ra) # 80006406 <virtio_disk_rw>
}
    ...
    800034bc:	05850513          	addi	a0,a0,88 # 80008510 <syscalls+0xf0>
    800034c0:	ffffd097          	auipc	ra,0xffffd
    800034c4:	08a080e7          	jalr	138(ra) # 8000054a <panic>

00000000800034c8 <brelse>:
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    800034d6:	01050913          	addi	s2,a0,16
    800034da:	854a                	mv	a0,s2
    800034dc:	00001097          	auipc	ra,0x1
    800034e0:	42c080e7          	jalr	1068(ra) # 80004908 <holdingsleep>
    800034e4:	c92d                	beqz	a0,80003556 <brelse+0x8e>
    panic("brelse");

  releasesleep(&b->lock);
    800034e6:	854a                	mv	a0,s2
    800034e8:	00001097          	auipc	ra,0x1
    800034ec:	3dc080e7          	jalr	988(ra) # 800048c4 <releasesleep>

  acquire(&bcache.lock);
    800034f0:	00055517          	auipc	a0,0x55
    800034f4:	fd050513          	addi	a0,a0,-48 # 800584c0 <bcache>
    800034f8:	ffffd097          	auipc	ra,0xffffd
    800034fc:	70e080e7          	jalr	1806(ra) # 80000c06 <acquire>
  b->refcnt--;
    80003500:	40bc                	lw	a5,64(s1)
    80003502:	37fd                	addiw	a5,a5,-1
    80003504:	0007871b          	sext.w	a4,a5
    80003508:	c0bc                	sw	a5,64(s1)
  if (b->refcnt == 0) {
    8000350a:	eb05                	bnez	a4,8000353a <brelse+0x72>
    // no one is waiting for it.
    b->next->prev = b->prev;
    8000350c:	68bc                	ld	a5,80(s1)
    8000350e:	64b8                	ld	a4,72(s1)
    80003510:	e7b8                	sd	a4,72(a5)
    b->prev->next = b->next;
    80003512:	64bc                	ld	a5,72(s1)
    80003514:	68b8                	ld	a4,80(s1)
    80003516:	ebb8                	sd	a4,80(a5)
    b->next = bcache.head.next;
    80003518:	0005d797          	auipc	a5,0x5d
    8000351c:	fa878793          	addi	a5,a5,-88 # 800604c0 <bcache+0x8000>
    80003520:	2b87b703          	ld	a4,696(a5)
    80003524:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80003526:	0005d717          	auipc	a4,0x5d
    8000352a:	20270713          	addi	a4,a4,514 # 80060728 <bcache+0x8268>
  ...
  release(&bcache.lock);
    8000353a:	00055517          	auipc	a0,0x55
    8000353e:	f8650513          	addi	a0,a0,-122 # 800584c0 <bcache>
    80003542:	ffffd097          	auipc	ra,0xffffd
    80003546:	778080e7          	jalr	1912(ra) # 80000cba <release>
}
    ...
    8000355a:	fc250513          	addi	a0,a0,-62 # 80008518 <syscalls+0xf8>
    8000355e:	ffffd097          	auipc	ra,0xffffd
    80003562:	fec080e7          	jalr	-20(ra) # 8000054a <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    80003572:	00055517          	auipc	a0,0x55
    80003576:	f4e50513          	addi	a0,a0,-178 # 800584c0 <bcache>
    8000357a:	ffffd097          	auipc	ra,0xffffd
    8000357e:	68c080e7          	jalr	1676(ra) # 80000c06 <acquire>
  b->refcnt++;
    80003582:	40bc                	lw	a5,64(s1)
    80003584:	2785                	addiw	a5,a5,1
    80003586:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80003588:	00055517          	auipc	a0,0x55
    8000358c:	f3850513          	addi	a0,a0,-200 # 800584c0 <bcache>
    80003590:	ffffd097          	auipc	ra,0xffffd
    80003594:	72a080e7          	jalr	1834(ra) # 80000cba <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    800035ae:	00055517          	auipc	a0,0x55
    800035b2:	f1250513          	addi	a0,a0,-238 # 800584c0 <bcache>
    800035b6:	ffffd097          	auipc	ra,0xffffd
    800035ba:	650080e7          	jalr	1616(ra) # 80000c06 <acquire>
  b->refcnt--;
    800035be:	40bc                	lw	a5,64(s1)
    800035c0:	37fd                	addiw	a5,a5,-1
    800035c2:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    800035c4:	00055517          	auipc	a0,0x55
    800035c8:	efc50513          	addi	a0,a0,-260 # 800584c0 <bcache>
    800035cc:	ffffd097          	auipc	ra,0xffffd
    800035d0:	6ee080e7          	jalr	1774(ra) # 80000cba <release>
}
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    800035ec:	00d5d59b          	srliw	a1,a1,0xd
    800035f0:	0005d797          	auipc	a5,0x5d
    800035f4:	5ac7a783          	lw	a5,1452(a5) # 80060b9c <sb+0x1c>
    800035f8:	9dbd                	addw	a1,a1,a5
    800035fa:	00000097          	auipc	ra,0x0
    800035fe:	d9e080e7          	jalr	-610(ra) # 80003398 <bread>
  bi = b % BPB;
  m = 1 << (bi % 8);
    80003602:	0074f713          	andi	a4,s1,7
    80003606:	4785                	li	a5,1
    80003608:	00e797bb          	sllw	a5,a5,a4
  if((bp->data[bi/8] & m) == 0)
    8000360c:	14ce                	slli	s1,s1,0x33
    8000360e:	90d9                	srli	s1,s1,0x36
  ...
  bp->data[bi/8] &= ~m;
    ...
    80003626:	8ff9                	and	a5,a5,a4
    80003628:	04f48c23          	sb	a5,88(s1)
  log_write(bp);
    8000362c:	00001097          	auipc	ra,0x1
    80003630:	11a080e7          	jalr	282(ra) # 80004746 <log_write>
  brelse(bp);
    80003634:	854a                	mv	a0,s2
    80003636:	00000097          	auipc	ra,0x0
    8000363a:	e92080e7          	jalr	-366(ra) # 800034c8 <brelse>
}
    ...
    8000364e:	ed650513          	addi	a0,a0,-298 # 80008520 <syscalls+0x100>
    80003652:	ffffd097          	auipc	ra,0xffffd
    80003656:	ef8080e7          	jalr	-264(ra) # 8000054a <panic>

000000008000365a <balloc>:
{
    8000365a:	711d                	addi	sp,sp,-96
    ...
    80003672:	1080                	addi	s0,sp,96
  for(b = 0; b < sb.size; b += BPB){
    80003674:	0005d797          	auipc	a5,0x5d
    80003678:	5107a783          	lw	a5,1296(a5) # 80060b84 <sb+0x4>
    8000367c:	cbd1                	beqz	a5,80003710 <balloc+0xb6>
    8000367e:	8baa                	mv	s7,a0
    80003680:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    80003682:	0005db17          	auipc	s6,0x5d
    80003686:	4feb0b13          	addi	s6,s6,1278 # 80060b80 <sb>
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800036ca:	cd2080e7          	jalr	-814(ra) # 80003398 <bread>
    800036ce:	892a                	mv	s2,a0
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    800036d0:	004b2503          	lw	a0,4(s6)
    800036d4:	000a849b          	sext.w	s1,s5
    800036d8:	8662                	mv	a2,s8
    800036da:	faa4fde3          	bgeu	s1,a0,80003694 <balloc+0x3a>
      m = 1 << (bi % 8);
    800036de:	41f6579b          	sraiw	a5,a2,0x1f
    800036e2:	01d7d69b          	srliw	a3,a5,0x1d
    800036e6:	00c6873b          	addw	a4,a3,a2
    800036ea:	00777793          	andi	a5,a4,7
    800036ee:	9f95                	subw	a5,a5,a3
    800036f0:	00f997bb          	sllw	a5,s3,a5
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    800036f4:	4037571b          	sraiw	a4,a4,0x3
    800036f8:	00e906b3          	add	a3,s2,a4
    800036fc:	0586c683          	lbu	a3,88(a3)
    80003700:	00d7f5b3          	and	a1,a5,a3
    80003704:	cd91                	beqz	a1,80003720 <balloc+0xc6>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80003706:	2605                	addiw	a2,a2,1
    80003708:	2485                	addiw	s1,s1,1
    8000370a:	fd4618e3          	bne	a2,s4,800036da <balloc+0x80>
    8000370e:	b759                	j	80003694 <balloc+0x3a>
  panic("balloc: out of blocks");
    80003710:	00005517          	auipc	a0,0x5
    80003714:	e2850513          	addi	a0,a0,-472 # 80008538 <syscalls+0x118>
    80003718:	ffffd097          	auipc	ra,0xffffd
    8000371c:	e32080e7          	jalr	-462(ra) # 8000054a <panic>
    ...
    8000372e:	01c080e7          	jalr	28(ra) # 80004746 <log_write>
        brelse(bp);
    80003732:	854a                	mv	a0,s2
    80003734:	00000097          	auipc	ra,0x0
    80003738:	d94080e7          	jalr	-620(ra) # 800034c8 <brelse>
  bp = bread(dev, bno);
    8000373c:	85a6                	mv	a1,s1
    8000373e:	855e                	mv	a0,s7
    80003740:	00000097          	auipc	ra,0x0
    80003744:	c58080e7          	jalr	-936(ra) # 80003398 <bread>
  ...
  memset(bp->data, 0, BSIZE);
    ...
    80003758:	5ae080e7          	jalr	1454(ra) # 80000d02 <memset>
  log_write(bp);
    8000375c:	854a                	mv	a0,s2
    8000375e:	00001097          	auipc	ra,0x1
    80003762:	fe8080e7          	jalr	-24(ra) # 80004746 <log_write>
  brelse(bp);
    80003766:	854a                	mv	a0,s2
    80003768:	00000097          	auipc	ra,0x0
    8000376c:	d60080e7          	jalr	-672(ra) # 800034c8 <brelse>
}
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    800037a0:	04b7fe63          	bgeu	a5,a1,800037fc <bmap+0x70>
    if((addr = ip->addrs[bn]) == 0)
      ip->addrs[bn] = addr = balloc(ip->dev);
    return addr;
  }
  bn -= NDIRECT;
    800037a4:	ff45849b          	addiw	s1,a1,-12
    800037a8:	0004871b          	sext.w	a4,s1

  if(bn < NINDIRECT){
    800037ac:	0ff00793          	li	a5,255
    800037b0:	0ae7e363          	bltu	a5,a4,80003856 <bmap+0xca>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0)
    800037b4:	08052583          	lw	a1,128(a0)
    800037b8:	c5ad                	beqz	a1,80003822 <bmap+0x96>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    bp = bread(ip->dev, addr);
    800037ba:	00092503          	lw	a0,0(s2)
    800037be:	00000097          	auipc	ra,0x0
    800037c2:	bda080e7          	jalr	-1062(ra) # 80003398 <bread>
    800037c6:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    800037c8:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    800037cc:	02049593          	slli	a1,s1,0x20
    800037d0:	9181                	srli	a1,a1,0x20
    800037d2:	058a                	slli	a1,a1,0x2
    800037d4:	00b784b3          	add	s1,a5,a1
    800037d8:	0004a983          	lw	s3,0(s1)
    800037dc:	04098d63          	beqz	s3,80003836 <bmap+0xaa>
    ...
    800037e6:	ce6080e7          	jalr	-794(ra) # 800034c8 <brelse>
    return addr;
  }
  ...
  panic("bmap: out of range");
    ...
    80003806:	0504a983          	lw	s3,80(s1)
    8000380a:	fe0990e3          	bnez	s3,800037ea <bmap+0x5e>
      ip->addrs[bn] = addr = balloc(ip->dev);
    8000380e:	4108                	lw	a0,0(a0)
    80003810:	00000097          	auipc	ra,0x0
    80003814:	e4a080e7          	jalr	-438(ra) # 8000365a <balloc>
    80003818:	0005099b          	sext.w	s3,a0
    8000381c:	0534a823          	sw	s3,80(s1)
    80003820:	b7e9                	j	800037ea <bmap+0x5e>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    80003822:	4108                	lw	a0,0(a0)
    80003824:	00000097          	auipc	ra,0x0
    80003828:	e36080e7          	jalr	-458(ra) # 8000365a <balloc>
    8000382c:	0005059b          	sext.w	a1,a0
    80003830:	08b92023          	sw	a1,128(s2)
    80003834:	b759                	j	800037ba <bmap+0x2e>
      a[bn] = addr = balloc(ip->dev);
    80003836:	00092503          	lw	a0,0(s2)
    8000383a:	00000097          	auipc	ra,0x0
    8000383e:	e20080e7          	jalr	-480(ra) # 8000365a <balloc>
    80003842:	0005099b          	sext.w	s3,a0
    80003846:	0134a023          	sw	s3,0(s1)
      log_write(bp);
    8000384a:	8552                	mv	a0,s4
    8000384c:	00001097          	auipc	ra,0x1
    80003850:	efa080e7          	jalr	-262(ra) # 80004746 <log_write>
    80003854:	b771                	j	800037e0 <bmap+0x54>
  panic("bmap: out of range");
    80003856:	00005517          	auipc	a0,0x5
    8000385a:	cfa50513          	addi	a0,a0,-774 # 80008550 <syscalls+0x130>
    8000385e:	ffffd097          	auipc	ra,0xffffd
    80003862:	cec080e7          	jalr	-788(ra) # 8000054a <panic>

0000000080003866 <iget>:
{
    ...
    80003878:	8a2e                	mv	s4,a1
  acquire(&icache.lock);
    8000387a:	0005d517          	auipc	a0,0x5d
    8000387e:	32650513          	addi	a0,a0,806 # 80060ba0 <icache>
    80003882:	ffffd097          	auipc	ra,0xffffd
    80003886:	384080e7          	jalr	900(ra) # 80000c06 <acquire>
  empty = 0;
    8000388a:	4901                	li	s2,0
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    8000388c:	0005d497          	auipc	s1,0x5d
    80003890:	32c48493          	addi	s1,s1,812 # 80060bb8 <icache+0x18>
    80003894:	0005f697          	auipc	a3,0x5f
    80003898:	db468693          	addi	a3,a3,-588 # 80062648 <log>
    8000389c:	a039                	j	800038aa <iget+0x44>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    8000389e:	02090b63          	beqz	s2,800038d4 <iget+0x6e>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    800038a2:	08848493          	addi	s1,s1,136
    800038a6:	02d48a63          	beq	s1,a3,800038da <iget+0x74>
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
    800038aa:	449c                	lw	a5,8(s1)
    800038ac:	fef059e3          	blez	a5,8000389e <iget+0x38>
    800038b0:	4098                	lw	a4,0(s1)
    800038b2:	ff3716e3          	bne	a4,s3,8000389e <iget+0x38>
    800038b6:	40d8                	lw	a4,4(s1)
    800038b8:	ff4713e3          	bne	a4,s4,8000389e <iget+0x38>
      ip->ref++;
    800038bc:	2785                	addiw	a5,a5,1
    800038be:	c49c                	sw	a5,8(s1)
      release(&icache.lock);
    800038c0:	0005d517          	auipc	a0,0x5d
    800038c4:	2e050513          	addi	a0,a0,736 # 80060ba0 <icache>
    800038c8:	ffffd097          	auipc	ra,0xffffd
    800038cc:	3f2080e7          	jalr	1010(ra) # 80000cba <release>
      return ip;
    800038d0:	8926                	mv	s2,s1
    800038d2:	a03d                	j	80003900 <iget+0x9a>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    800038d4:	f7f9                	bnez	a5,800038a2 <iget+0x3c>
    800038d6:	8926                	mv	s2,s1
    800038d8:	b7e9                	j	800038a2 <iget+0x3c>
  if(empty == 0)
    800038da:	02090c63          	beqz	s2,80003912 <iget+0xac>
  ip->dev = dev;
    800038de:	01392023          	sw	s3,0(s2)
  ip->inum = inum;
    800038e2:	01492223          	sw	s4,4(s2)
  ip->ref = 1;
    800038e6:	4785                	li	a5,1
    800038e8:	00f92423          	sw	a5,8(s2)
  ip->valid = 0;
    800038ec:	04092023          	sw	zero,64(s2)
  release(&icache.lock);
    800038f0:	0005d517          	auipc	a0,0x5d
    800038f4:	2b050513          	addi	a0,a0,688 # 80060ba0 <icache>
    800038f8:	ffffd097          	auipc	ra,0xffffd
    800038fc:	3c2080e7          	jalr	962(ra) # 80000cba <release>
}
    ...
    80003916:	c5650513          	addi	a0,a0,-938 # 80008568 <syscalls+0x148>
    8000391a:	ffffd097          	auipc	ra,0xffffd
    8000391e:	c30080e7          	jalr	-976(ra) # 8000054a <panic>

0000000080003922 <fsinit>:
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    80003932:	4585                	li	a1,1
    80003934:	00000097          	auipc	ra,0x0
    80003938:	a64080e7          	jalr	-1436(ra) # 80003398 <bread>
    8000393c:	84aa                	mv	s1,a0
  memmove(sb, bp->data, sizeof(*sb));
    8000393e:	0005d997          	auipc	s3,0x5d
    80003942:	24298993          	addi	s3,s3,578 # 80060b80 <sb>
    80003946:	02000613          	li	a2,32
    8000394a:	05850593          	addi	a1,a0,88
    8000394e:	854e                	mv	a0,s3
    80003950:	ffffd097          	auipc	ra,0xffffd
    80003954:	40e080e7          	jalr	1038(ra) # 80000d5e <memmove>
  brelse(bp);
    80003958:	8526                	mv	a0,s1
    8000395a:	00000097          	auipc	ra,0x0
    8000395e:	b6e080e7          	jalr	-1170(ra) # 800034c8 <brelse>
  if(sb.magic != FSMAGIC)
    80003962:	0009a703          	lw	a4,0(s3)
    80003966:	102037b7          	lui	a5,0x10203
    8000396a:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    8000396e:	02f71263          	bne	a4,a5,80003992 <fsinit+0x70>
  initlog(dev, &sb);
    80003972:	0005d597          	auipc	a1,0x5d
    80003976:	20e58593          	addi	a1,a1,526 # 80060b80 <sb>
    8000397a:	854a                	mv	a0,s2
    8000397c:	00001097          	auipc	ra,0x1
    80003980:	b4e080e7          	jalr	-1202(ra) # 800044ca <initlog>
}
    ...
    80003996:	be650513          	addi	a0,a0,-1050 # 80008578 <syscalls+0x158>
    8000399a:	ffffd097          	auipc	ra,0xffffd
    8000399e:	bb0080e7          	jalr	-1104(ra) # 8000054a <panic>

00000000800039a2 <iinit>:
{
  ...
  initlock(&icache.lock, "icache");
    ...
    800039b4:	be058593          	addi	a1,a1,-1056 # 80008590 <syscalls+0x170>
    800039b8:	0005d517          	auipc	a0,0x5d
    800039bc:	1e850513          	addi	a0,a0,488 # 80060ba0 <icache>
    800039c0:	ffffd097          	auipc	ra,0xffffd
    800039c4:	1b6080e7          	jalr	438(ra) # 80000b76 <initlock>
  for(i = 0; i < NINODE; i++) {
    800039c8:	0005d497          	auipc	s1,0x5d
    800039cc:	20048493          	addi	s1,s1,512 # 80060bc8 <icache+0x28>
    800039d0:	0005f997          	auipc	s3,0x5f
    800039d4:	c8898993          	addi	s3,s3,-888 # 80062658 <log+0x10>
    initsleeplock(&icache.inode[i].lock, "inode");
    800039d8:	00005917          	auipc	s2,0x5
    800039dc:	bc090913          	addi	s2,s2,-1088 # 80008598 <syscalls+0x178>
    800039e0:	85ca                	mv	a1,s2
    800039e2:	8526                	mv	a0,s1
    800039e4:	00001097          	auipc	ra,0x1
    800039e8:	e50080e7          	jalr	-432(ra) # 80004834 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    800039ec:	08848493          	addi	s1,s1,136
    800039f0:	ff3498e3          	bne	s1,s3,800039e0 <iinit+0x3e>
}
...
0000000080003a02 <ialloc>:
{
    80003a02:	715d                	addi	sp,sp,-80
    80003a04:	e486                	sd	ra,72(sp)
    80003a06:	e0a2                	sd	s0,64(sp)
    80003a08:	fc26                	sd	s1,56(sp)
    80003a0a:	f84a                	sd	s2,48(sp)
    80003a0c:	f44e                	sd	s3,40(sp)
    80003a0e:	f052                	sd	s4,32(sp)
    80003a10:	ec56                	sd	s5,24(sp)
    80003a12:	e85a                	sd	s6,16(sp)
    80003a14:	e45e                	sd	s7,8(sp)
    80003a16:	0880                	addi	s0,sp,80
  for(inum = 1; inum < sb.ninodes; inum++){
    80003a18:	0005d717          	auipc	a4,0x5d
    80003a1c:	17472703          	lw	a4,372(a4) # 80060b8c <sb+0xc>
    80003a20:	4785                	li	a5,1
    80003a22:	04e7fa63          	bgeu	a5,a4,80003a76 <ialloc+0x74>
    80003a26:	8aaa                	mv	s5,a0
    80003a28:	8bae                	mv	s7,a1
    80003a2a:	4485                	li	s1,1
    bp = bread(dev, IBLOCK(inum, sb));
    80003a2c:	0005da17          	auipc	s4,0x5d
    80003a30:	154a0a13          	addi	s4,s4,340 # 80060b80 <sb>
    80003a34:	00048b1b          	sext.w	s6,s1
    80003a38:	0044d793          	srli	a5,s1,0x4
    80003a3c:	018a2583          	lw	a1,24(s4)
    80003a40:	9dbd                	addw	a1,a1,a5
    80003a42:	8556                	mv	a0,s5
    80003a44:	00000097          	auipc	ra,0x0
    80003a48:	954080e7          	jalr	-1708(ra) # 80003398 <bread>
    80003a4c:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + inum%IPB;
    80003a4e:	05850993          	addi	s3,a0,88
    80003a52:	00f4f793          	andi	a5,s1,15
    80003a56:	079a                	slli	a5,a5,0x6
    80003a58:	99be                	add	s3,s3,a5
    if(dip->type == 0){  // a free inode
    80003a5a:	00099783          	lh	a5,0(s3)
    80003a5e:	c785                	beqz	a5,80003a86 <ialloc+0x84>
    brelse(bp);
    80003a60:	00000097          	auipc	ra,0x0
    80003a64:	a68080e7          	jalr	-1432(ra) # 800034c8 <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
    80003a68:	0485                	addi	s1,s1,1
    80003a6a:	00ca2703          	lw	a4,12(s4)
    80003a6e:	0004879b          	sext.w	a5,s1
    80003a72:	fce7e1e3          	bltu	a5,a4,80003a34 <ialloc+0x32>
  panic("ialloc: no inodes");
    80003a76:	00005517          	auipc	a0,0x5
    80003a7a:	b2a50513          	addi	a0,a0,-1238 # 800085a0 <syscalls+0x180>
    80003a7e:	ffffd097          	auipc	ra,0xffffd
    80003a82:	acc080e7          	jalr	-1332(ra) # 8000054a <panic>
      memset(dip, 0, sizeof(*dip));
    80003a86:	04000613          	li	a2,64
    80003a8a:	4581                	li	a1,0
    80003a8c:	854e                	mv	a0,s3
    80003a8e:	ffffd097          	auipc	ra,0xffffd
    80003a92:	274080e7          	jalr	628(ra) # 80000d02 <memset>
      dip->type = type;
    80003a96:	01799023          	sh	s7,0(s3)
      log_write(bp);   // mark it allocated on the disk
    80003a9a:	854a                	mv	a0,s2
    80003a9c:	00001097          	auipc	ra,0x1
    80003aa0:	caa080e7          	jalr	-854(ra) # 80004746 <log_write>
      brelse(bp);
    80003aa4:	854a                	mv	a0,s2
    80003aa6:	00000097          	auipc	ra,0x0
    80003aaa:	a22080e7          	jalr	-1502(ra) # 800034c8 <brelse>
      return iget(dev, inum);
    80003aae:	85da                	mv	a1,s6
    80003ab0:	8556                	mv	a0,s5
    80003ab2:	00000097          	auipc	ra,0x0
    80003ab6:	db4080e7          	jalr	-588(ra) # 80003866 <iget>
}
    80003aba:	60a6                	ld	ra,72(sp)
    80003abc:	6406                	ld	s0,64(sp)
    80003abe:	74e2                	ld	s1,56(sp)
    80003ac0:	7942                	ld	s2,48(sp)
    80003ac2:	79a2                	ld	s3,40(sp)
    80003ac4:	7a02                	ld	s4,32(sp)
    80003ac6:	6ae2                	ld	s5,24(sp)
    80003ac8:	6b42                	ld	s6,16(sp)
    80003aca:	6ba2                	ld	s7,8(sp)
    80003acc:	6161                	addi	sp,sp,80
    80003ace:	8082                	ret

0000000080003ad0 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003ae0:	0047d79b          	srliw	a5,a5,0x4
    80003ae4:	0005d597          	auipc	a1,0x5d
    80003ae8:	0b45a583          	lw	a1,180(a1) # 80060b98 <sb+0x18>
    80003aec:	9dbd                	addw	a1,a1,a5
    80003aee:	4108                	lw	a0,0(a0)
    80003af0:	00000097          	auipc	ra,0x0
    80003af4:	8a8080e7          	jalr	-1880(ra) # 80003398 <bread>
    80003af8:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003afa:	05850793          	addi	a5,a0,88
    80003afe:	40c8                	lw	a0,4(s1)
    80003b00:	893d                	andi	a0,a0,15
    80003b02:	051a                	slli	a0,a0,0x6
    80003b04:	953e                	add	a0,a0,a5
  dip->type = ip->type;
    80003b06:	04449703          	lh	a4,68(s1)
    80003b0a:	00e51023          	sh	a4,0(a0)
  dip->major = ip->major;
    80003b0e:	04649703          	lh	a4,70(s1)
    80003b12:	00e51123          	sh	a4,2(a0)
  dip->minor = ip->minor;
    80003b16:	04849703          	lh	a4,72(s1)
    80003b1a:	00e51223          	sh	a4,4(a0)
  dip->nlink = ip->nlink;
    80003b1e:	04a49703          	lh	a4,74(s1)
    80003b22:	00e51323          	sh	a4,6(a0)
  dip->size = ip->size;
    80003b26:	44f8                	lw	a4,76(s1)
    80003b28:	c518                	sw	a4,8(a0)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80003b2a:	03400613          	li	a2,52
    80003b2e:	05048593          	addi	a1,s1,80
    80003b32:	0531                	addi	a0,a0,12
    80003b34:	ffffd097          	auipc	ra,0xffffd
    80003b38:	22a080e7          	jalr	554(ra) # 80000d5e <memmove>
  log_write(bp);
    80003b3c:	854a                	mv	a0,s2
    80003b3e:	00001097          	auipc	ra,0x1
    80003b42:	c08080e7          	jalr	-1016(ra) # 80004746 <log_write>
  brelse(bp);
    80003b46:	854a                	mv	a0,s2
    80003b48:	00000097          	auipc	ra,0x0
    80003b4c:	980080e7          	jalr	-1664(ra) # 800034c8 <brelse>
}
...
0000000080003b5c <idup>:
{
  ...
  acquire(&icache.lock);
    80003b68:	0005d517          	auipc	a0,0x5d
    80003b6c:	03850513          	addi	a0,a0,56 # 80060ba0 <icache>
    80003b70:	ffffd097          	auipc	ra,0xffffd
    80003b74:	096080e7          	jalr	150(ra) # 80000c06 <acquire>
  ip->ref++;
    80003b78:	449c                	lw	a5,8(s1)
    80003b7a:	2785                	addiw	a5,a5,1
    80003b7c:	c49c                	sw	a5,8(s1)
  release(&icache.lock);
    80003b7e:	0005d517          	auipc	a0,0x5d
    80003b82:	02250513          	addi	a0,a0,34 # 80060ba0 <icache>
    80003b86:	ffffd097          	auipc	ra,0xffffd
    80003b8a:	134080e7          	jalr	308(ra) # 80000cba <release>
}
...
0000000080003b9a <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    80003ba6:	c115                	beqz	a0,80003bca <ilock+0x30>
    80003ba8:	84aa                	mv	s1,a0
    80003baa:	451c                	lw	a5,8(a0)
    80003bac:	00f05f63          	blez	a5,80003bca <ilock+0x30>
  acquiresleep(&ip->lock);
    80003bb0:	0541                	addi	a0,a0,16
    80003bb2:	00001097          	auipc	ra,0x1
    80003bb6:	cbc080e7          	jalr	-836(ra) # 8000486e <acquiresleep>
  if(ip->valid == 0){
    80003bba:	40bc                	lw	a5,64(s1)
    80003bbc:	cf99                	beqz	a5,80003bda <ilock+0x40>
}
    ...
    80003bce:	9ee50513          	addi	a0,a0,-1554 # 800085b8 <syscalls+0x198>
    80003bd2:	ffffd097          	auipc	ra,0xffffd
    80003bd6:	978080e7          	jalr	-1672(ra) # 8000054a <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80003bda:	40dc                	lw	a5,4(s1)
    80003bdc:	0047d79b          	srliw	a5,a5,0x4
    80003be0:	0005d597          	auipc	a1,0x5d
    80003be4:	fb85a583          	lw	a1,-72(a1) # 80060b98 <sb+0x18>
    80003be8:	9dbd                	addw	a1,a1,a5
    80003bea:	4088                	lw	a0,0(s1)
    80003bec:	fffff097          	auipc	ra,0xfffff
    80003bf0:	7ac080e7          	jalr	1964(ra) # 80003398 <bread>
    80003bf4:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003bf6:	05850593          	addi	a1,a0,88
    80003bfa:	40dc                	lw	a5,4(s1)
    80003bfc:	8bbd                	andi	a5,a5,15
    80003bfe:	079a                	slli	a5,a5,0x6
    80003c00:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    80003c02:	00059783          	lh	a5,0(a1)
    80003c06:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80003c0a:	00259783          	lh	a5,2(a1)
    80003c0e:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    80003c12:	00459783          	lh	a5,4(a1)
    80003c16:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80003c1a:	00659783          	lh	a5,6(a1)
    80003c1e:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    80003c22:	459c                	lw	a5,8(a1)
    80003c24:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    80003c26:	03400613          	li	a2,52
    80003c2a:	05b1                	addi	a1,a1,12
    80003c2c:	05048513          	addi	a0,s1,80
    80003c30:	ffffd097          	auipc	ra,0xffffd
    80003c34:	12e080e7          	jalr	302(ra) # 80000d5e <memmove>
    brelse(bp);
    80003c38:	854a                	mv	a0,s2
    80003c3a:	00000097          	auipc	ra,0x0
    80003c3e:	88e080e7          	jalr	-1906(ra) # 800034c8 <brelse>
    ip->valid = 1;
    80003c42:	4785                	li	a5,1
    80003c44:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    80003c46:	04449783          	lh	a5,68(s1)
    80003c4a:	fbb5                	bnez	a5,80003bbe <ilock+0x24>
      panic("ilock: no type");
    80003c4c:	00005517          	auipc	a0,0x5
    80003c50:	97450513          	addi	a0,a0,-1676 # 800085c0 <syscalls+0x1a0>
    80003c54:	ffffd097          	auipc	ra,0xffffd
    80003c58:	8f6080e7          	jalr	-1802(ra) # 8000054a <panic>

0000000080003c5c <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    80003c68:	c905                	beqz	a0,80003c98 <iunlock+0x3c>
    80003c6a:	84aa                	mv	s1,a0
    80003c6c:	01050913          	addi	s2,a0,16
    80003c70:	854a                	mv	a0,s2
    80003c72:	00001097          	auipc	ra,0x1
    80003c76:	c96080e7          	jalr	-874(ra) # 80004908 <holdingsleep>
    80003c7a:	cd19                	beqz	a0,80003c98 <iunlock+0x3c>
    80003c7c:	449c                	lw	a5,8(s1)
    80003c7e:	00f05d63          	blez	a5,80003c98 <iunlock+0x3c>
  releasesleep(&ip->lock);
    80003c82:	854a                	mv	a0,s2
    80003c84:	00001097          	auipc	ra,0x1
    80003c88:	c40080e7          	jalr	-960(ra) # 800048c4 <releasesleep>
}
    ...
    80003c9c:	93850513          	addi	a0,a0,-1736 # 800085d0 <syscalls+0x1b0>
    80003ca0:	ffffd097          	auipc	ra,0xffffd
    80003ca4:	8aa080e7          	jalr	-1878(ra) # 8000054a <panic>
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    ...
    80003cc6:	01248d63          	beq	s1,s2,80003ce0 <itrunc+0x38>
    if(ip->addrs[i]){
    ...
    80003cd6:	90c080e7          	jalr	-1780(ra) # 800035de <bfree>
      ip->addrs[i] = 0;
    80003cda:	0004a023          	sw	zero,0(s1)
    80003cde:	b7dd                	j	80003cc4 <itrunc+0x1c>
    }
  }

  if(ip->addrs[NDIRECT]){
    80003ce0:	0809a583          	lw	a1,128(s3)
    80003ce4:	e185                	bnez	a1,80003d04 <itrunc+0x5c>
    brelse(bp);
  ...
  ip->size = 0;
    80003ce6:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    80003cea:	854e                	mv	a0,s3
    80003cec:	00000097          	auipc	ra,0x0
    80003cf0:	de4080e7          	jalr	-540(ra) # 80003ad0 <iupdate>
}
    ...
    80003cfe:	6a02                	ld	s4,0(sp)
    80003d00:	6145                	addi	sp,sp,48
    80003d02:	8082                	ret
    bp = bread(ip->dev, ip->addrs[NDIRECT]);
    80003d04:	0009a503          	lw	a0,0(s3)
    80003d08:	fffff097          	auipc	ra,0xfffff
    80003d0c:	690080e7          	jalr	1680(ra) # 80003398 <bread>
    80003d10:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    80003d12:	05850493          	addi	s1,a0,88
    80003d16:	45850913          	addi	s2,a0,1112
    80003d1a:	a021                	j	80003d22 <itrunc+0x7a>
    80003d1c:	0491                	addi	s1,s1,4
    80003d1e:	01248b63          	beq	s1,s2,80003d34 <itrunc+0x8c>
      if(a[j])
    80003d22:	408c                	lw	a1,0(s1)
    80003d24:	dde5                	beqz	a1,80003d1c <itrunc+0x74>
        bfree(ip->dev, a[j]);
    80003d26:	0009a503          	lw	a0,0(s3)
    80003d2a:	00000097          	auipc	ra,0x0
    80003d2e:	8b4080e7          	jalr	-1868(ra) # 800035de <bfree>
    80003d32:	b7ed                	j	80003d1c <itrunc+0x74>
    brelse(bp);
    80003d34:	8552                	mv	a0,s4
    80003d36:	fffff097          	auipc	ra,0xfffff
    80003d3a:	792080e7          	jalr	1938(ra) # 800034c8 <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    80003d3e:	0809a583          	lw	a1,128(s3)
    80003d42:	0009a503          	lw	a0,0(s3)
    80003d46:	00000097          	auipc	ra,0x0
    80003d4a:	898080e7          	jalr	-1896(ra) # 800035de <bfree>
    ip->addrs[NDIRECT] = 0;
    80003d4e:	0809a023          	sw	zero,128(s3)
    80003d52:	bf51                	j	80003ce6 <itrunc+0x3e>

0000000080003d54 <iput>:
{
  ...
  acquire(&icache.lock);
    80003d62:	0005d517          	auipc	a0,0x5d
    80003d66:	e3e50513          	addi	a0,a0,-450 # 80060ba0 <icache>
    80003d6a:	ffffd097          	auipc	ra,0xffffd
    80003d6e:	e9c080e7          	jalr	-356(ra) # 80000c06 <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80003d72:	4498                	lw	a4,8(s1)
    80003d74:	4785                	li	a5,1
    80003d76:	02f70363          	beq	a4,a5,80003d9c <iput+0x48>
  ip->ref--;
    80003d7a:	449c                	lw	a5,8(s1)
    80003d7c:	37fd                	addiw	a5,a5,-1
    80003d7e:	c49c                	sw	a5,8(s1)
  release(&icache.lock);
    80003d80:	0005d517          	auipc	a0,0x5d
    80003d84:	e2050513          	addi	a0,a0,-480 # 80060ba0 <icache>
    80003d88:	ffffd097          	auipc	ra,0xffffd
    80003d8c:	f32080e7          	jalr	-206(ra) # 80000cba <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003d9e:	dff1                	beqz	a5,80003d7a <iput+0x26>
    80003da0:	04a49783          	lh	a5,74(s1)
    80003da4:	fbf9                	bnez	a5,80003d7a <iput+0x26>
    acquiresleep(&ip->lock);
    80003da6:	01048913          	addi	s2,s1,16
    80003daa:	854a                	mv	a0,s2
    80003dac:	00001097          	auipc	ra,0x1
    80003db0:	ac2080e7          	jalr	-1342(ra) # 8000486e <acquiresleep>
    release(&icache.lock);
    80003db4:	0005d517          	auipc	a0,0x5d
    80003db8:	dec50513          	addi	a0,a0,-532 # 80060ba0 <icache>
    80003dbc:	ffffd097          	auipc	ra,0xffffd
    80003dc0:	efe080e7          	jalr	-258(ra) # 80000cba <release>
    itrunc(ip);
    80003dc4:	8526                	mv	a0,s1
    80003dc6:	00000097          	auipc	ra,0x0
    80003dca:	ee2080e7          	jalr	-286(ra) # 80003ca8 <itrunc>
    ip->type = 0;
    80003dce:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    80003dd2:	8526                	mv	a0,s1
    80003dd4:	00000097          	auipc	ra,0x0
    80003dd8:	cfc080e7          	jalr	-772(ra) # 80003ad0 <iupdate>
    ip->valid = 0;
    80003ddc:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    80003de0:	854a                	mv	a0,s2
    80003de2:	00001097          	auipc	ra,0x1
    80003de6:	ae2080e7          	jalr	-1310(ra) # 800048c4 <releasesleep>
    acquire(&icache.lock);
    80003dea:	0005d517          	auipc	a0,0x5d
    80003dee:	db650513          	addi	a0,a0,-586 # 80060ba0 <icache>
    80003df2:	ffffd097          	auipc	ra,0xffffd
    80003df6:	e14080e7          	jalr	-492(ra) # 80000c06 <acquire>
    80003dfa:	b741                	j	80003d7a <iput+0x26>

0000000080003dfc <iunlockput>:
{
  ...
  iunlock(ip);
    ...
    80003e0c:	e54080e7          	jalr	-428(ra) # 80003c5c <iunlock>
  iput(ip);
    80003e10:	8526                	mv	a0,s1
    80003e12:	00000097          	auipc	ra,0x0
    80003e16:	f42080e7          	jalr	-190(ra) # 80003d54 <iput>
}
...
{
    80003e24:	1141                	addi	sp,sp,-16
    80003e26:	e422                	sd	s0,8(sp)
    80003e28:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    80003e2a:	411c                	lw	a5,0(a0)
    80003e2c:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    80003e2e:	415c                	lw	a5,4(a0)
    80003e30:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    80003e32:	04451783          	lh	a5,68(a0)
    80003e36:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    80003e3a:	04a51783          	lh	a5,74(a0)
    80003e3e:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    80003e42:	04c56783          	lwu	a5,76(a0)
    80003e46:	e99c                	sd	a5,16(a1)
}
    80003e48:	6422                	ld	s0,8(sp)
    80003e4a:	0141                	addi	sp,sp,16
    80003e4c:	8082                	ret

0000000080003e4e <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80003e50:	0ed7e963          	bltu	a5,a3,80003f42 <readi+0xf4>
{
    ...
    80003e72:	8baa                	mv	s7,a0
    80003e74:	8c2e                	mv	s8,a1
    80003e76:	8ab2                	mv	s5,a2
    80003e78:	84b6                	mv	s1,a3
    80003e7a:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80003e7c:	9f35                	addw	a4,a4,a3
    return 0;
    80003e7e:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    80003e80:	0ad76063          	bltu	a4,a3,80003f20 <readi+0xd2>
  if(off + n > ip->size)
    80003e84:	00e7f463          	bgeu	a5,a4,80003e8c <readi+0x3e>
    n = ip->size - off;
    80003e88:	40d78b3b          	subw	s6,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003e8c:	0a0b0963          	beqz	s6,80003f3e <readi+0xf0>
    80003e90:	4981                	li	s3,0
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    m = min(n - tot, BSIZE - off%BSIZE);
    80003e92:	40000d13          	li	s10,1024
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    80003e96:	5cfd                	li	s9,-1
    80003e98:	a82d                	j	80003ed2 <readi+0x84>
    80003e9a:	020a1d93          	slli	s11,s4,0x20
    80003e9e:	020ddd93          	srli	s11,s11,0x20
    80003ea2:	05890793          	addi	a5,s2,88
    80003ea6:	86ee                	mv	a3,s11
    80003ea8:	963e                	add	a2,a2,a5
    80003eaa:	85d6                	mv	a1,s5
    80003eac:	8562                	mv	a0,s8
    80003eae:	ffffe097          	auipc	ra,0xffffe
    80003eb2:	670080e7          	jalr	1648(ra) # 8000251e <either_copyout>
    80003eb6:	05950d63          	beq	a0,s9,80003f10 <readi+0xc2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    80003ec0:	60c080e7          	jalr	1548(ra) # 800034c8 <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003ec4:	013a09bb          	addw	s3,s4,s3
    80003ec8:	009a04bb          	addw	s1,s4,s1
    80003ecc:	9aee                	add	s5,s5,s11
    80003ece:	0569f763          	bgeu	s3,s6,80003f1c <readi+0xce>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80003ed2:	000ba903          	lw	s2,0(s7)
    80003ed6:	00a4d59b          	srliw	a1,s1,0xa
    80003eda:	855e                	mv	a0,s7
    80003edc:	00000097          	auipc	ra,0x0
    80003ee0:	8b0080e7          	jalr	-1872(ra) # 8000378c <bmap>
    80003ee4:	0005059b          	sext.w	a1,a0
    80003ee8:	854a                	mv	a0,s2
    80003eea:	fffff097          	auipc	ra,0xfffff
    80003eee:	4ae080e7          	jalr	1198(ra) # 80003398 <bread>
    80003ef2:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003ef4:	3ff4f613          	andi	a2,s1,1023
    80003ef8:	40cd07bb          	subw	a5,s10,a2
    80003efc:	413b073b          	subw	a4,s6,s3
    80003f00:	8a3e                	mv	s4,a5
    80003f02:	2781                	sext.w	a5,a5
    80003f04:	0007069b          	sext.w	a3,a4
    80003f08:	f8f6f9e3          	bgeu	a3,a5,80003e9a <readi+0x4c>
    80003f0c:	8a3a                	mv	s4,a4
    80003f0e:	b771                	j	80003e9a <readi+0x4c>
      brelse(bp);
    80003f10:	854a                	mv	a0,s2
    80003f12:	fffff097          	auipc	ra,0xfffff
    80003f16:	5b6080e7          	jalr	1462(ra) # 800034c8 <brelse>
      tot = -1;
    80003f1a:	59fd                	li	s3,-1
  }
  return tot;
    80003f1c:	0009851b          	sext.w	a0,s3
}
    80003f20:	70a6                	ld	ra,104(sp)
    80003f22:	7406                	ld	s0,96(sp)
    80003f24:	64e6                	ld	s1,88(sp)
    80003f26:	6946                	ld	s2,80(sp)
    80003f28:	69a6                	ld	s3,72(sp)
    80003f2a:	6a06                	ld	s4,64(sp)
    80003f2c:	7ae2                	ld	s5,56(sp)
    80003f2e:	7b42                	ld	s6,48(sp)
    80003f30:	7ba2                	ld	s7,40(sp)
    80003f32:	7c02                	ld	s8,32(sp)
    80003f34:	6ce2                	ld	s9,24(sp)
    80003f36:	6d42                	ld	s10,16(sp)
    80003f38:	6da2                	ld	s11,8(sp)
    80003f3a:	6165                	addi	sp,sp,112
    80003f3c:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003f3e:	89da                	mv	s3,s6
    80003f40:	bff1                	j	80003f1c <readi+0xce>
    return 0;
    80003f42:	4501                	li	a0,0
}
    80003f44:	8082                	ret

0000000080003f46 <writei>:
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80003f48:	10d7e763          	bltu	a5,a3,80004056 <writei+0x110>
{
    ...
    80003f64:	e86a                	sd	s10,16(sp)
    80003f66:	e46e                	sd	s11,8(sp)
    80003f68:	1880                	addi	s0,sp,112
    80003f6a:	8baa                	mv	s7,a0
    80003f6c:	8c2e                	mv	s8,a1
    80003f6e:	8ab2                	mv	s5,a2
    80003f70:	8936                	mv	s2,a3
    80003f72:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80003f74:	00e687bb          	addw	a5,a3,a4
    80003f78:	0ed7e163          	bltu	a5,a3,8000405a <writei+0x114>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    80003f7c:	00043737          	lui	a4,0x43
    80003f80:	0cf76f63          	bltu	a4,a5,8000405e <writei+0x118>
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003f84:	0a0b0863          	beqz	s6,80004034 <writei+0xee>
    80003f88:	4a01                	li	s4,0
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    m = min(n - tot, BSIZE - off%BSIZE);
    80003f8a:	40000d13          	li	s10,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    80003f8e:	5cfd                	li	s9,-1
    80003f90:	a091                	j	80003fd4 <writei+0x8e>
    80003f92:	02099d93          	slli	s11,s3,0x20
    80003f96:	020ddd93          	srli	s11,s11,0x20
    80003f9a:	05848793          	addi	a5,s1,88
    80003f9e:	86ee                	mv	a3,s11
    80003fa0:	8656                	mv	a2,s5
    80003fa2:	85e2                	mv	a1,s8
    80003fa4:	953e                	add	a0,a0,a5
    80003fa6:	ffffe097          	auipc	ra,0xffffe
    80003faa:	5d2080e7          	jalr	1490(ra) # 80002578 <either_copyin>
    80003fae:	07950263          	beq	a0,s9,80004012 <writei+0xcc>
      brelse(bp);
      n = -1;
      break;
    }
    ...
    80003fb8:	792080e7          	jalr	1938(ra) # 80004746 <log_write>
    brelse(bp);
    80003fbc:	8526                	mv	a0,s1
    80003fbe:	fffff097          	auipc	ra,0xfffff
    80003fc2:	50a080e7          	jalr	1290(ra) # 800034c8 <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003fc6:	01498a3b          	addw	s4,s3,s4
    80003fca:	0129893b          	addw	s2,s3,s2
    80003fce:	9aee                	add	s5,s5,s11
    80003fd0:	056a7763          	bgeu	s4,s6,8000401e <writei+0xd8>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80003fd4:	000ba483          	lw	s1,0(s7)
    80003fd8:	00a9559b          	srliw	a1,s2,0xa
    80003fdc:	855e                	mv	a0,s7
    80003fde:	fffff097          	auipc	ra,0xfffff
    80003fe2:	7ae080e7          	jalr	1966(ra) # 8000378c <bmap>
    80003fe6:	0005059b          	sext.w	a1,a0
    80003fea:	8526                	mv	a0,s1
    80003fec:	fffff097          	auipc	ra,0xfffff
    80003ff0:	3ac080e7          	jalr	940(ra) # 80003398 <bread>
    80003ff4:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003ff6:	3ff97513          	andi	a0,s2,1023
    80003ffa:	40ad07bb          	subw	a5,s10,a0
    80003ffe:	414b073b          	subw	a4,s6,s4
    80004002:	89be                	mv	s3,a5
    80004004:	2781                	sext.w	a5,a5
    80004006:	0007069b          	sext.w	a3,a4
    8000400a:	f8f6f4e3          	bgeu	a3,a5,80003f92 <writei+0x4c>
    8000400e:	89ba                	mv	s3,a4
    80004010:	b749                	j	80003f92 <writei+0x4c>
      brelse(bp);
    80004012:	8526                	mv	a0,s1
    80004014:	fffff097          	auipc	ra,0xfffff
    80004018:	4b4080e7          	jalr	1204(ra) # 800034c8 <brelse>
      n = -1;
  ...
  if(n > 0){
    if(off > ip->size)
    8000401e:	04cba783          	lw	a5,76(s7)
    80004022:	0127f463          	bgeu	a5,s2,8000402a <writei+0xe4>
      ip->size = off;
    80004026:	052ba623          	sw	s2,76(s7)
    // write the i-node back to disk even if the size didn't change
    // because the loop above might have called bmap() and added a new
    // block to ip->addrs[].
    iupdate(ip);
    8000402a:	855e                	mv	a0,s7
    8000402c:	00000097          	auipc	ra,0x0
    80004030:	aa4080e7          	jalr	-1372(ra) # 80003ad0 <iupdate>
  }

  return n;
    80004034:	000b051b          	sext.w	a0,s6
}
    ...
    8000405c:	bff1                	j	80004038 <writei+0xf2>
    return -1;
    8000405e:	557d                	li	a0,-1
    80004060:	bfe1                	j	80004038 <writei+0xf2>
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    ...
    80004070:	d6e080e7          	jalr	-658(ra) # 80000dda <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800040aa:	53250513          	addi	a0,a0,1330 # 800085d8 <syscalls+0x1b8>
    800040ae:	ffffc097          	auipc	ra,0xffffc
    800040b2:	49c080e7          	jalr	1180(ra) # 8000054a <panic>
      panic("dirlookup read");
    800040b6:	00004517          	auipc	a0,0x4
    800040ba:	53a50513          	addi	a0,a0,1338 # 800085f0 <syscalls+0x1d0>
    800040be:	ffffc097          	auipc	ra,0xffffc
    800040c2:	48c080e7          	jalr	1164(ra) # 8000054a <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800040e0:	d72080e7          	jalr	-654(ra) # 80003e4e <readi>
    ...
    80004114:	756080e7          	jalr	1878(ra) # 80003866 <iget>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80004154:	02f70563          	beq	a4,a5,8000417e <namex+0x52>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    80004158:	ffffe097          	auipc	ra,0xffffe
    8000415c:	8b6080e7          	jalr	-1866(ra) # 80001a0e <myproc>
    80004160:	6785                	lui	a5,0x1
    80004162:	97aa                	add	a5,a5,a0
    80004164:	1a07b503          	ld	a0,416(a5) # 11a0 <_entry-0x7fffee60>
    80004168:	00000097          	auipc	ra,0x0
    8000416c:	9f4080e7          	jalr	-1548(ra) # 80003b5c <idup>
  ...
  while((path = skipelem(path, name)) != 0){
    ...
    8000417c:	a865                	j	80004234 <namex+0x108>
    ip = iget(ROOTDEV, ROOTINO);
    8000417e:	4585                	li	a1,1
    80004180:	4505                	li	a0,1
    80004182:	fffff097          	auipc	ra,0xfffff
    80004186:	6e4080e7          	jalr	1764(ra) # 80003866 <iget>
    8000418a:	89aa                	mv	s3,a0
    8000418c:	b7dd                	j	80004172 <namex+0x46>
      iunlockput(ip);
    8000418e:	854e                	mv	a0,s3
    80004190:	00000097          	auipc	ra,0x0
    80004194:	c6c080e7          	jalr	-916(ra) # 80003dfc <iunlockput>
      return 0;
  ...
  return ip;
    ...
    800041bc:	aa4080e7          	jalr	-1372(ra) # 80003c5c <iunlock>
      return ip;
    800041c0:	bfe9                	j	8000419a <namex+0x6e>
      iunlockput(ip);
    800041c2:	854e                	mv	a0,s3
    800041c4:	00000097          	auipc	ra,0x0
    800041c8:	c38080e7          	jalr	-968(ra) # 80003dfc <iunlockput>
      return 0;
    800041cc:	89e6                	mv	s3,s9
    800041ce:	b7f1                	j	8000419a <namex+0x6e>
  len = path - s;
    800041d0:	40b48633          	sub	a2,s1,a1
    800041d4:	00060c9b          	sext.w	s9,a2
  if(len >= DIRSIZ)
    800041d8:	099c5463          	bge	s8,s9,80004260 <namex+0x134>
    memmove(name, s, DIRSIZ);
    800041dc:	4639                	li	a2,14
    800041de:	8552                	mv	a0,s4
    800041e0:	ffffd097          	auipc	ra,0xffffd
    800041e4:	b7e080e7          	jalr	-1154(ra) # 80000d5e <memmove>
  while(*path == '/')
    800041e8:	0004c783          	lbu	a5,0(s1)
    800041ec:	01279763          	bne	a5,s2,800041fa <namex+0xce>
    path++;
    800041f0:	0485                	addi	s1,s1,1
  while(*path == '/')
    800041f2:	0004c783          	lbu	a5,0(s1)
    800041f6:	ff278de3          	beq	a5,s2,800041f0 <namex+0xc4>
    ilock(ip);
    800041fa:	854e                	mv	a0,s3
    800041fc:	00000097          	auipc	ra,0x0
    80004200:	99e080e7          	jalr	-1634(ra) # 80003b9a <ilock>
    if(ip->type != T_DIR){
    80004204:	04499783          	lh	a5,68(s3)
    80004208:	f97793e3          	bne	a5,s7,8000418e <namex+0x62>
    if(nameiparent && *path == '\0'){
    8000420c:	000a8563          	beqz	s5,80004216 <namex+0xea>
    80004210:	0004c783          	lbu	a5,0(s1)
    80004214:	d3cd                	beqz	a5,800041b6 <namex+0x8a>
    if((next = dirlookup(ip, name, 0)) == 0){
    80004216:	865a                	mv	a2,s6
    80004218:	85d2                	mv	a1,s4
    8000421a:	854e                	mv	a0,s3
    8000421c:	00000097          	auipc	ra,0x0
    80004220:	e60080e7          	jalr	-416(ra) # 8000407c <dirlookup>
    80004224:	8caa                	mv	s9,a0
    80004226:	dd51                	beqz	a0,800041c2 <namex+0x96>
    iunlockput(ip);
    80004228:	854e                	mv	a0,s3
    8000422a:	00000097          	auipc	ra,0x0
    8000422e:	bd2080e7          	jalr	-1070(ra) # 80003dfc <iunlockput>
    ip = next;
    80004232:	89e6                	mv	s3,s9
  while(*path == '/')
    80004234:	0004c783          	lbu	a5,0(s1)
    80004238:	05279763          	bne	a5,s2,80004286 <namex+0x15a>
    path++;
    8000423c:	0485                	addi	s1,s1,1
  while(*path == '/')
    8000423e:	0004c783          	lbu	a5,0(s1)
    80004242:	ff278de3          	beq	a5,s2,8000423c <namex+0x110>
  if(*path == 0)
    80004246:	c79d                	beqz	a5,80004274 <namex+0x148>
    path++;
  ...
  while(*path != '/' && *path != 0)
    8000424e:	01278963          	beq	a5,s2,80004260 <namex+0x134>
    80004252:	dfbd                	beqz	a5,800041d0 <namex+0xa4>
    path++;
    80004254:	0485                	addi	s1,s1,1
  while(*path != '/' && *path != 0)
    80004256:	0004c783          	lbu	a5,0(s1)
    8000425a:	ff279ce3          	bne	a5,s2,80004252 <namex+0x126>
    8000425e:	bf8d                	j	800041d0 <namex+0xa4>
    memmove(name, s, len);
    80004260:	2601                	sext.w	a2,a2
    80004262:	8552                	mv	a0,s4
    80004264:	ffffd097          	auipc	ra,0xffffd
    80004268:	afa080e7          	jalr	-1286(ra) # 80000d5e <memmove>
    name[len] = 0;
    8000426c:	9cd2                	add	s9,s9,s4
    8000426e:	000c8023          	sb	zero,0(s9) # 2000 <_entry-0x7fffe000>
    80004272:	bf9d                	j	800041e8 <namex+0xbc>
  if(nameiparent){
    80004274:	f20a83e3          	beqz	s5,8000419a <namex+0x6e>
    iput(ip);
    80004278:	854e                	mv	a0,s3
    8000427a:	00000097          	auipc	ra,0x0
    8000427e:	ada080e7          	jalr	-1318(ra) # 80003d54 <iput>
    return 0;
    80004282:	4981                	li	s3,0
    80004284:	bf19                	j	8000419a <namex+0x6e>
  if(*path == 0)
    80004286:	d7fd                	beqz	a5,80004274 <namex+0x148>
  while(*path != '/' && *path != 0)
    80004288:	0004c783          	lbu	a5,0(s1)
    8000428c:	85a6                	mv	a1,s1
    8000428e:	b7d1                	j	80004252 <namex+0x126>
...
0000000080004290 <dirlink>:
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    800042ac:	dd4080e7          	jalr	-556(ra) # 8000407c <dirlookup>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800042ca:	b88080e7          	jalr	-1144(ra) # 80003e4e <readi>
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    800042f0:	b2a080e7          	jalr	-1238(ra) # 80000e16 <strncpy>
  de.inum = inum;
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80004308:	c42080e7          	jalr	-958(ra) # 80003f46 <writei>
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    8000432a:	a2e080e7          	jalr	-1490(ra) # 80003d54 <iput>
    return -1;
    8000432e:	557d                	li	a0,-1
    80004330:	b7dd                	j	80004316 <dirlink+0x86>
      panic("dirlink read");
    80004332:	00004517          	auipc	a0,0x4
    80004336:	2ce50513          	addi	a0,a0,718 # 80008600 <syscalls+0x1e0>
    8000433a:	ffffc097          	auipc	ra,0xffffc
    8000433e:	210080e7          	jalr	528(ra) # 8000054a <panic>
    panic("dirlink");
    80004342:	00004517          	auipc	a0,0x4
    80004346:	3de50513          	addi	a0,a0,990 # 80008720 <syscalls+0x300>
    8000434a:	ffffc097          	auipc	ra,0xffffc
    8000434e:	200080e7          	jalr	512(ra) # 8000054a <panic>
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    ...
    80004364:	dcc080e7          	jalr	-564(ra) # 8000412c <namex>
}
...
nameiparent(char *path, char *name)
{
  ...
  return namex(path, 1, name);
    ...
    80004380:	db0080e7          	jalr	-592(ra) # 8000412c <namex>
}
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80004398:	0005e917          	auipc	s2,0x5e
    8000439c:	2b090913          	addi	s2,s2,688 # 80062648 <log>
    800043a0:	01892583          	lw	a1,24(s2)
    800043a4:	02892503          	lw	a0,40(s2)
    800043a8:	fffff097          	auipc	ra,0xfffff
    800043ac:	ff0080e7          	jalr	-16(ra) # 80003398 <bread>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800043bc:	0005e797          	auipc	a5,0x5e
    800043c0:	2bc78793          	addi	a5,a5,700 # 80062678 <log+0x30>
    ...
    800043d0:	0005e617          	auipc	a2,0x5e
    800043d4:	2ac60613          	addi	a2,a2,684 # 8006267c <log+0x34>
  ...
  bwrite(buf);
    ...
    800043ec:	0a2080e7          	jalr	162(ra) # 8000348a <bwrite>
  brelse(buf);
    800043f0:	8526                	mv	a0,s1
    800043f2:	fffff097          	auipc	ra,0xfffff
    800043f6:	0d6080e7          	jalr	214(ra) # 800034c8 <brelse>
}
...
0000000080004406 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80004406:	0005e797          	auipc	a5,0x5e
    8000440a:	26e7a783          	lw	a5,622(a5) # 80062674 <log+0x2c>
    8000440e:	0af05d63          	blez	a5,800044c8 <install_trans+0xc2>
{
    ...
    80004428:	0005ea97          	auipc	s5,0x5e
    8000442c:	250a8a93          	addi	s5,s5,592 # 80062678 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80004430:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80004432:	0005e997          	auipc	s3,0x5e
    80004436:	21698993          	addi	s3,s3,534 # 80062648 <log>
    8000443a:	a00d                	j	8000445c <install_trans+0x56>
    brelse(lbuf);
    8000443c:	854a                	mv	a0,s2
    8000443e:	fffff097          	auipc	ra,0xfffff
    80004442:	08a080e7          	jalr	138(ra) # 800034c8 <brelse>
    brelse(dbuf);
    80004446:	8526                	mv	a0,s1
    80004448:	fffff097          	auipc	ra,0xfffff
    8000444c:	080080e7          	jalr	128(ra) # 800034c8 <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80004450:	2a05                	addiw	s4,s4,1
    80004452:	0a91                	addi	s5,s5,4
    80004454:	02c9a783          	lw	a5,44(s3)
    80004458:	04fa5e63          	bge	s4,a5,800044b4 <install_trans+0xae>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    8000445c:	0189a583          	lw	a1,24(s3)
    80004460:	014585bb          	addw	a1,a1,s4
    80004464:	2585                	addiw	a1,a1,1
    80004466:	0289a503          	lw	a0,40(s3)
    8000446a:	fffff097          	auipc	ra,0xfffff
    8000446e:	f2e080e7          	jalr	-210(ra) # 80003398 <bread>
    80004472:	892a                	mv	s2,a0
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
    80004474:	000aa583          	lw	a1,0(s5)
    80004478:	0289a503          	lw	a0,40(s3)
    8000447c:	fffff097          	auipc	ra,0xfffff
    80004480:	f1c080e7          	jalr	-228(ra) # 80003398 <bread>
    80004484:	84aa                	mv	s1,a0
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
    80004486:	40000613          	li	a2,1024
    8000448a:	05890593          	addi	a1,s2,88
    8000448e:	05850513          	addi	a0,a0,88
    80004492:	ffffd097          	auipc	ra,0xffffd
    80004496:	8cc080e7          	jalr	-1844(ra) # 80000d5e <memmove>
    bwrite(dbuf);  // write dst to disk
    8000449a:	8526                	mv	a0,s1
    8000449c:	fffff097          	auipc	ra,0xfffff
    800044a0:	fee080e7          	jalr	-18(ra) # 8000348a <bwrite>
    if(recovering == 0)
    800044a4:	f80b1ce3          	bnez	s6,8000443c <install_trans+0x36>
      bunpin(dbuf);
    800044a8:	8526                	mv	a0,s1
    800044aa:	fffff097          	auipc	ra,0xfffff
    800044ae:	0f8080e7          	jalr	248(ra) # 800035a2 <bunpin>
...
00000000800044ca <initlog>:
{
  ...
  initlock(&log.lock, "log");
    800044dc:	0005e497          	auipc	s1,0x5e
    800044e0:	16c48493          	addi	s1,s1,364 # 80062648 <log>
    800044e4:	00004597          	auipc	a1,0x4
    800044e8:	12c58593          	addi	a1,a1,300 # 80008610 <syscalls+0x1f0>
    800044ec:	8526                	mv	a0,s1
    800044ee:	ffffc097          	auipc	ra,0xffffc
    800044f2:	688080e7          	jalr	1672(ra) # 80000b76 <initlock>
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    8000450c:	e90080e7          	jalr	-368(ra) # 80003398 <bread>
  log.lh.n = lh->n;
    80004510:	4d34                	lw	a3,88(a0)
    80004512:	d4d4                	sw	a3,44(s1)
  for (i = 0; i < log.lh.n; i++) {
    80004514:	02d05563          	blez	a3,8000453e <initlog+0x74>
    80004518:	05c50793          	addi	a5,a0,92
    8000451c:	0005e717          	auipc	a4,0x5e
    80004520:	15c70713          	addi	a4,a4,348 # 80062678 <log+0x30>
    80004524:	36fd                	addiw	a3,a3,-1
    80004526:	1682                	slli	a3,a3,0x20
    80004528:	9281                	srli	a3,a3,0x20
    8000452a:	068a                	slli	a3,a3,0x2
    8000452c:	06050613          	addi	a2,a0,96
    80004530:	96b2                	add	a3,a3,a2
    log.lh.block[i] = lh->block[i];
    80004532:	4390                	lw	a2,0(a5)
    80004534:	c310                	sw	a2,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80004536:	0791                	addi	a5,a5,4
    80004538:	0711                	addi	a4,a4,4
    8000453a:	fed79ce3          	bne	a5,a3,80004532 <initlog+0x68>
  brelse(buf);
    8000453e:	fffff097          	auipc	ra,0xfffff
    80004542:	f8a080e7          	jalr	-118(ra) # 800034c8 <brelse>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    80004550:	0005e797          	auipc	a5,0x5e
    80004554:	1207a223          	sw	zero,292(a5) # 80062674 <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    8000457a:	0005e517          	auipc	a0,0x5e
    8000457e:	0ce50513          	addi	a0,a0,206 # 80062648 <log>
    80004582:	ffffc097          	auipc	ra,0xffffc
    80004586:	684080e7          	jalr	1668(ra) # 80000c06 <acquire>
  while(1){
    if(log.committing){
    8000458a:	0005e497          	auipc	s1,0x5e
    8000458e:	0be48493          	addi	s1,s1,190 # 80062648 <log>
      sleep(&log, &log.lock);
    ...
    8000459e:	d16080e7          	jalr	-746(ra) # 800022b0 <sleep>
    if(log.committing){
    ...
    800045ca:	cea080e7          	jalr	-790(ra) # 800022b0 <sleep>
    800045ce:	bfd1                	j	800045a2 <begin_op+0x34>
    } else {
      log.outstanding += 1;
    800045d0:	0005e517          	auipc	a0,0x5e
    800045d4:	07850513          	addi	a0,a0,120 # 80062648 <log>
    800045d8:	d114                	sw	a3,32(a0)
      release(&log.lock);
    800045da:	ffffc097          	auipc	ra,0xffffc
    800045de:	6e0080e7          	jalr	1760(ra) # 80000cba <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    80004600:	0005e497          	auipc	s1,0x5e
    80004604:	04848493          	addi	s1,s1,72 # 80062648 <log>
    80004608:	8526                	mv	a0,s1
    8000460a:	ffffc097          	auipc	ra,0xffffc
    8000460e:	5fc080e7          	jalr	1532(ra) # 80000c06 <acquire>
  log.outstanding -= 1;
  ...
  if(log.committing)
    ...
    8000461e:	e7b9                	bnez	a5,8000466c <end_op+0x7e>
    panic("log.committing");
  if(log.outstanding == 0){
    80004620:	04091e63          	bnez	s2,8000467c <end_op+0x8e>
    do_commit = 1;
    log.committing = 1;
    80004624:	0005e497          	auipc	s1,0x5e
    80004628:	02448493          	addi	s1,s1,36 # 80062648 <log>
  ...
  release(&log.lock);
    ...
    80004636:	688080e7          	jalr	1672(ra) # 80000cba <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    80004640:	0005e497          	auipc	s1,0x5e
    80004644:	00848493          	addi	s1,s1,8 # 80062648 <log>
    80004648:	8526                	mv	a0,s1
    8000464a:	ffffc097          	auipc	ra,0xffffc
    8000464e:	5bc080e7          	jalr	1468(ra) # 80000c06 <acquire>
    log.committing = 0;
    80004652:	0204a223          	sw	zero,36(s1)
    wakeup(&log);
    80004656:	8526                	mv	a0,s1
    80004658:	ffffe097          	auipc	ra,0xffffe
    8000465c:	ddc080e7          	jalr	-548(ra) # 80002434 <wakeup>
    release(&log.lock);
    80004660:	8526                	mv	a0,s1
    80004662:	ffffc097          	auipc	ra,0xffffc
    80004666:	658080e7          	jalr	1624(ra) # 80000cba <release>
}
    8000466a:	a03d                	j	80004698 <end_op+0xaa>
    panic("log.committing");
    8000466c:	00004517          	auipc	a0,0x4
    80004670:	fac50513          	addi	a0,a0,-84 # 80008618 <syscalls+0x1f8>
    80004674:	ffffc097          	auipc	ra,0xffffc
    80004678:	ed6080e7          	jalr	-298(ra) # 8000054a <panic>
    wakeup(&log);
    8000467c:	0005e497          	auipc	s1,0x5e
    80004680:	fcc48493          	addi	s1,s1,-52 # 80062648 <log>
    80004684:	8526                	mv	a0,s1
    80004686:	ffffe097          	auipc	ra,0xffffe
    8000468a:	dae080e7          	jalr	-594(ra) # 80002434 <wakeup>
  release(&log.lock);
    8000468e:	8526                	mv	a0,s1
    80004690:	ffffc097          	auipc	ra,0xffffc
    80004694:	62a080e7          	jalr	1578(ra) # 80000cba <release>
}
    ...
    800046a8:	8082                	ret
  for (tail = 0; tail < log.lh.n; tail++) {
    800046aa:	0005ea97          	auipc	s5,0x5e
    800046ae:	fcea8a93          	addi	s5,s5,-50 # 80062678 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800046b2:	0005ea17          	auipc	s4,0x5e
    800046b6:	f96a0a13          	addi	s4,s4,-106 # 80062648 <log>
    ...
    800046cc:	cd0080e7          	jalr	-816(ra) # 80003398 <bread>
    ...
    800046de:	cbe080e7          	jalr	-834(ra) # 80003398 <bread>
    ...
    800046f4:	66e080e7          	jalr	1646(ra) # 80000d5e <memmove>
    bwrite(to);  // write the log
    800046f8:	8526                	mv	a0,s1
    800046fa:	fffff097          	auipc	ra,0xfffff
    800046fe:	d90080e7          	jalr	-624(ra) # 8000348a <bwrite>
    brelse(from);
    80004702:	854e                	mv	a0,s3
    80004704:	fffff097          	auipc	ra,0xfffff
    80004708:	dc4080e7          	jalr	-572(ra) # 800034c8 <brelse>
    brelse(to);
    8000470c:	8526                	mv	a0,s1
    8000470e:	fffff097          	auipc	ra,0xfffff
    80004712:	dba080e7          	jalr	-582(ra) # 800034c8 <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    log.lh.n = 0;
    80004734:	0005e797          	auipc	a5,0x5e
    80004738:	f407a023          	sw	zero,-192(a5) # 80062674 <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    80004752:	0005e717          	auipc	a4,0x5e
    80004756:	f2272703          	lw	a4,-222(a4) # 80062674 <log+0x2c>
    8000475a:	47f5                	li	a5,29
    8000475c:	08e7c063          	blt	a5,a4,800047dc <log_write+0x96>
    80004760:	84aa                	mv	s1,a0
    80004762:	0005e797          	auipc	a5,0x5e
    80004766:	f027a783          	lw	a5,-254(a5) # 80062664 <log+0x1c>
    8000476a:	37fd                	addiw	a5,a5,-1
    8000476c:	06f75863          	bge	a4,a5,800047dc <log_write+0x96>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80004770:	0005e797          	auipc	a5,0x5e
    80004774:	ef87a783          	lw	a5,-264(a5) # 80062668 <log+0x20>
    80004778:	06f05a63          	blez	a5,800047ec <log_write+0xa6>
    panic("log_write outside of trans");

  acquire(&log.lock);
    8000477c:	0005e917          	auipc	s2,0x5e
    80004780:	ecc90913          	addi	s2,s2,-308 # 80062648 <log>
    80004784:	854a                	mv	a0,s2
    80004786:	ffffc097          	auipc	ra,0xffffc
    8000478a:	480080e7          	jalr	1152(ra) # 80000c06 <acquire>
  for (i = 0; i < log.lh.n; i++) {
    8000478e:	02c92603          	lw	a2,44(s2)
    80004792:	06c05563          	blez	a2,800047fc <log_write+0xb6>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
    80004796:	44cc                	lw	a1,12(s1)
    80004798:	0005e717          	auipc	a4,0x5e
    8000479c:	ee070713          	addi	a4,a4,-288 # 80062678 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
    800047a0:	4781                	li	a5,0
    if (log.lh.block[i] == b->blockno)   // log absorbtion
    800047a2:	4314                	lw	a3,0(a4)
    800047a4:	04b68d63          	beq	a3,a1,800047fe <log_write+0xb8>
  for (i = 0; i < log.lh.n; i++) {
    800047a8:	2785                	addiw	a5,a5,1
    800047aa:	0711                	addi	a4,a4,4
    800047ac:	fec79be3          	bne	a5,a2,800047a2 <log_write+0x5c>
      break;
  }
  log.lh.block[i] = b->blockno;
    800047b0:	0621                	addi	a2,a2,8
    800047b2:	060a                	slli	a2,a2,0x2
    800047b4:	0005e797          	auipc	a5,0x5e
    800047b8:	e9478793          	addi	a5,a5,-364 # 80062648 <log>
    800047bc:	963e                	add	a2,a2,a5
    800047be:	44dc                	lw	a5,12(s1)
    800047c0:	ca1c                	sw	a5,16(a2)
  if (i == log.lh.n) {  // Add new block to log?
    bpin(b);
    800047c2:	8526                	mv	a0,s1
    800047c4:	fffff097          	auipc	ra,0xfffff
    800047c8:	da2080e7          	jalr	-606(ra) # 80003566 <bpin>
    log.lh.n++;
    800047cc:	0005e717          	auipc	a4,0x5e
    800047d0:	e7c70713          	addi	a4,a4,-388 # 80062648 <log>
    800047d4:	575c                	lw	a5,44(a4)
    800047d6:	2785                	addiw	a5,a5,1
    800047d8:	d75c                	sw	a5,44(a4)
    800047da:	a83d                	j	80004818 <log_write+0xd2>
    panic("too big a transaction");
    800047dc:	00004517          	auipc	a0,0x4
    800047e0:	e4c50513          	addi	a0,a0,-436 # 80008628 <syscalls+0x208>
    800047e4:	ffffc097          	auipc	ra,0xffffc
    800047e8:	d66080e7          	jalr	-666(ra) # 8000054a <panic>
    panic("log_write outside of trans");
    800047ec:	00004517          	auipc	a0,0x4
    800047f0:	e5450513          	addi	a0,a0,-428 # 80008640 <syscalls+0x220>
    800047f4:	ffffc097          	auipc	ra,0xffffc
    800047f8:	d56080e7          	jalr	-682(ra) # 8000054a <panic>
  for (i = 0; i < log.lh.n; i++) {
    800047fc:	4781                	li	a5,0
  log.lh.block[i] = b->blockno;
    800047fe:	00878713          	addi	a4,a5,8
    80004802:	00271693          	slli	a3,a4,0x2
    80004806:	0005e717          	auipc	a4,0x5e
    8000480a:	e4270713          	addi	a4,a4,-446 # 80062648 <log>
    8000480e:	9736                	add	a4,a4,a3
    80004810:	44d4                	lw	a3,12(s1)
    80004812:	cb14                	sw	a3,16(a4)
  if (i == log.lh.n) {  // Add new block to log?
    80004814:	faf607e3          	beq	a2,a5,800047c2 <log_write+0x7c>
  }
  release(&log.lock);
    80004818:	0005e517          	auipc	a0,0x5e
    8000481c:	e3050513          	addi	a0,a0,-464 # 80062648 <log>
    80004820:	ffffc097          	auipc	ra,0xffffc
    80004824:	49a080e7          	jalr	1178(ra) # 80000cba <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80004848:	e1c58593          	addi	a1,a1,-484 # 80008660 <syscalls+0x240>
    8000484c:	0521                	addi	a0,a0,8
    8000484e:	ffffc097          	auipc	ra,0xffffc
    80004852:	328080e7          	jalr	808(ra) # 80000b76 <initlock>
  lk->name = name;
    80004856:	0324b023          	sd	s2,32(s1)
  lk->locked = 0;
    8000485a:	0004a023          	sw	zero,0(s1)
  lk->pid = 0;
    8000485e:	0204a423          	sw	zero,40(s1)
}
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    8000487c:	00850913          	addi	s2,a0,8
    80004880:	854a                	mv	a0,s2
    80004882:	ffffc097          	auipc	ra,0xffffc
    80004886:	384080e7          	jalr	900(ra) # 80000c06 <acquire>
  while (lk->locked) {
    8000488a:	409c                	lw	a5,0(s1)
    8000488c:	cb89                	beqz	a5,8000489e <acquiresleep+0x30>
    sleep(lk, &lk->lk);
    8000488e:	85ca                	mv	a1,s2
    80004890:	8526                	mv	a0,s1
    80004892:	ffffe097          	auipc	ra,0xffffe
    80004896:	a1e080e7          	jalr	-1506(ra) # 800022b0 <sleep>
  while (lk->locked) {
    8000489a:	409c                	lw	a5,0(s1)
    8000489c:	fbed                	bnez	a5,8000488e <acquiresleep+0x20>
  }
  lk->locked = 1;
    8000489e:	4785                	li	a5,1
    800048a0:	c09c                	sw	a5,0(s1)
  lk->pid = myproc()->pid;
    800048a2:	ffffd097          	auipc	ra,0xffffd
    800048a6:	16c080e7          	jalr	364(ra) # 80001a0e <myproc>
    800048aa:	5d1c                	lw	a5,56(a0)
    800048ac:	d49c                	sw	a5,40(s1)
  release(&lk->lk);
    800048ae:	854a                	mv	a0,s2
    800048b0:	ffffc097          	auipc	ra,0xffffc
    800048b4:	40a080e7          	jalr	1034(ra) # 80000cba <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    800048d2:	00850913          	addi	s2,a0,8
  ...
  wakeup(lk);
    ...
    800048ee:	b4a080e7          	jalr	-1206(ra) # 80002434 <wakeup>
  release(&lk->lk);
    800048f2:	854a                	mv	a0,s2
    800048f4:	ffffc097          	auipc	ra,0xffffc
    800048f8:	3c6080e7          	jalr	966(ra) # 80000cba <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80004922:	2e8080e7          	jalr	744(ra) # 80000c06 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
    80004926:	409c                	lw	a5,0(s1)
    80004928:	ef99                	bnez	a5,80004946 <holdingsleep+0x3e>
    8000492a:	4481                	li	s1,0
  release(&lk->lk);
  ...
  return r;
    ...
    80004944:	8082                	ret
  r = lk->locked && (lk->pid == myproc()->pid);
    80004946:	0284a983          	lw	s3,40(s1)
    8000494a:	ffffd097          	auipc	ra,0xffffd
    8000494e:	0c4080e7          	jalr	196(ra) # 80001a0e <myproc>
    80004952:	5d04                	lw	s1,56(a0)
    80004954:	413484b3          	sub	s1,s1,s3
    80004958:	0014b493          	seqz	s1,s1
    8000495c:	bfc1                	j	8000492c <holdingsleep+0x24>

000000008000495e <fileinit>:
...
fileinit(void)
{
    ...
    80004960:	e406                	sd	ra,8(sp)
    80004962:	e022                	sd	s0,0(sp)
    80004964:	0800                	addi	s0,sp,16
  initlock(&ftable.lock, "ftable");
    80004966:	00004597          	auipc	a1,0x4
    8000496a:	d0a58593          	addi	a1,a1,-758 # 80008670 <syscalls+0x250>
    8000496e:	0005e517          	auipc	a0,0x5e
    80004972:	e2250513          	addi	a0,a0,-478 # 80062790 <ftable>
    80004976:	ffffc097          	auipc	ra,0xffffc
    8000497a:	200080e7          	jalr	512(ra) # 80000b76 <initlock>
}
    8000497e:	60a2                	ld	ra,8(sp)
    80004980:	6402                	ld	s0,0(sp)
    80004982:	0141                	addi	sp,sp,16
    80004984:	8082                	ret

0000000080004986 <filealloc>:
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    80004990:	0005e517          	auipc	a0,0x5e
    80004994:	e0050513          	addi	a0,a0,-512 # 80062790 <ftable>
    80004998:	ffffc097          	auipc	ra,0xffffc
    8000499c:	26e080e7          	jalr	622(ra) # 80000c06 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800049a0:	0005e497          	auipc	s1,0x5e
    800049a4:	e0848493          	addi	s1,s1,-504 # 800627a8 <ftable+0x18>
    800049a8:	0005f717          	auipc	a4,0x5f
    800049ac:	da070713          	addi	a4,a4,-608 # 80063748 <ftable+0xfb8>
    if(f->ref == 0){
    800049b0:	40dc                	lw	a5,4(s1)
    800049b2:	cf99                	beqz	a5,800049d0 <filealloc+0x4a>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800049b4:	02848493          	addi	s1,s1,40
    800049b8:	fee49ce3          	bne	s1,a4,800049b0 <filealloc+0x2a>
      f->ref = 1;
      release(&ftable.lock);
      return f;
    }
  ...
  release(&ftable.lock);
    800049bc:	0005e517          	auipc	a0,0x5e
    800049c0:	dd450513          	addi	a0,a0,-556 # 80062790 <ftable>
    800049c4:	ffffc097          	auipc	ra,0xffffc
    800049c8:	2f6080e7          	jalr	758(ra) # 80000cba <release>
  return 0;
    800049cc:	4481                	li	s1,0
    800049ce:	a819                	j	800049e4 <filealloc+0x5e>
      f->ref = 1;
    800049d0:	4785                	li	a5,1
    800049d2:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    800049d4:	0005e517          	auipc	a0,0x5e
    800049d8:	dbc50513          	addi	a0,a0,-580 # 80062790 <ftable>
    800049dc:	ffffc097          	auipc	ra,0xffffc
    800049e0:	2de080e7          	jalr	734(ra) # 80000cba <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004a08:	202080e7          	jalr	514(ra) # 80000c06 <acquire>
  if(f->ref < 1)
    80004a0c:	40dc                	lw	a5,4(s1)
    80004a0e:	02f05263          	blez	a5,80004a32 <filedup+0x42>
    panic("filedup");
  f->ref++;
    80004a12:	2785                	addiw	a5,a5,1
    80004a14:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80004a16:	0005e517          	auipc	a0,0x5e
    80004a1a:	d7a50513          	addi	a0,a0,-646 # 80062790 <ftable>
    80004a1e:	ffffc097          	auipc	ra,0xffffc
    80004a22:	29c080e7          	jalr	668(ra) # 80000cba <release>
  return f;
}
    ...
    80004a36:	c4650513          	addi	a0,a0,-954 # 80008678 <syscalls+0x258>
    80004a3a:	ffffc097          	auipc	ra,0xffffc
    80004a3e:	b10080e7          	jalr	-1264(ra) # 8000054a <panic>

0000000080004a42 <fileclose>:

// Close file f.  (Decrement ref count, close when reaches 0.)
void
fileclose(struct file *f)
{
    80004a42:	7139                	addi	sp,sp,-64
    80004a44:	fc06                	sd	ra,56(sp)
    80004a46:	f822                	sd	s0,48(sp)
    80004a48:	f426                	sd	s1,40(sp)
    80004a4a:	f04a                	sd	s2,32(sp)
    80004a4c:	ec4e                	sd	s3,24(sp)
    80004a4e:	e852                	sd	s4,16(sp)
    80004a50:	e456                	sd	s5,8(sp)
    80004a52:	0080                	addi	s0,sp,64
    80004a54:	84aa                	mv	s1,a0
  struct file ff;

  acquire(&ftable.lock);
    80004a56:	0005e517          	auipc	a0,0x5e
    80004a5a:	d3a50513          	addi	a0,a0,-710 # 80062790 <ftable>
    80004a5e:	ffffc097          	auipc	ra,0xffffc
    80004a62:	1a8080e7          	jalr	424(ra) # 80000c06 <acquire>
  if(f->ref < 1)
    80004a66:	40dc                	lw	a5,4(s1)
    80004a68:	06f05163          	blez	a5,80004aca <fileclose+0x88>
    panic("fileclose");
  if(--f->ref > 0){
    80004a6c:	37fd                	addiw	a5,a5,-1
    80004a6e:	0007871b          	sext.w	a4,a5
    80004a72:	c0dc                	sw	a5,4(s1)
    80004a74:	06e04363          	bgtz	a4,80004ada <fileclose+0x98>
    release(&ftable.lock);
    return;
  }
  ff = *f;
    80004a78:	0004a903          	lw	s2,0(s1)
    80004a7c:	0094ca83          	lbu	s5,9(s1)
    80004a80:	0104ba03          	ld	s4,16(s1)
    80004a84:	0184b983          	ld	s3,24(s1)
  f->ref = 0;
    80004a88:	0004a223          	sw	zero,4(s1)
  f->type = FD_NONE;
    80004a8c:	0004a023          	sw	zero,0(s1)
  release(&ftable.lock);
    80004a90:	0005e517          	auipc	a0,0x5e
    80004a94:	d0050513          	addi	a0,a0,-768 # 80062790 <ftable>
    80004a98:	ffffc097          	auipc	ra,0xffffc
    80004a9c:	222080e7          	jalr	546(ra) # 80000cba <release>

  if(ff.type == FD_PIPE){
    80004aa0:	4785                	li	a5,1
    80004aa2:	04f90d63          	beq	s2,a5,80004afc <fileclose+0xba>
    pipeclose(ff.pipe, ff.writable);
  } else if(ff.type == FD_INODE || ff.type == FD_DEVICE){
    80004aa6:	3979                	addiw	s2,s2,-2
    80004aa8:	4785                	li	a5,1
    80004aaa:	0527e063          	bltu	a5,s2,80004aea <fileclose+0xa8>
    begin_op();
    80004aae:	00000097          	auipc	ra,0x0
    80004ab2:	ac0080e7          	jalr	-1344(ra) # 8000456e <begin_op>
    iput(ff.ip);
    80004ab6:	854e                	mv	a0,s3
    80004ab8:	fffff097          	auipc	ra,0xfffff
    80004abc:	29c080e7          	jalr	668(ra) # 80003d54 <iput>
    end_op();
    80004ac0:	00000097          	auipc	ra,0x0
    80004ac4:	b2e080e7          	jalr	-1234(ra) # 800045ee <end_op>
    80004ac8:	a00d                	j	80004aea <fileclose+0xa8>
    panic("fileclose");
    80004aca:	00004517          	auipc	a0,0x4
    80004ace:	bb650513          	addi	a0,a0,-1098 # 80008680 <syscalls+0x260>
    80004ad2:	ffffc097          	auipc	ra,0xffffc
    80004ad6:	a78080e7          	jalr	-1416(ra) # 8000054a <panic>
    release(&ftable.lock);
    80004ada:	0005e517          	auipc	a0,0x5e
    80004ade:	cb650513          	addi	a0,a0,-842 # 80062790 <ftable>
    80004ae2:	ffffc097          	auipc	ra,0xffffc
    80004ae6:	1d8080e7          	jalr	472(ra) # 80000cba <release>
  }
}
    80004aea:	70e2                	ld	ra,56(sp)
    80004aec:	7442                	ld	s0,48(sp)
    80004aee:	74a2                	ld	s1,40(sp)
    80004af0:	7902                	ld	s2,32(sp)
    80004af2:	69e2                	ld	s3,24(sp)
    80004af4:	6a42                	ld	s4,16(sp)
    80004af6:	6aa2                	ld	s5,8(sp)
    80004af8:	6121                	addi	sp,sp,64
    80004afa:	8082                	ret
    pipeclose(ff.pipe, ff.writable);
    80004afc:	85d6                	mv	a1,s5
    80004afe:	8552                	mv	a0,s4
    80004b00:	00000097          	auipc	ra,0x0
    80004b04:	374080e7          	jalr	884(ra) # 80004e74 <pipeclose>
    80004b08:	b7cd                	j	80004aea <fileclose+0xa8>

0000000080004b0a <filestat>:
...
filestat(struct file *f, uint64 addr)
{
    ...
    80004b1a:	89ae                	mv	s3,a1
  struct proc *p = myproc();
    80004b1c:	ffffd097          	auipc	ra,0xffffd
    80004b20:	ef2080e7          	jalr	-270(ra) # 80001a0e <myproc>
  struct stat st;
  
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    80004b24:	409c                	lw	a5,0(s1)
    80004b26:	37f9                	addiw	a5,a5,-2
    80004b28:	4705                	li	a4,1
    80004b2a:	04f76863          	bltu	a4,a5,80004b7a <filestat+0x70>
    80004b2e:	892a                	mv	s2,a0
    ilock(f->ip);
    80004b30:	6c88                	ld	a0,24(s1)
    80004b32:	fffff097          	auipc	ra,0xfffff
    80004b36:	068080e7          	jalr	104(ra) # 80003b9a <ilock>
    stati(f->ip, &st);
    80004b3a:	fb840593          	addi	a1,s0,-72
    80004b3e:	6c88                	ld	a0,24(s1)
    80004b40:	fffff097          	auipc	ra,0xfffff
    80004b44:	2e4080e7          	jalr	740(ra) # 80003e24 <stati>
    iunlock(f->ip);
    80004b48:	6c88                	ld	a0,24(s1)
    80004b4a:	fffff097          	auipc	ra,0xfffff
    80004b4e:	112080e7          	jalr	274(ra) # 80003c5c <iunlock>
    if(copyout(p->pagetable, addr, (char *)&st, sizeof(st)) < 0)
    80004b52:	6505                	lui	a0,0x1
    80004b54:	954a                	add	a0,a0,s2
    80004b56:	46e1                	li	a3,24
    80004b58:	fb840613          	addi	a2,s0,-72
    80004b5c:	85ce                	mv	a1,s3
    80004b5e:	7148                	ld	a0,160(a0)
    80004b60:	ffffd097          	auipc	ra,0xffffd
    80004b64:	b22080e7          	jalr	-1246(ra) # 80001682 <copyout>
  ...
  return -1;
    ...
    80004b7c:	bfc5                	j	80004b6c <filestat+0x62>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->readable == 0)
    80004b8c:	00854783          	lbu	a5,8(a0) # 1008 <_entry-0x7fffeff8>
  ...
  if(f->type == FD_PIPE){
    ...
    80004bb2:	fec080e7          	jalr	-20(ra) # 80003b9a <ilock>
    ...
    80004bc4:	28e080e7          	jalr	654(ra) # 80003e4e <readi>
    ...
    80004bda:	086080e7          	jalr	134(ra) # 80003c5c <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    80004bf4:	3fc080e7          	jalr	1020(ra) # 80004fec <piperead>
    ...
    80004c0e:	0005e717          	auipc	a4,0x5e
    80004c12:	ae270713          	addi	a4,a4,-1310 # 800626f0 <devsw>
    ...
    80004c28:	a6c50513          	addi	a0,a0,-1428 # 80008690 <syscalls+0x270>
    80004c2c:	ffffc097          	auipc	ra,0xffffc
    80004c30:	91e080e7          	jalr	-1762(ra) # 8000054a <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->writable == 0)
    ...
    80004c44:	14078563          	beqz	a5,80004d8e <filewrite+0x14e>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004c76:	10e79463          	bne	a5,a4,80004d7e <filewrite+0x13e>
    ...
    int i = 0;
    while(i < n){
    80004c7a:	0ec05e63          	blez	a2,80004d76 <filewrite+0x136>
    int i = 0;
    ...
    80004c8c:	a851                	j	80004d20 <filewrite+0xe0>
    ret = pipewrite(f->pipe, addr, n);
    80004c8e:	6908                	ld	a0,16(a0)
    80004c90:	00000097          	auipc	ra,0x0
    80004c94:	254080e7          	jalr	596(ra) # 80004ee4 <pipewrite>
    80004c98:	a85d                	j	80004d4e <filewrite+0x10e>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
    80004c9a:	02451783          	lh	a5,36(a0)
    80004c9e:	03079693          	slli	a3,a5,0x30
    80004ca2:	92c1                	srli	a3,a3,0x30
    80004ca4:	4725                	li	a4,9
    80004ca6:	0ed76663          	bltu	a4,a3,80004d92 <filewrite+0x152>
    80004caa:	0792                	slli	a5,a5,0x4
    80004cac:	0005e717          	auipc	a4,0x5e
    80004cb0:	a4470713          	addi	a4,a4,-1468 # 800626f0 <devsw>
    80004cb4:	97ba                	add	a5,a5,a4
    80004cb6:	679c                	ld	a5,8(a5)
    80004cb8:	cff9                	beqz	a5,80004d96 <filewrite+0x156>
    ret = devsw[f->major].write(1, addr, n);
    80004cba:	4505                	li	a0,1
    80004cbc:	9782                	jalr	a5
    80004cbe:	a841                	j	80004d4e <filewrite+0x10e>
    80004cc0:	00048c1b          	sext.w	s8,s1
      int n1 = n - i;
      if(n1 > max)
        n1 = max;
    ...
    80004cc8:	8aa080e7          	jalr	-1878(ra) # 8000456e <begin_op>
      ilock(f->ip);
    80004ccc:	01893503          	ld	a0,24(s2)
    80004cd0:	fffff097          	auipc	ra,0xfffff
    80004cd4:	eca080e7          	jalr	-310(ra) # 80003b9a <ilock>
      if ((r = writei(f->ip, 1, addr + i, f->off, n1)) > 0)
    80004cd8:	8762                	mv	a4,s8
    80004cda:	02092683          	lw	a3,32(s2)
    80004cde:	01598633          	add	a2,s3,s5
    80004ce2:	4585                	li	a1,1
    80004ce4:	01893503          	ld	a0,24(s2)
    80004ce8:	fffff097          	auipc	ra,0xfffff
    80004cec:	25e080e7          	jalr	606(ra) # 80003f46 <writei>
    80004cf0:	84aa                	mv	s1,a0
    80004cf2:	02a05f63          	blez	a0,80004d30 <filewrite+0xf0>
        f->off += r;
    80004cf6:	02092783          	lw	a5,32(s2)
    80004cfa:	9fa9                	addw	a5,a5,a0
    80004cfc:	02f92023          	sw	a5,32(s2)
      iunlock(f->ip);
    80004d00:	01893503          	ld	a0,24(s2)
    80004d04:	fffff097          	auipc	ra,0xfffff
    80004d08:	f58080e7          	jalr	-168(ra) # 80003c5c <iunlock>
      end_op();
    80004d0c:	00000097          	auipc	ra,0x0
    80004d10:	8e2080e7          	jalr	-1822(ra) # 800045ee <end_op>

      if(r < 0)
        break;
      if(r != n1)
    80004d14:	049c1963          	bne	s8,s1,80004d66 <filewrite+0x126>
        panic("short filewrite");
      i += r;
    80004d18:	013489bb          	addw	s3,s1,s3
    while(i < n){
    80004d1c:	0349d663          	bge	s3,s4,80004d48 <filewrite+0x108>
      int n1 = n - i;
    80004d20:	413a07bb          	subw	a5,s4,s3
      if(n1 > max)
    80004d24:	84be                	mv	s1,a5
    80004d26:	2781                	sext.w	a5,a5
    80004d28:	f8fb5ce3          	bge	s6,a5,80004cc0 <filewrite+0x80>
    80004d2c:	84de                	mv	s1,s7
    80004d2e:	bf49                	j	80004cc0 <filewrite+0x80>
      iunlock(f->ip);
    80004d30:	01893503          	ld	a0,24(s2)
    80004d34:	fffff097          	auipc	ra,0xfffff
    80004d38:	f28080e7          	jalr	-216(ra) # 80003c5c <iunlock>
      end_op();
    80004d3c:	00000097          	auipc	ra,0x0
    80004d40:	8b2080e7          	jalr	-1870(ra) # 800045ee <end_op>
      if(r < 0)
    80004d44:	fc04d8e3          	bgez	s1,80004d14 <filewrite+0xd4>
    }
    ret = (i == n ? n : -1);
    80004d48:	8552                	mv	a0,s4
    80004d4a:	033a1863          	bne	s4,s3,80004d7a <filewrite+0x13a>
  } else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80004d6a:	93a50513          	addi	a0,a0,-1734 # 800086a0 <syscalls+0x280>
    80004d6e:	ffffb097          	auipc	ra,0xffffb
    80004d72:	7dc080e7          	jalr	2012(ra) # 8000054a <panic>
    int i = 0;
    80004d76:	4981                	li	s3,0
    80004d78:	bfc1                	j	80004d48 <filewrite+0x108>
    ret = (i == n ? n : -1);
    80004d7a:	557d                	li	a0,-1
    80004d7c:	bfc9                	j	80004d4e <filewrite+0x10e>
    panic("filewrite");
    80004d7e:	00004517          	auipc	a0,0x4
    80004d82:	93250513          	addi	a0,a0,-1742 # 800086b0 <syscalls+0x290>
    80004d86:	ffffb097          	auipc	ra,0xffffb
    80004d8a:	7c4080e7          	jalr	1988(ra) # 8000054a <panic>
    return -1;
    ...
    80004d94:	bf6d                	j	80004d4e <filewrite+0x10e>
    80004d96:	557d                	li	a0,-1
    80004d98:	bf5d                	j	80004d4e <filewrite+0x10e>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004df2:	8d258593          	addi	a1,a1,-1838 # 800086c0 <syscalls+0x2a0>
    80004df6:	ffffc097          	auipc	ra,0xffffc
    80004dfa:	d80080e7          	jalr	-640(ra) # 80000b76 <initlock>
  (*f0)->type = FD_PIPE;
 ...
 bad:
  ...
  if(*f0)
    ...
    80004e48:	bfe080e7          	jalr	-1026(ra) # 80004a42 <fileclose>
  if(*f1)
  ...
  if(*f1)
    ...
    80004e5a:	bec080e7          	jalr	-1044(ra) # 80004a42 <fileclose>
  return -1;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80004e88:	d82080e7          	jalr	-638(ra) # 80000c06 <acquire>
  if(writable){
    ...
    80004e9c:	59c080e7          	jalr	1436(ra) # 80002434 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80004eac:	e12080e7          	jalr	-494(ra) # 80000cba <release>
    kfree((char*)pi);
    80004eb0:	8526                	mv	a0,s1
    80004eb2:	ffffc097          	auipc	ra,0xffffc
    80004eb6:	b68080e7          	jalr	-1176(ra) # 80000a1a <kfree>
  } else
    release(&pi->lock);
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004efc:	1880                	addi	s0,sp,112
    80004efe:	84aa                	mv	s1,a0
    80004f00:	8b2e                	mv	s6,a1
    80004f02:	8ab2                	mv	s5,a2
  int i;
  char ch;
  struct proc *pr = myproc();
    80004f04:	ffffd097          	auipc	ra,0xffffd
    80004f08:	b0a080e7          	jalr	-1270(ra) # 80001a0e <myproc>
    80004f0c:	892a                	mv	s2,a0

  acquire(&pi->lock);
    80004f0e:	8526                	mv	a0,s1
    80004f10:	ffffc097          	auipc	ra,0xffffc
    80004f14:	cf6080e7          	jalr	-778(ra) # 80000c06 <acquire>
  for(i = 0; i < n; i++){
    80004f18:	09505963          	blez	s5,80004faa <pipewrite+0xc6>
    ...
    while(pi->nwrite == pi->nread + PIPESIZE){  //DOC: pipewrite-full
      ...
      wakeup(&pi->nread);
    80004f1e:	21848a13          	addi	s4,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80004f22:	21c48993          	addi	s3,s1,540
    }
    if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    80004f26:	6c05                	lui	s8,0x1
    80004f28:	9c4a                	add	s8,s8,s2
    80004f2a:	5cfd                	li	s9,-1
    while(pi->nwrite == pi->nread + PIPESIZE){  //DOC: pipewrite-full
    80004f2c:	2184a783          	lw	a5,536(s1)
    80004f30:	21c4a703          	lw	a4,540(s1)
    80004f34:	2007879b          	addiw	a5,a5,512
    80004f38:	02f71b63          	bne	a4,a5,80004f6e <pipewrite+0x8a>
      if(pi->readopen == 0 || pr->killed){
    80004f3c:	2204a783          	lw	a5,544(s1)
    80004f40:	c3d1                	beqz	a5,80004fc4 <pipewrite+0xe0>
    80004f42:	03092783          	lw	a5,48(s2)
    80004f46:	efbd                	bnez	a5,80004fc4 <pipewrite+0xe0>
      wakeup(&pi->nread);
    80004f48:	8552                	mv	a0,s4
    80004f4a:	ffffd097          	auipc	ra,0xffffd
    80004f4e:	4ea080e7          	jalr	1258(ra) # 80002434 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004f52:	85a6                	mv	a1,s1
    80004f54:	854e                	mv	a0,s3
    80004f56:	ffffd097          	auipc	ra,0xffffd
    80004f5a:	35a080e7          	jalr	858(ra) # 800022b0 <sleep>
    while(pi->nwrite == pi->nread + PIPESIZE){  //DOC: pipewrite-full
    80004f5e:	2184a783          	lw	a5,536(s1)
    80004f62:	21c4a703          	lw	a4,540(s1)
    80004f66:	2007879b          	addiw	a5,a5,512
    80004f6a:	fcf709e3          	beq	a4,a5,80004f3c <pipewrite+0x58>
    if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    80004f6e:	4685                	li	a3,1
    80004f70:	865a                	mv	a2,s6
    80004f72:	f9f40593          	addi	a1,s0,-97
    80004f76:	0a0c3503          	ld	a0,160(s8) # 10a0 <_entry-0x7fffef60>
    80004f7a:	ffffc097          	auipc	ra,0xffffc
    80004f7e:	794080e7          	jalr	1940(ra) # 8000170e <copyin>
    80004f82:	03950563          	beq	a0,s9,80004fac <pipewrite+0xc8>
      break;
  ...
  for(i = 0; i < n; i++){
    80004fa0:	2b85                	addiw	s7,s7,1
    80004fa2:	0b05                	addi	s6,s6,1
    80004fa4:	f97a94e3          	bne	s5,s7,80004f2c <pipewrite+0x48>
    80004fa8:	a011                	j	80004fac <pipewrite+0xc8>
    80004faa:	4b81                	li	s7,0
  }
  wakeup(&pi->nread);
    80004fac:	21848513          	addi	a0,s1,536
  ...
  release(&pi->lock);
    ...
    80004fbe:	d00080e7          	jalr	-768(ra) # 80000cba <release>
  return i;
    80004fc2:	a039                	j	80004fd0 <pipewrite+0xec>
        release(&pi->lock);
    80004fc4:	8526                	mv	a0,s1
    80004fc6:	ffffc097          	auipc	ra,0xffffc
    80004fca:	cf4080e7          	jalr	-780(ra) # 80000cba <release>
        return -1;
    80004fce:	5bfd                	li	s7,-1
}
...
piperead(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004ffc:	e85a                	sd	s6,16(sp)
    80004ffe:	0880                	addi	s0,sp,80
    80005000:	84aa                	mv	s1,a0
    80005002:	892e                	mv	s2,a1
    80005004:	8a32                	mv	s4,a2
  int i;
  struct proc *pr = myproc();
    80005006:	ffffd097          	auipc	ra,0xffffd
    8000500a:	a08080e7          	jalr	-1528(ra) # 80001a0e <myproc>
  ...
  acquire(&pi->lock);
    ...
    80005016:	bf4080e7          	jalr	-1036(ra) # 80000c06 <acquire>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    8000501a:	2184a703          	lw	a4,536(s1)
    ...
    80005022:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80005026:	02f71463          	bne	a4,a5,8000504e <piperead+0x62>
    8000502a:	2244a783          	lw	a5,548(s1)
    8000502e:	c385                	beqz	a5,8000504e <piperead+0x62>
    if(pr->killed){
    80005030:	030aa783          	lw	a5,48(s5)
    80005034:	ebd1                	bnez	a5,800050c8 <piperead+0xdc>
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    80005036:	85a6                	mv	a1,s1
    80005038:	854e                	mv	a0,s3
    8000503a:	ffffd097          	auipc	ra,0xffffd
    8000503e:	276080e7          	jalr	630(ra) # 800022b0 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80005042:	2184a703          	lw	a4,536(s1)
    80005046:	21c4a783          	lw	a5,540(s1)
    8000504a:	fef700e3          	beq	a4,a5,8000502a <piperead+0x3e>
  }
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    8000504e:	4981                	li	s3,0
    80005050:	09405363          	blez	s4,800050d6 <piperead+0xea>
    if(pi->nread == pi->nwrite)
      break;
    ch = pi->data[pi->nread++ % PIPESIZE];
    if(copyout(pr->pagetable, addr + i, &ch, 1) == -1)
    80005054:	6505                	lui	a0,0x1
    80005056:	9aaa                	add	s5,s5,a0
    80005058:	5b7d                	li	s6,-1
    if(pi->nread == pi->nwrite)
    8000505a:	2184a783          	lw	a5,536(s1)
    8000505e:	21c4a703          	lw	a4,540(s1)
    80005062:	02f70d63          	beq	a4,a5,8000509c <piperead+0xb0>
    ch = pi->data[pi->nread++ % PIPESIZE];
    80005066:	0017871b          	addiw	a4,a5,1
    8000506a:	20e4ac23          	sw	a4,536(s1)
    8000506e:	1ff7f793          	andi	a5,a5,511
    80005072:	97a6                	add	a5,a5,s1
    80005074:	0187c783          	lbu	a5,24(a5)
    80005078:	faf40fa3          	sb	a5,-65(s0)
    if(copyout(pr->pagetable, addr + i, &ch, 1) == -1)
    8000507c:	4685                	li	a3,1
    8000507e:	fbf40613          	addi	a2,s0,-65
    80005082:	85ca                	mv	a1,s2
    80005084:	0a0ab503          	ld	a0,160(s5)
    80005088:	ffffc097          	auipc	ra,0xffffc
    8000508c:	5fa080e7          	jalr	1530(ra) # 80001682 <copyout>
    80005090:	01650663          	beq	a0,s6,8000509c <piperead+0xb0>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80005094:	2985                	addiw	s3,s3,1
    80005096:	0905                	addi	s2,s2,1
    80005098:	fd3a11e3          	bne	s4,s3,8000505a <piperead+0x6e>
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    8000509c:	21c48513          	addi	a0,s1,540
    800050a0:	ffffd097          	auipc	ra,0xffffd
    800050a4:	394080e7          	jalr	916(ra) # 80002434 <wakeup>
  release(&pi->lock);
    800050a8:	8526                	mv	a0,s1
    800050aa:	ffffc097          	auipc	ra,0xffffc
    800050ae:	c10080e7          	jalr	-1008(ra) # 80000cba <release>
  return i;
}
    ...
    800050c2:	6b42                	ld	s6,16(sp)
    800050c4:	6161                	addi	sp,sp,80
    800050c6:	8082                	ret
      release(&pi->lock);
    800050c8:	8526                	mv	a0,s1
    800050ca:	ffffc097          	auipc	ra,0xffffc
    800050ce:	bf0080e7          	jalr	-1040(ra) # 80000cba <release>
      return -1;
    800050d2:	59fd                	li	s3,-1
    800050d4:	bff9                	j	800050b2 <piperead+0xc6>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    800050d6:	4981                	li	s3,0
    800050d8:	b7d1                	j	8000509c <piperead+0xb0>

00000000800050da <exec>:
...
{
    800050da:	de010113          	addi	sp,sp,-544
    800050de:	20113c23          	sd	ra,536(sp)
    800050e2:	20813823          	sd	s0,528(sp)
    800050e6:	20913423          	sd	s1,520(sp)
    800050ea:	21213023          	sd	s2,512(sp)
    800050ee:	ffce                	sd	s3,504(sp)
    800050f0:	fbd2                	sd	s4,496(sp)
    800050f2:	f7d6                	sd	s5,488(sp)
    800050f4:	f3da                	sd	s6,480(sp)
    800050f6:	efde                	sd	s7,472(sp)
    800050f8:	ebe2                	sd	s8,464(sp)
    800050fa:	e7e6                	sd	s9,456(sp)
    800050fc:	e3ea                	sd	s10,448(sp)
    800050fe:	ff6e                	sd	s11,440(sp)
    80005100:	1400                	addi	s0,sp,544
    80005102:	892a                	mv	s2,a0
    80005104:	dea43423          	sd	a0,-536(s0)
    80005108:	deb43823          	sd	a1,-528(s0)
  ...
  struct proc *p = myproc();
    ...
    80005110:	902080e7          	jalr	-1790(ra) # 80001a0e <myproc>
    80005114:	84aa                	mv	s1,a0

  begin_op();
    80005116:	fffff097          	auipc	ra,0xfffff
    8000511a:	458080e7          	jalr	1112(ra) # 8000456e <begin_op>

  if((ip = namei(path)) == 0){
    8000511e:	854a                	mv	a0,s2
    80005120:	fffff097          	auipc	ra,0xfffff
    80005124:	232080e7          	jalr	562(ra) # 80004352 <namei>
    80005128:	c93d                	beqz	a0,8000519e <exec+0xc4>
 ...
 bad:
  ...
  if(ip){
    ...
    80005168:	c98080e7          	jalr	-872(ra) # 80003dfc <iunlockput>
    end_op();
    8000516c:	fffff097          	auipc	ra,0xfffff
    80005170:	482080e7          	jalr	1154(ra) # 800045ee <end_op>
  }
  return -1;
    80005174:	557d                	li	a0,-1
}
    80005176:	21813083          	ld	ra,536(sp)
    8000517a:	21013403          	ld	s0,528(sp)
    8000517e:	20813483          	ld	s1,520(sp)
    80005182:	20013903          	ld	s2,512(sp)
    80005186:	79fe                	ld	s3,504(sp)
    80005188:	7a5e                	ld	s4,496(sp)
    8000518a:	7abe                	ld	s5,488(sp)
    8000518c:	7b1e                	ld	s6,480(sp)
    8000518e:	6bfe                	ld	s7,472(sp)
    80005190:	6c5e                	ld	s8,464(sp)
    80005192:	6cbe                	ld	s9,456(sp)
    80005194:	6d1e                	ld	s10,448(sp)
    80005196:	7dfa                	ld	s11,440(sp)
    80005198:	22010113          	addi	sp,sp,544
    8000519c:	8082                	ret
    end_op();
    8000519e:	fffff097          	auipc	ra,0xfffff
    800051a2:	450080e7          	jalr	1104(ra) # 800045ee <end_op>
    return -1;
    800051a6:	557d                	li	a0,-1
    800051a8:	b7f9                	j	80005176 <exec+0x9c>
  if((pagetable = proc_pagetable(p)) == 0)
    800051aa:	8526                	mv	a0,s1
    800051ac:	ffffd097          	auipc	ra,0xffffd
    800051b0:	926080e7          	jalr	-1754(ra) # 80001ad2 <proc_pagetable>
    800051b4:	8b2a                	mv	s6,a0
    800051b6:	d555                	beqz	a0,80005162 <exec+0x88>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800051b8:	e6842783          	lw	a5,-408(s0)
    800051bc:	e8045703          	lhu	a4,-384(s0)
    800051c0:	c735                	beqz	a4,8000522c <exec+0x152>
  uint64 argc, sz = 0, sp, ustack[MAXARG+1], stackbase;
    800051c2:	4481                	li	s1,0
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800051c4:	e0043423          	sd	zero,-504(s0)
    if(ph.vaddr % PGSIZE != 0)
    800051c8:	6a05                	lui	s4,0x1
    800051ca:	fffa0713          	addi	a4,s4,-1 # fff <_entry-0x7ffff001>
    800051ce:	dee43023          	sd	a4,-544(s0)
  uint64 pa;
  ...
  for(i = 0; i < sz; i += PGSIZE){
    800051d2:	6d85                	lui	s11,0x1
    800051d4:	7d7d                	lui	s10,0xfffff
    800051d6:	a489                	j	80005418 <exec+0x33e>
    pa = walkaddr(pagetable, va + i);
    if(pa == 0)
      panic("loadseg: address should exist");
    800051d8:	00003517          	auipc	a0,0x3
    800051dc:	4f050513          	addi	a0,a0,1264 # 800086c8 <syscalls+0x2a8>
    800051e0:	ffffb097          	auipc	ra,0xffffb
    800051e4:	36a080e7          	jalr	874(ra) # 8000054a <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, 0, (uint64)pa, offset+i, n) != n)
    800051e8:	874a                	mv	a4,s2
    800051ea:	009c86bb          	addw	a3,s9,s1
    800051ee:	4581                	li	a1,0
    800051f0:	8556                	mv	a0,s5
    800051f2:	fffff097          	auipc	ra,0xfffff
    800051f6:	c5c080e7          	jalr	-932(ra) # 80003e4e <readi>
    800051fa:	2501                	sext.w	a0,a0
    800051fc:	1aa91e63          	bne	s2,a0,800053b8 <exec+0x2de>
  for(i = 0; i < sz; i += PGSIZE){
    80005200:	009d84bb          	addw	s1,s11,s1
    80005204:	013d09bb          	addw	s3,s10,s3
    80005208:	1f74f863          	bgeu	s1,s7,800053f8 <exec+0x31e>
    pa = walkaddr(pagetable, va + i);
    8000520c:	02049593          	slli	a1,s1,0x20
    80005210:	9181                	srli	a1,a1,0x20
    80005212:	95e2                	add	a1,a1,s8
    80005214:	855a                	mv	a0,s6
    80005216:	ffffc097          	auipc	ra,0xffffc
    8000521a:	e7a080e7          	jalr	-390(ra) # 80001090 <walkaddr>
    8000521e:	862a                	mv	a2,a0
    if(pa == 0)
    80005220:	dd45                	beqz	a0,800051d8 <exec+0xfe>
      n = PGSIZE;
    80005222:	8952                	mv	s2,s4
    if(sz - i < PGSIZE)
    80005224:	fd49f2e3          	bgeu	s3,s4,800051e8 <exec+0x10e>
      n = sz - i;
    80005228:	894e                	mv	s2,s3
    8000522a:	bf7d                	j	800051e8 <exec+0x10e>
  uint64 argc, sz = 0, sp, ustack[MAXARG+1], stackbase;
    8000522c:	4481                	li	s1,0
  iunlockput(ip);
    8000522e:	8556                	mv	a0,s5
    80005230:	fffff097          	auipc	ra,0xfffff
    80005234:	bcc080e7          	jalr	-1076(ra) # 80003dfc <iunlockput>
  end_op();
    80005238:	fffff097          	auipc	ra,0xfffff
    8000523c:	3b6080e7          	jalr	950(ra) # 800045ee <end_op>
  p = myproc();
    80005240:	ffffc097          	auipc	ra,0xffffc
    80005244:	7ce080e7          	jalr	1998(ra) # 80001a0e <myproc>
    80005248:	8baa                	mv	s7,a0
  uint64 oldsz = p->sz;
    8000524a:	6785                	lui	a5,0x1
    8000524c:	00f50733          	add	a4,a0,a5
    80005250:	09873d03          	ld	s10,152(a4)
  sz = PGROUNDUP(sz);
    80005254:	17fd                	addi	a5,a5,-1
    80005256:	94be                	add	s1,s1,a5
    80005258:	77fd                	lui	a5,0xfffff
    8000525a:	8fe5                	and	a5,a5,s1
    8000525c:	def43c23          	sd	a5,-520(s0)
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    ...
    8000526c:	1ca080e7          	jalr	458(ra) # 80001432 <uvmalloc>
    80005270:	8c2a                	mv	s8,a0
  ip = 0;
    80005272:	4a81                	li	s5,0
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    80005274:	14050263          	beqz	a0,800053b8 <exec+0x2de>
  uvmclear(pagetable, sz-2*PGSIZE);
    80005278:	75f9                	lui	a1,0xffffe
    8000527a:	95aa                	add	a1,a1,a0
    8000527c:	855a                	mv	a0,s6
    8000527e:	ffffc097          	auipc	ra,0xffffc
    80005282:	3d2080e7          	jalr	978(ra) # 80001650 <uvmclear>
  stackbase = sp - PGSIZE;
    80005286:	7afd                	lui	s5,0xfffff
    80005288:	9ae2                	add	s5,s5,s8
  for(argc = 0; argv[argc]; argc++) {
    8000528a:	df043783          	ld	a5,-528(s0)
    8000528e:	6388                	ld	a0,0(a5)
    80005290:	c925                	beqz	a0,80005300 <exec+0x226>
    80005292:	e8840993          	addi	s3,s0,-376
    80005296:	f8840c93          	addi	s9,s0,-120
  sp = sz;
    8000529a:	8962                	mv	s2,s8
  for(argc = 0; argv[argc]; argc++) {
    8000529c:	4481                	li	s1,0
    sp -= strlen(argv[argc]) + 1;
    8000529e:	ffffc097          	auipc	ra,0xffffc
    800052a2:	be8080e7          	jalr	-1048(ra) # 80000e86 <strlen>
    800052a6:	0015079b          	addiw	a5,a0,1
    800052aa:	40f90933          	sub	s2,s2,a5
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    800052ae:	ff097913          	andi	s2,s2,-16
    if(sp < stackbase)
    800052b2:	13596763          	bltu	s2,s5,800053e0 <exec+0x306>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    800052b6:	df043d83          	ld	s11,-528(s0)
    800052ba:	000dba03          	ld	s4,0(s11) # 1000 <_entry-0x7ffff000>
    800052be:	8552                	mv	a0,s4
    800052c0:	ffffc097          	auipc	ra,0xffffc
    800052c4:	bc6080e7          	jalr	-1082(ra) # 80000e86 <strlen>
    800052c8:	0015069b          	addiw	a3,a0,1
    800052cc:	8652                	mv	a2,s4
    800052ce:	85ca                	mv	a1,s2
    800052d0:	855a                	mv	a0,s6
    800052d2:	ffffc097          	auipc	ra,0xffffc
    800052d6:	3b0080e7          	jalr	944(ra) # 80001682 <copyout>
    800052da:	10054763          	bltz	a0,800053e8 <exec+0x30e>
    ustack[argc] = sp;
    800052de:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    800052e2:	0485                	addi	s1,s1,1
    800052e4:	008d8793          	addi	a5,s11,8
    800052e8:	def43823          	sd	a5,-528(s0)
    800052ec:	008db503          	ld	a0,8(s11)
    800052f0:	c911                	beqz	a0,80005304 <exec+0x22a>
    if(argc >= MAXARG)
    800052f2:	09a1                	addi	s3,s3,8
    800052f4:	fb3c95e3          	bne	s9,s3,8000529e <exec+0x1c4>
  sz = sz1;
    800052f8:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800052fc:	4a81                	li	s5,0
    800052fe:	a86d                	j	800053b8 <exec+0x2de>
  sp = sz;
    80005300:	8962                	mv	s2,s8
  for(argc = 0; argv[argc]; argc++) {
    80005302:	4481                	li	s1,0
  ustack[argc] = 0;
    80005304:	00349793          	slli	a5,s1,0x3
    80005308:	f9040713          	addi	a4,s0,-112
    8000530c:	97ba                	add	a5,a5,a4
    8000530e:	ee07bc23          	sd	zero,-264(a5) # ffffffffffffeef8 <end+0xffffffff7ff97ef8>
  sp -= (argc+1) * sizeof(uint64);
    80005312:	00148693          	addi	a3,s1,1
    80005316:	068e                	slli	a3,a3,0x3
    80005318:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    8000531c:	ff097913          	andi	s2,s2,-16
  if(sp < stackbase)
    80005320:	01597663          	bgeu	s2,s5,8000532c <exec+0x252>
  sz = sz1;
    80005324:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    80005328:	4a81                	li	s5,0
    8000532a:	a079                	j	800053b8 <exec+0x2de>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    8000532c:	e8840613          	addi	a2,s0,-376
    80005330:	85ca                	mv	a1,s2
    80005332:	855a                	mv	a0,s6
    80005334:	ffffc097          	auipc	ra,0xffffc
    80005338:	34e080e7          	jalr	846(ra) # 80001682 <copyout>
    8000533c:	0a054a63          	bltz	a0,800053f0 <exec+0x316>
  p->trapframe->a1 = sp;
    80005340:	6785                	lui	a5,0x1
    80005342:	97de                	add	a5,a5,s7
    80005344:	77dc                	ld	a5,168(a5)
    80005346:	0727bc23          	sd	s2,120(a5) # 1078 <_entry-0x7fffef88>
  for(last=s=path; *s; s++)
    8000534a:	de843783          	ld	a5,-536(s0)
    8000534e:	0007c703          	lbu	a4,0(a5)
    80005352:	cf11                	beqz	a4,8000536e <exec+0x294>
    80005354:	0785                	addi	a5,a5,1
    if(*s == '/')
    80005356:	02f00693          	li	a3,47
    8000535a:	a039                	j	80005368 <exec+0x28e>
      last = s+1;
    8000535c:	def43423          	sd	a5,-536(s0)
  for(last=s=path; *s; s++)
    80005360:	0785                	addi	a5,a5,1
    80005362:	fff7c703          	lbu	a4,-1(a5)
    80005366:	c701                	beqz	a4,8000536e <exec+0x294>
    if(*s == '/')
    80005368:	fed71ce3          	bne	a4,a3,80005360 <exec+0x286>
    8000536c:	bfc5                	j	8000535c <exec+0x282>
  safestrcpy(p->name, last, sizeof(p->name));
    8000536e:	6985                	lui	s3,0x1
    80005370:	1a898513          	addi	a0,s3,424 # 11a8 <_entry-0x7fffee58>
    80005374:	4641                	li	a2,16
    80005376:	de843583          	ld	a1,-536(s0)
    8000537a:	955e                	add	a0,a0,s7
    8000537c:	ffffc097          	auipc	ra,0xffffc
    80005380:	ad8080e7          	jalr	-1320(ra) # 80000e54 <safestrcpy>
  oldpagetable = p->pagetable;
    80005384:	9bce                	add	s7,s7,s3
    80005386:	0a0bb503          	ld	a0,160(s7) # 10a0 <_entry-0x7fffef60>
  p->pagetable = pagetable;
    8000538a:	0b6bb023          	sd	s6,160(s7)
  p->sz = sz;
    8000538e:	098bbc23          	sd	s8,152(s7)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    80005392:	0a8bb783          	ld	a5,168(s7)
    80005396:	e6043703          	ld	a4,-416(s0)
    8000539a:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    8000539c:	0a8bb783          	ld	a5,168(s7)
    800053a0:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    800053a4:	85ea                	mv	a1,s10
    800053a6:	ffffc097          	auipc	ra,0xffffc
    800053aa:	7ca080e7          	jalr	1994(ra) # 80001b70 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    800053ae:	0004851b          	sext.w	a0,s1
    800053b2:	b3d1                	j	80005176 <exec+0x9c>
    800053b4:	de943c23          	sd	s1,-520(s0)
    proc_freepagetable(pagetable, sz);
    800053b8:	df843583          	ld	a1,-520(s0)
    800053bc:	855a                	mv	a0,s6
    800053be:	ffffc097          	auipc	ra,0xffffc
    800053c2:	7b2080e7          	jalr	1970(ra) # 80001b70 <proc_freepagetable>
  if(ip){
    800053c6:	d80a9ee3          	bnez	s5,80005162 <exec+0x88>
  return -1;
    800053ca:	557d                	li	a0,-1
    800053cc:	b36d                	j	80005176 <exec+0x9c>
    800053ce:	de943c23          	sd	s1,-520(s0)
    800053d2:	b7dd                	j	800053b8 <exec+0x2de>
    800053d4:	de943c23          	sd	s1,-520(s0)
    800053d8:	b7c5                	j	800053b8 <exec+0x2de>
    800053da:	de943c23          	sd	s1,-520(s0)
    800053de:	bfe9                	j	800053b8 <exec+0x2de>
  sz = sz1;
    800053e0:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800053e4:	4a81                	li	s5,0
    800053e6:	bfc9                	j	800053b8 <exec+0x2de>
  sz = sz1;
    800053e8:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800053ec:	4a81                	li	s5,0
    800053ee:	b7e9                	j	800053b8 <exec+0x2de>
  sz = sz1;
    800053f0:	df843c23          	sd	s8,-520(s0)
  ip = 0;
    800053f4:	4a81                	li	s5,0
    800053f6:	b7c9                	j	800053b8 <exec+0x2de>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    800053f8:	df843483          	ld	s1,-520(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800053fc:	e0843783          	ld	a5,-504(s0)
    80005400:	0017869b          	addiw	a3,a5,1
    80005404:	e0d43423          	sd	a3,-504(s0)
    80005408:	e0043783          	ld	a5,-512(s0)
    8000540c:	0387879b          	addiw	a5,a5,56
    80005410:	e8045703          	lhu	a4,-384(s0)
    80005414:	e0e6dde3          	bge	a3,a4,8000522e <exec+0x154>
    if(readi(ip, 0, (uint64)&ph, off, sizeof(ph)) != sizeof(ph))
    80005418:	2781                	sext.w	a5,a5
    8000541a:	e0f43023          	sd	a5,-512(s0)
    8000541e:	03800713          	li	a4,56
    80005422:	86be                	mv	a3,a5
    80005424:	e1040613          	addi	a2,s0,-496
    80005428:	4581                	li	a1,0
    8000542a:	8556                	mv	a0,s5
    8000542c:	fffff097          	auipc	ra,0xfffff
    80005430:	a22080e7          	jalr	-1502(ra) # 80003e4e <readi>
    80005434:	03800793          	li	a5,56
    80005438:	f6f51ee3          	bne	a0,a5,800053b4 <exec+0x2da>
    if(ph.type != ELF_PROG_LOAD)
    8000543c:	e1042783          	lw	a5,-496(s0)
    80005440:	4705                	li	a4,1
    80005442:	fae79de3          	bne	a5,a4,800053fc <exec+0x322>
    if(ph.memsz < ph.filesz)
    80005446:	e3843603          	ld	a2,-456(s0)
    8000544a:	e3043783          	ld	a5,-464(s0)
    8000544e:	f8f660e3          	bltu	a2,a5,800053ce <exec+0x2f4>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    80005452:	e2043783          	ld	a5,-480(s0)
    80005456:	963e                	add	a2,a2,a5
    80005458:	f6f66ee3          	bltu	a2,a5,800053d4 <exec+0x2fa>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    8000545c:	85a6                	mv	a1,s1
    8000545e:	855a                	mv	a0,s6
    80005460:	ffffc097          	auipc	ra,0xffffc
    80005464:	fd2080e7          	jalr	-46(ra) # 80001432 <uvmalloc>
    80005468:	dea43c23          	sd	a0,-520(s0)
    8000546c:	d53d                	beqz	a0,800053da <exec+0x300>
    if(ph.vaddr % PGSIZE != 0)
    8000546e:	e2043c03          	ld	s8,-480(s0)
    80005472:	de043783          	ld	a5,-544(s0)
    80005476:	00fc77b3          	and	a5,s8,a5
    8000547a:	ff9d                	bnez	a5,800053b8 <exec+0x2de>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    8000547c:	e1842c83          	lw	s9,-488(s0)
    80005480:	e3042b83          	lw	s7,-464(s0)
  for(i = 0; i < sz; i += PGSIZE){
    80005484:	f60b8ae3          	beqz	s7,800053f8 <exec+0x31e>
    80005488:	89de                	mv	s3,s7
    8000548a:	4481                	li	s1,0
    8000548c:	b341                	j	8000520c <exec+0x132>

000000008000548e <argfd>:
...
argfd(int n, int *pfd, struct file **pf)
{
    ...
    8000549a:	892e                	mv	s2,a1
    8000549c:	84b2                	mv	s1,a2
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
    8000549e:	fdc40593          	addi	a1,s0,-36
    800054a2:	ffffe097          	auipc	ra,0xffffe
    800054a6:	8d6080e7          	jalr	-1834(ra) # 80002d78 <argint>
    800054aa:	04054063          	bltz	a0,800054ea <argfd+0x5c>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    800054ae:	fdc42703          	lw	a4,-36(s0)
    800054b2:	47bd                	li	a5,15
    800054b4:	02e7ed63          	bltu	a5,a4,800054ee <argfd+0x60>
    800054b8:	ffffc097          	auipc	ra,0xffffc
    800054bc:	556080e7          	jalr	1366(ra) # 80001a0e <myproc>
    800054c0:	fdc42703          	lw	a4,-36(s0)
    800054c4:	22470793          	addi	a5,a4,548
    800054c8:	078e                	slli	a5,a5,0x3
    800054ca:	953e                	add	a0,a0,a5
    800054cc:	611c                	ld	a5,0(a0)
    800054ce:	c395                	beqz	a5,800054f2 <argfd+0x64>
    return -1;
  if(pfd)
    800054d0:	00090463          	beqz	s2,800054d8 <argfd+0x4a>
    *pfd = fd;
    800054d4:	00e92023          	sw	a4,0(s2)
  if(pf)
    *pf = f;
  return 0;
    800054d8:	4501                	li	a0,0
  if(pf)
    800054da:	c091                	beqz	s1,800054de <argfd+0x50>
    *pf = f;
    800054dc:	e09c                	sd	a5,0(s1)
}
    800054de:	70a2                	ld	ra,40(sp)
    800054e0:	7402                	ld	s0,32(sp)
    800054e2:	64e2                	ld	s1,24(sp)
    800054e4:	6942                	ld	s2,16(sp)
    800054e6:	6145                	addi	sp,sp,48
    800054e8:	8082                	ret
    return -1;
    800054ea:	557d                	li	a0,-1
    800054ec:	bfcd                	j	800054de <argfd+0x50>
    return -1;
    800054ee:	557d                	li	a0,-1
    800054f0:	b7fd                	j	800054de <argfd+0x50>
    800054f2:	557d                	li	a0,-1
    800054f4:	b7ed                	j	800054de <argfd+0x50>

00000000800054f6 <fdalloc>:
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    80005506:	50c080e7          	jalr	1292(ra) # 80001a0e <myproc>
    8000550a:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    8000550c:	6785                	lui	a5,0x1
    8000550e:	12078793          	addi	a5,a5,288 # 1120 <_entry-0x7fffeee0>
    80005512:	97aa                	add	a5,a5,a0
    80005514:	4501                	li	a0,0
    80005516:	46c1                	li	a3,16
    if(p->ofile[fd] == 0){
    80005518:	6398                	ld	a4,0(a5)
    8000551a:	cb19                	beqz	a4,80005530 <fdalloc+0x3a>
  for(fd = 0; fd < NOFILE; fd++){
    8000551c:	2505                	addiw	a0,a0,1
    8000551e:	07a1                	addi	a5,a5,8
    80005520:	fed51ce3          	bne	a0,a3,80005518 <fdalloc+0x22>
      p->ofile[fd] = f;
      return fd;
    }
  }
  return -1;
    ...
    8000552e:	8082                	ret
      p->ofile[fd] = f;
    80005530:	22450793          	addi	a5,a0,548
    80005534:	078e                	slli	a5,a5,0x3
    80005536:	963e                	add	a2,a2,a5
    80005538:	e204                	sd	s1,0(a2)
      return fd;
    8000553a:	b7f5                	j	80005526 <fdalloc+0x30>

000000008000553c <create>:
  return -1;
}
...
create(char *path, short type, short major, short minor)
{
    ...
    8000554e:	89ae                	mv	s3,a1
    80005550:	8ab2                	mv	s5,a2
    80005552:	8a36                	mv	s4,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    8000555c:	e18080e7          	jalr	-488(ra) # 80004370 <nameiparent>
    80005560:	892a                	mv	s2,a0
    80005562:	12050e63          	beqz	a0,8000569e <create+0x162>
    return 0;

  ilock(dp);
    80005566:	ffffe097          	auipc	ra,0xffffe
    8000556a:	634080e7          	jalr	1588(ra) # 80003b9a <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
    8000556e:	4601                	li	a2,0
    80005570:	fb040593          	addi	a1,s0,-80
    80005574:	854a                	mv	a0,s2
    80005576:	fffff097          	auipc	ra,0xfffff
    8000557a:	b06080e7          	jalr	-1274(ra) # 8000407c <dirlookup>
    8000557e:	84aa                	mv	s1,a0
    80005580:	c921                	beqz	a0,800055d0 <create+0x94>
    iunlockput(dp);
    80005582:	854a                	mv	a0,s2
    80005584:	fffff097          	auipc	ra,0xfffff
    80005588:	878080e7          	jalr	-1928(ra) # 80003dfc <iunlockput>
    ilock(ip);
    8000558c:	8526                	mv	a0,s1
    8000558e:	ffffe097          	auipc	ra,0xffffe
    80005592:	60c080e7          	jalr	1548(ra) # 80003b9a <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    80005596:	2981                	sext.w	s3,s3
    80005598:	4789                	li	a5,2
    8000559a:	02f99463          	bne	s3,a5,800055c2 <create+0x86>
    8000559e:	0444d783          	lhu	a5,68(s1)
    800055a2:	37f9                	addiw	a5,a5,-2
    800055a4:	17c2                	slli	a5,a5,0x30
    800055a6:	93c1                	srli	a5,a5,0x30
    800055a8:	4705                	li	a4,1
    800055aa:	00f76c63          	bltu	a4,a5,800055c2 <create+0x86>
  ...
  return ip;
    ...
    800055be:	6161                	addi	sp,sp,80
    800055c0:	8082                	ret
    iunlockput(ip);
    800055c2:	8526                	mv	a0,s1
    800055c4:	fffff097          	auipc	ra,0xfffff
    800055c8:	838080e7          	jalr	-1992(ra) # 80003dfc <iunlockput>
    return 0;
    800055cc:	4481                	li	s1,0
    800055ce:	b7c5                	j	800055ae <create+0x72>
  if((ip = ialloc(dp->dev, type)) == 0)
    800055d0:	85ce                	mv	a1,s3
    800055d2:	00092503          	lw	a0,0(s2)
    800055d6:	ffffe097          	auipc	ra,0xffffe
    800055da:	42c080e7          	jalr	1068(ra) # 80003a02 <ialloc>
    800055de:	84aa                	mv	s1,a0
    800055e0:	c521                	beqz	a0,80005628 <create+0xec>
  ilock(ip);
    800055e2:	ffffe097          	auipc	ra,0xffffe
    800055e6:	5b8080e7          	jalr	1464(ra) # 80003b9a <ilock>
  ip->major = major;
    800055ea:	05549323          	sh	s5,70(s1)
  ip->minor = minor;
    800055ee:	05449423          	sh	s4,72(s1)
  ip->nlink = 1;
    800055f2:	4a05                	li	s4,1
    800055f4:	05449523          	sh	s4,74(s1)
  iupdate(ip);
    800055f8:	8526                	mv	a0,s1
    800055fa:	ffffe097          	auipc	ra,0xffffe
    800055fe:	4d6080e7          	jalr	1238(ra) # 80003ad0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    80005602:	2981                	sext.w	s3,s3
    80005604:	03498a63          	beq	s3,s4,80005638 <create+0xfc>
  if(dirlink(dp, name, ip->inum) < 0)
    80005608:	40d0                	lw	a2,4(s1)
    8000560a:	fb040593          	addi	a1,s0,-80
    8000560e:	854a                	mv	a0,s2
    80005610:	fffff097          	auipc	ra,0xfffff
    80005614:	c80080e7          	jalr	-896(ra) # 80004290 <dirlink>
    80005618:	06054b63          	bltz	a0,8000568e <create+0x152>
  iunlockput(dp);
    8000561c:	854a                	mv	a0,s2
    8000561e:	ffffe097          	auipc	ra,0xffffe
    80005622:	7de080e7          	jalr	2014(ra) # 80003dfc <iunlockput>
  return ip;
    80005626:	b761                	j	800055ae <create+0x72>
    panic("create: ialloc");
    80005628:	00003517          	auipc	a0,0x3
    8000562c:	0c050513          	addi	a0,a0,192 # 800086e8 <syscalls+0x2c8>
    80005630:	ffffb097          	auipc	ra,0xffffb
    80005634:	f1a080e7          	jalr	-230(ra) # 8000054a <panic>
    dp->nlink++;  // for ".."
    ...
    80005648:	48c080e7          	jalr	1164(ra) # 80003ad0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    8000564c:	40d0                	lw	a2,4(s1)
    8000564e:	00003597          	auipc	a1,0x3
    80005652:	0aa58593          	addi	a1,a1,170 # 800086f8 <syscalls+0x2d8>
    80005656:	8526                	mv	a0,s1
    80005658:	fffff097          	auipc	ra,0xfffff
    8000565c:	c38080e7          	jalr	-968(ra) # 80004290 <dirlink>
    80005660:	00054f63          	bltz	a0,8000567e <create+0x142>
    80005664:	00492603          	lw	a2,4(s2)
    80005668:	00003597          	auipc	a1,0x3
    8000566c:	09858593          	addi	a1,a1,152 # 80008700 <syscalls+0x2e0>
    80005670:	8526                	mv	a0,s1
    80005672:	fffff097          	auipc	ra,0xfffff
    80005676:	c1e080e7          	jalr	-994(ra) # 80004290 <dirlink>
    8000567a:	f80557e3          	bgez	a0,80005608 <create+0xcc>
      panic("create dots");
    8000567e:	00003517          	auipc	a0,0x3
    80005682:	08a50513          	addi	a0,a0,138 # 80008708 <syscalls+0x2e8>
    80005686:	ffffb097          	auipc	ra,0xffffb
    8000568a:	ec4080e7          	jalr	-316(ra) # 8000054a <panic>
    panic("create: dirlink");
    8000568e:	00003517          	auipc	a0,0x3
    80005692:	08a50513          	addi	a0,a0,138 # 80008718 <syscalls+0x2f8>
    80005696:	ffffb097          	auipc	ra,0xffffb
    8000569a:	eb4080e7          	jalr	-332(ra) # 8000054a <panic>
    return 0;
    8000569e:	84aa                	mv	s1,a0
    800056a0:	b739                	j	800055ae <create+0x72>

00000000800056a2 <sys_dup>:
{
    800056a2:	7179                	addi	sp,sp,-48
    800056a4:	f406                	sd	ra,40(sp)
    800056a6:	f022                	sd	s0,32(sp)
    800056a8:	ec26                	sd	s1,24(sp)
  ...
  if(argfd(0, 0, &f) < 0)
    ...
    800056b8:	dda080e7          	jalr	-550(ra) # 8000548e <argfd>
    return -1;
    800056bc:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0)
    800056be:	02054363          	bltz	a0,800056e4 <sys_dup+0x42>
  if((fd=fdalloc(f)) < 0)
    800056c2:	fd843503          	ld	a0,-40(s0)
    800056c6:	00000097          	auipc	ra,0x0
    800056ca:	e30080e7          	jalr	-464(ra) # 800054f6 <fdalloc>
    800056ce:	84aa                	mv	s1,a0
    return -1;
    800056d0:	57fd                	li	a5,-1
  if((fd=fdalloc(f)) < 0)
    800056d2:	00054963          	bltz	a0,800056e4 <sys_dup+0x42>
  filedup(f);
    800056d6:	fd843503          	ld	a0,-40(s0)
    800056da:	fffff097          	auipc	ra,0xfffff
    800056de:	316080e7          	jalr	790(ra) # 800049f0 <filedup>
  return fd;
...
00000000800056f0 <sys_read>:
{
    800056f0:	7179                	addi	sp,sp,-48
    800056f2:	f406                	sd	ra,40(sp)
    800056f4:	f022                	sd	s0,32(sp)
    800056f6:	1800                	addi	s0,sp,48
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800056f8:	fe840613          	addi	a2,s0,-24
    800056fc:	4581                	li	a1,0
    800056fe:	4501                	li	a0,0
    80005700:	00000097          	auipc	ra,0x0
    80005704:	d8e080e7          	jalr	-626(ra) # 8000548e <argfd>
    return -1;
    80005708:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000570a:	04054163          	bltz	a0,8000574c <sys_read+0x5c>
    8000570e:	fe440593          	addi	a1,s0,-28
    80005712:	4509                	li	a0,2
    80005714:	ffffd097          	auipc	ra,0xffffd
    80005718:	664080e7          	jalr	1636(ra) # 80002d78 <argint>
    return -1;
    8000571c:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000571e:	02054763          	bltz	a0,8000574c <sys_read+0x5c>
    80005722:	fd840593          	addi	a1,s0,-40
    80005726:	4505                	li	a0,1
    80005728:	ffffd097          	auipc	ra,0xffffd
    8000572c:	672080e7          	jalr	1650(ra) # 80002d9a <argaddr>
    return -1;
    80005730:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005732:	00054d63          	bltz	a0,8000574c <sys_read+0x5c>
  return fileread(f, p, n);
    80005736:	fe442603          	lw	a2,-28(s0)
    8000573a:	fd843583          	ld	a1,-40(s0)
    8000573e:	fe843503          	ld	a0,-24(s0)
    80005742:	fffff097          	auipc	ra,0xfffff
    80005746:	43c080e7          	jalr	1084(ra) # 80004b7e <fileread>
    8000574a:	87aa                	mv	a5,a0
}
    8000574c:	853e                	mv	a0,a5
    8000574e:	70a2                	ld	ra,40(sp)
    80005750:	7402                	ld	s0,32(sp)
    80005752:	6145                	addi	sp,sp,48
    80005754:	8082                	ret

0000000080005756 <sys_write>:
{
    80005756:	7179                	addi	sp,sp,-48
    80005758:	f406                	sd	ra,40(sp)
    8000575a:	f022                	sd	s0,32(sp)
    8000575c:	1800                	addi	s0,sp,48
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000575e:	fe840613          	addi	a2,s0,-24
    80005762:	4581                	li	a1,0
    80005764:	4501                	li	a0,0
    80005766:	00000097          	auipc	ra,0x0
    8000576a:	d28080e7          	jalr	-728(ra) # 8000548e <argfd>
    return -1;
    8000576e:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005770:	04054163          	bltz	a0,800057b2 <sys_write+0x5c>
    80005774:	fe440593          	addi	a1,s0,-28
    80005778:	4509                	li	a0,2
    8000577a:	ffffd097          	auipc	ra,0xffffd
    8000577e:	5fe080e7          	jalr	1534(ra) # 80002d78 <argint>
    return -1;
    80005782:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005784:	02054763          	bltz	a0,800057b2 <sys_write+0x5c>
    80005788:	fd840593          	addi	a1,s0,-40
    8000578c:	4505                	li	a0,1
    8000578e:	ffffd097          	auipc	ra,0xffffd
    80005792:	60c080e7          	jalr	1548(ra) # 80002d9a <argaddr>
    return -1;
    80005796:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005798:	00054d63          	bltz	a0,800057b2 <sys_write+0x5c>
  return filewrite(f, p, n);
    8000579c:	fe442603          	lw	a2,-28(s0)
    800057a0:	fd843583          	ld	a1,-40(s0)
    800057a4:	fe843503          	ld	a0,-24(s0)
    800057a8:	fffff097          	auipc	ra,0xfffff
    800057ac:	498080e7          	jalr	1176(ra) # 80004c40 <filewrite>
...
00000000800057bc <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    800057c4:	fe040613          	addi	a2,s0,-32
    800057c8:	fec40593          	addi	a1,s0,-20
    800057cc:	4501                	li	a0,0
    800057ce:	00000097          	auipc	ra,0x0
    800057d2:	cc0080e7          	jalr	-832(ra) # 8000548e <argfd>
    return -1;
    800057d6:	57fd                	li	a5,-1
  if(argfd(0, &fd, &f) < 0)
    800057d8:	02054563          	bltz	a0,80005802 <sys_close+0x46>
  myproc()->ofile[fd] = 0;
    800057dc:	ffffc097          	auipc	ra,0xffffc
    800057e0:	232080e7          	jalr	562(ra) # 80001a0e <myproc>
    800057e4:	fec42783          	lw	a5,-20(s0)
    800057e8:	22478793          	addi	a5,a5,548
  ...
  fileclose(f);
    ...
    800057fc:	24a080e7          	jalr	586(ra) # 80004a42 <fileclose>
  return 0;
...
000000008000580c <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    80005820:	c72080e7          	jalr	-910(ra) # 8000548e <argfd>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    80005834:	56a080e7          	jalr	1386(ra) # 80002d9a <argaddr>
    return -1;
  ...
  return filestat(f, st);
    ...
    8000584a:	2c4080e7          	jalr	708(ra) # 80004b0a <filestat>
...
000000008000585a <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80005874:	54c080e7          	jalr	1356(ra) # 80002dbc <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    8000588c:	534080e7          	jalr	1332(ra) # 80002dbc <argstr>
    return -1;
  ...
  return 0;
    ...
    8000594a:	4b6080e7          	jalr	1206(ra) # 80003dfc <iunlockput>
    end_op();
    8000594e:	fffff097          	auipc	ra,0xfffff
    80005952:	ca0080e7          	jalr	-864(ra) # 800045ee <end_op>
    return -1;
    ...
    80005960:	4a0080e7          	jalr	1184(ra) # 80003dfc <iunlockput>
  ilock(ip);
    80005964:	8526                	mv	a0,s1
    80005966:	ffffe097          	auipc	ra,0xffffe
    8000596a:	234080e7          	jalr	564(ra) # 80003b9a <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    8000597e:	156080e7          	jalr	342(ra) # 80003ad0 <iupdate>
  iunlockput(ip);
    80005982:	8526                	mv	a0,s1
    80005984:	ffffe097          	auipc	ra,0xffffe
    80005988:	478080e7          	jalr	1144(ra) # 80003dfc <iunlockput>
  end_op();
    8000598c:	fffff097          	auipc	ra,0xfffff
    80005990:	c62080e7          	jalr	-926(ra) # 800045ee <end_op>
  return -1;
...
00000000800059a4 <sys_unlink>:
{
  ...
  memset(&de, 0, sizeof(de));
    ...
    80005a5a:	2ac080e7          	jalr	684(ra) # 80000d02 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80005a70:	4da080e7          	jalr	1242(ra) # 80003f46 <writei>
  ...
  iunlockput(dp);
    ...
    80005a8a:	376080e7          	jalr	886(ra) # 80003dfc <iunlockput>
  ip->nlink--;
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005af4:	35e080e7          	jalr	862(ra) # 80003e4e <readi>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005b14:	c3050513          	addi	a0,a0,-976 # 80008740 <syscalls+0x320>
    80005b18:	ffffb097          	auipc	ra,0xffffb
    80005b1c:	a32080e7          	jalr	-1486(ra) # 8000054a <panic>
    panic("unlink: writei");
    80005b20:	00003517          	auipc	a0,0x3
    80005b24:	c3850513          	addi	a0,a0,-968 # 80008758 <syscalls+0x338>
    80005b28:	ffffb097          	auipc	ra,0xffffb
    80005b2c:	a22080e7          	jalr	-1502(ra) # 8000054a <panic>
    dp->nlink--;
    ...
    80005b40:	f94080e7          	jalr	-108(ra) # 80003ad0 <iupdate>
    ...
    80005b50:	2b0080e7          	jalr	688(ra) # 80003dfc <iunlockput>
  iunlockput(dp);
    80005b54:	8526                	mv	a0,s1
    80005b56:	ffffe097          	auipc	ra,0xffffe
    80005b5a:	2a6080e7          	jalr	678(ra) # 80003dfc <iunlockput>
  end_op();
    80005b5e:	fffff097          	auipc	ra,0xfffff
    80005b62:	a90080e7          	jalr	-1392(ra) # 800045ee <end_op>
  return -1;
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005b92:	22e080e7          	jalr	558(ra) # 80002dbc <argstr>
    return -1;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005ba6:	1d6080e7          	jalr	470(ra) # 80002d78 <argint>
    80005baa:	0a054863          	bltz	a0,80005c5a <sys_open+0xe4>

  begin_op();
    80005bae:	fffff097          	auipc	ra,0xfffff
    80005bb2:	9c0080e7          	jalr	-1600(ra) # 8000456e <begin_op>
  ...
  if(omode & O_CREATE){
    ...
    80005bce:	972080e7          	jalr	-1678(ra) # 8000553c <create>
  ...
  iunlock(ip);
    ...
    80005c4e:	012080e7          	jalr	18(ra) # 80003c5c <iunlock>
  end_op();
    80005c52:	fffff097          	auipc	ra,0xfffff
    80005c56:	99c080e7          	jalr	-1636(ra) # 800045ee <end_op>
  ...
  return fd;
    ...
    80005ca2:	15e080e7          	jalr	350(ra) # 80003dfc <iunlockput>
      end_op();
    80005ca6:	fffff097          	auipc	ra,0xfffff
    80005caa:	948080e7          	jalr	-1720(ra) # 800045ee <end_op>
      return -1;
    80005cae:	54fd                	li	s1,-1
    80005cb0:	b76d                	j	80005c5a <sys_open+0xe4>
      end_op();
    80005cb2:	fffff097          	auipc	ra,0xfffff
    80005cb6:	93c080e7          	jalr	-1732(ra) # 800045ee <end_op>
      return -1;
    ...
    80005cc4:	13c080e7          	jalr	316(ra) # 80003dfc <iunlockput>
    end_op();
    80005cc8:	fffff097          	auipc	ra,0xfffff
    80005ccc:	926080e7          	jalr	-1754(ra) # 800045ee <end_op>
    return -1;
    ...
    80005ce8:	fc4080e7          	jalr	-60(ra) # 80003ca8 <itrunc>
    80005cec:	bfb1                	j	80005c48 <sys_open+0xd2>
      fileclose(f);
    80005cee:	854e                	mv	a0,s3
    80005cf0:	fffff097          	auipc	ra,0xfffff
    80005cf4:	d52080e7          	jalr	-686(ra) # 80004a42 <fileclose>
    iunlockput(ip);
    80005cf8:	854a                	mv	a0,s2
    80005cfa:	ffffe097          	auipc	ra,0xffffe
    80005cfe:	102080e7          	jalr	258(ra) # 80003dfc <iunlockput>
    end_op();
    80005d02:	fffff097          	auipc	ra,0xfffff
    80005d06:	8ec080e7          	jalr	-1812(ra) # 800045ee <end_op>
    return -1;
...
sys_mkdir(void)
{
  ...
  begin_op();
    ...
    80005d1a:	858080e7          	jalr	-1960(ra) # 8000456e <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005d2c:	094080e7          	jalr	148(ra) # 80002dbc <argstr>
    ...
    80005d42:	7fe080e7          	jalr	2046(ra) # 8000553c <create>
  ...
  iunlockput(ip);
    ...
    80005d4c:	0b4080e7          	jalr	180(ra) # 80003dfc <iunlockput>
  end_op();
    80005d50:	fffff097          	auipc	ra,0xfffff
    80005d54:	89e080e7          	jalr	-1890(ra) # 800045ee <end_op>
  return 0;
    ...
    80005d66:	88c080e7          	jalr	-1908(ra) # 800045ee <end_op>
    return -1;
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005d9e:	fde080e7          	jalr	-34(ra) # 80002d78 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005db0:	fcc080e7          	jalr	-52(ra) # 80002d78 <argint>
     argint(1, &major) < 0 ||
    ...
    80005dca:	776080e7          	jalr	1910(ra) # 8000553c <create>
     argint(2, &minor) < 0 ||
  ...
  iunlockput(ip);
    ...
    80005dd4:	02c080e7          	jalr	44(ra) # 80003dfc <iunlockput>
  end_op();
    80005dd8:	fffff097          	auipc	ra,0xfffff
    80005ddc:	816080e7          	jalr	-2026(ra) # 800045ee <end_op>
  return 0;
    80005de0:	4501                	li	a0,0
    80005de2:	a031                	j	80005dee <sys_mknod+0x80>
    end_op();
    80005de4:	fffff097          	auipc	ra,0xfffff
    80005de8:	80a080e7          	jalr	-2038(ra) # 800045ee <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005e06:	c0c080e7          	jalr	-1012(ra) # 80001a0e <myproc>
    80005e0a:	892a                	mv	s2,a0
  
  begin_op();
    80005e0c:	ffffe097          	auipc	ra,0xffffe
    80005e10:	762080e7          	jalr	1890(ra) # 8000456e <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80005e22:	f9e080e7          	jalr	-98(ra) # 80002dbc <argstr>
    80005e26:	04054d63          	bltz	a0,80005e80 <sys_chdir+0x8a>
    80005e2a:	f6040513          	addi	a0,s0,-160
    80005e2e:	ffffe097          	auipc	ra,0xffffe
    80005e32:	524080e7          	jalr	1316(ra) # 80004352 <namei>
    80005e36:	84aa                	mv	s1,a0
    80005e38:	c521                	beqz	a0,80005e80 <sys_chdir+0x8a>
    end_op();
    return -1;
  }
  ilock(ip);
    80005e3a:	ffffe097          	auipc	ra,0xffffe
    80005e3e:	d60080e7          	jalr	-672(ra) # 80003b9a <ilock>
  if(ip->type != T_DIR){
    80005e42:	04449703          	lh	a4,68(s1)
    80005e46:	4785                	li	a5,1
    80005e48:	04f71263          	bne	a4,a5,80005e8c <sys_chdir+0x96>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80005e52:	e0e080e7          	jalr	-498(ra) # 80003c5c <iunlock>
  iput(p->cwd);
    80005e56:	6505                	lui	a0,0x1
    80005e58:	992a                	add	s2,s2,a0
    80005e5a:	1a093503          	ld	a0,416(s2)
    80005e5e:	ffffe097          	auipc	ra,0xffffe
    80005e62:	ef6080e7          	jalr	-266(ra) # 80003d54 <iput>
  end_op();
    80005e66:	ffffe097          	auipc	ra,0xffffe
    80005e6a:	788080e7          	jalr	1928(ra) # 800045ee <end_op>
  p->cwd = ip;
    80005e6e:	1a993023          	sd	s1,416(s2)
  return 0;
    ...
    80005e84:	76e080e7          	jalr	1902(ra) # 800045ee <end_op>
    return -1;
    80005e88:	557d                	li	a0,-1
    80005e8a:	b7ed                	j	80005e74 <sys_chdir+0x7e>
    iunlockput(ip);
    80005e8c:	8526                	mv	a0,s1
    80005e8e:	ffffe097          	auipc	ra,0xffffe
    80005e92:	f6e080e7          	jalr	-146(ra) # 80003dfc <iunlockput>
    end_op();
    80005e96:	ffffe097          	auipc	ra,0xffffe
    80005e9a:	758080e7          	jalr	1880(ra) # 800045ee <end_op>
    return -1;
    80005e9e:	557d                	li	a0,-1
    80005ea0:	bfd1                	j	80005e74 <sys_chdir+0x7e>
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005ec2:	efe080e7          	jalr	-258(ra) # 80002dbc <argstr>
    return -1;
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005ed6:	ec8080e7          	jalr	-312(ra) # 80002d9a <argaddr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005eec:	e1a080e7          	jalr	-486(ra) # 80000d02 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005f00:	00391793          	slli	a5,s2,0x3
    80005f04:	e3040593          	addi	a1,s0,-464
    80005f08:	e3843503          	ld	a0,-456(s0)
    80005f0c:	953e                	add	a0,a0,a5
    80005f0e:	ffffd097          	auipc	ra,0xffffd
    80005f12:	dc4080e7          	jalr	-572(ra) # 80002cd2 <fetchaddr>
    ...
    80005f24:	bf6080e7          	jalr	-1034(ra) # 80000b16 <kalloc>
    ...
    80005f3a:	df6080e7          	jalr	-522(ra) # 80002d2c <fetchstr>
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80005f56:	ac8080e7          	jalr	-1336(ra) # 80000a1a <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
  ...
  return -1;
    ...
    80005f6c:	e80ab023          	sd	zero,-384(s5) # ffffffffffffee80 <end+0xffffffff7ff97e80>
  int ret = exec(path, argv);
    80005f70:	e4040593          	addi	a1,s0,-448
    80005f74:	f4040513          	addi	a0,s0,-192
    80005f78:	fffff097          	auipc	ra,0xfffff
    80005f7c:	162080e7          	jalr	354(ra) # 800050da <exec>
  ...
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80005f8e:	a90080e7          	jalr	-1392(ra) # 80000a1a <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005fbe:	a54080e7          	jalr	-1452(ra) # 80001a0e <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005fce:	dd0080e7          	jalr	-560(ra) # 80002d9a <argaddr>
    return -1;
    80005fd2:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    80005fd4:	0e054663          	bltz	a0,800060c0 <sys_pipe+0x110>
  if(pipealloc(&rf, &wf) < 0)
    80005fd8:	fc840593          	addi	a1,s0,-56
    80005fdc:	fd040513          	addi	a0,s0,-48
    80005fe0:	fffff097          	auipc	ra,0xfffff
    80005fe4:	dba080e7          	jalr	-582(ra) # 80004d9a <pipealloc>
    return -1;
    80005fe8:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    80005fea:	0c054b63          	bltz	a0,800060c0 <sys_pipe+0x110>
  fd0 = -1;
    80005fee:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80005ff2:	fd043503          	ld	a0,-48(s0)
    80005ff6:	fffff097          	auipc	ra,0xfffff
    80005ffa:	500080e7          	jalr	1280(ra) # 800054f6 <fdalloc>
    80005ffe:	fca42223          	sw	a0,-60(s0)
    80006002:	0a054263          	bltz	a0,800060a6 <sys_pipe+0xf6>
    80006006:	fc843503          	ld	a0,-56(s0)
    8000600a:	fffff097          	auipc	ra,0xfffff
    8000600e:	4ec080e7          	jalr	1260(ra) # 800054f6 <fdalloc>
    80006012:	fca42023          	sw	a0,-64(s0)
    80006016:	06054e63          	bltz	a0,80006092 <sys_pipe+0xe2>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    8000601a:	6785                	lui	a5,0x1
    8000601c:	97a6                	add	a5,a5,s1
    8000601e:	4691                	li	a3,4
    80006020:	fc440613          	addi	a2,s0,-60
    80006024:	fd843583          	ld	a1,-40(s0)
    80006028:	73c8                	ld	a0,160(a5)
    8000602a:	ffffb097          	auipc	ra,0xffffb
    8000602e:	658080e7          	jalr	1624(ra) # 80001682 <copyout>
    80006032:	02054263          	bltz	a0,80006056 <sys_pipe+0xa6>
    ...
    80006046:	73c8                	ld	a0,160(a5)
    80006048:	ffffb097          	auipc	ra,0xffffb
    8000604c:	63a080e7          	jalr	1594(ra) # 80001682 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80006052:	06055763          	bgez	a0,800060c0 <sys_pipe+0x110>
    p->ofile[fd0] = 0;
    80006056:	fc442783          	lw	a5,-60(s0)
    8000605a:	22478793          	addi	a5,a5,548 # 1224 <_entry-0x7fffeddc>
    8000605e:	078e                	slli	a5,a5,0x3
    80006060:	97a6                	add	a5,a5,s1
    80006062:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    80006066:	fc042503          	lw	a0,-64(s0)
    8000606a:	22450513          	addi	a0,a0,548 # 1224 <_entry-0x7fffeddc>
    ...
    8000607e:	9c8080e7          	jalr	-1592(ra) # 80004a42 <fileclose>
    fileclose(wf);
    80006082:	fc843503          	ld	a0,-56(s0)
    80006086:	fffff097          	auipc	ra,0xfffff
    8000608a:	9bc080e7          	jalr	-1604(ra) # 80004a42 <fileclose>
    return -1;
    8000608e:	57fd                	li	a5,-1
    80006090:	a805                	j	800060c0 <sys_pipe+0x110>
    if(fd0 >= 0)
    80006092:	fc442783          	lw	a5,-60(s0)
    80006096:	0007c863          	bltz	a5,800060a6 <sys_pipe+0xf6>
      p->ofile[fd0] = 0;
    8000609a:	22478513          	addi	a0,a5,548
    ...
    800060ae:	998080e7          	jalr	-1640(ra) # 80004a42 <fileclose>
    fileclose(wf);
    800060b2:	fc843503          	ld	a0,-56(s0)
    800060b6:	fffff097          	auipc	ra,0xfffff
    800060ba:	98c080e7          	jalr	-1652(ra) # 80004a42 <fileclose>
    return -1;
...
00000000800060d0 <kernelvec>:
    ...
    80006110:	9ddfc0ef          	jal	ra,80002aec <kerneltrap>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    800061e4:	802080e7          	jalr	-2046(ra) # 800019e2 <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    8000620c:	7da080e7          	jalr	2010(ra) # 800019e2 <cpuid>
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    panic("free_desc 1");
  if(disk.free[i])
    80006234:	0005e797          	auipc	a5,0x5e
    80006238:	dcc78793          	addi	a5,a5,-564 # 80064000 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    8000624e:	00060717          	auipc	a4,0x60
    80006252:	db270713          	addi	a4,a4,-590 # 80066000 <disk+0x2000>
  ...
  disk.free[i] = 1;
    80006276:	0005e797          	auipc	a5,0x5e
    8000627a:	d8a78793          	addi	a5,a5,-630 # 80064000 <disk>
  ...
  wakeup(&disk.free[0]);
    8000628a:	00060517          	auipc	a0,0x60
    8000628e:	d8e50513          	addi	a0,a0,-626 # 80066018 <disk+0x2018>
    80006292:	ffffc097          	auipc	ra,0xffffc
    80006296:	1a2080e7          	jalr	418(ra) # 80002434 <wakeup>
}
    ...
    800062a6:	4c650513          	addi	a0,a0,1222 # 80008768 <syscalls+0x348>
    800062aa:	ffffa097          	auipc	ra,0xffffa
    800062ae:	2a0080e7          	jalr	672(ra) # 8000054a <panic>
    panic("free_desc 2");
    800062b2:	00002517          	auipc	a0,0x2
    800062b6:	4c650513          	addi	a0,a0,1222 # 80008778 <syscalls+0x358>
    800062ba:	ffffa097          	auipc	ra,0xffffa
    800062be:	290080e7          	jalr	656(ra) # 8000054a <panic>
...
00000000800062c2 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800062d0:	4bc58593          	addi	a1,a1,1212 # 80008788 <syscalls+0x368>
    800062d4:	00060517          	auipc	a0,0x60
    800062d8:	e5450513          	addi	a0,a0,-428 # 80066128 <disk+0x2128>
    800062dc:	ffffb097          	auipc	ra,0xffffb
    800062e0:	89a080e7          	jalr	-1894(ra) # 80000b76 <initlock>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    8000633a:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47f9775f>
  ...
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
  ...
  memset(disk.pages, 0, sizeof(disk.pages));
    ...
    8000636c:	0005e517          	auipc	a0,0x5e
    80006370:	c9450513          	addi	a0,a0,-876 # 80064000 <disk>
    80006374:	ffffb097          	auipc	ra,0xffffb
    80006378:	98e080e7          	jalr	-1650(ra) # 80000d02 <memset>
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
    8000637c:	0005e717          	auipc	a4,0x5e
    80006380:	c8470713          	addi	a4,a4,-892 # 80064000 <disk>
    80006384:	00c75793          	srli	a5,a4,0xc
    80006388:	2781                	sext.w	a5,a5
    8000638a:	c0bc                	sw	a5,64(s1)
  disk.desc = (struct virtq_desc *) disk.pages;
    8000638c:	00060797          	auipc	a5,0x60
    80006390:	c7478793          	addi	a5,a5,-908 # 80066000 <disk+0x2000>
    80006394:	e398                	sd	a4,0(a5)
  disk.avail = (struct virtq_avail *)(disk.pages + NUM*sizeof(struct virtq_desc));
    80006396:	0005e717          	auipc	a4,0x5e
    8000639a:	cea70713          	addi	a4,a4,-790 # 80064080 <disk+0x80>
    8000639e:	e798                	sd	a4,8(a5)
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    800063a0:	0005f717          	auipc	a4,0x5f
    800063a4:	c6070713          	addi	a4,a4,-928 # 80065000 <disk+0x1000>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    80006436:	00060517          	auipc	a0,0x60
    8000643a:	cf250513          	addi	a0,a0,-782 # 80066128 <disk+0x2128>
    8000643e:	ffffa097          	auipc	ra,0xffffa
    80006442:	7c8080e7          	jalr	1992(ra) # 80000c06 <acquire>
  for(int i = 0; i < 3; i++){
    80006446:	4981                	li	s3,0
  for(int i = 0; i < NUM; i++){
    80006448:	44a1                	li	s1,8
      disk.free[i] = 0;
    8000644a:	0005ec17          	auipc	s8,0x5e
    8000644e:	bb6c0c13          	addi	s8,s8,-1098 # 80064000 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    80006472:	00060717          	auipc	a4,0x60
    80006476:	ba670713          	addi	a4,a4,-1114 # 80066018 <disk+0x2018>
  ...
  while(1){
    ...
    800064a8:	00060597          	auipc	a1,0x60
    800064ac:	c8058593          	addi	a1,a1,-896 # 80066128 <disk+0x2128>
    800064b0:	00060517          	auipc	a0,0x60
    800064b4:	b6850513          	addi	a0,a0,-1176 # 80066018 <disk+0x2018>
    800064b8:	ffffc097          	auipc	ra,0xffffc
    800064bc:	df8080e7          	jalr	-520(ra) # 800022b0 <sleep>
  for(int i = 0; i < 3; i++){
    800064c0:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    ...
    800064ca:	00060697          	auipc	a3,0x60
    800064ce:	b366b683          	ld	a3,-1226(a3) # 80066000 <disk+0x2000>
    800064d2:	96ba                	add	a3,a3,a4
    800064d4:	00069623          	sh	zero,12(a3)
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    800064d8:	0005e817          	auipc	a6,0x5e
    800064dc:	b2880813          	addi	a6,a6,-1240 # 80064000 <disk>
    800064e0:	00060697          	auipc	a3,0x60
    800064e4:	b2068693          	addi	a3,a3,-1248 # 80066000 <disk+0x2000>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006578:	00060917          	auipc	s2,0x60
    8000657c:	bb090913          	addi	s2,s2,-1104 # 80066128 <disk+0x2128>
  while(b->disk == 1) {
    ...
    8000658a:	d2a080e7          	jalr	-726(ra) # 800022b0 <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800065a2:	0005e797          	auipc	a5,0x5e
    800065a6:	a5e78793          	addi	a5,a5,-1442 # 80064000 <disk>
    800065aa:	97ba                	add	a5,a5,a4
    800065ac:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    800065b0:	00060997          	auipc	s3,0x60
    800065b4:	a5098993          	addi	s3,s3,-1456 # 80066000 <disk+0x2000>
  ...
  release(&disk.vdisk_lock);
    800065d8:	00060517          	auipc	a0,0x60
    800065dc:	b5050513          	addi	a0,a0,-1200 # 80066128 <disk+0x2128>
    800065e0:	ffffa097          	auipc	ra,0xffffa
    800065e4:	6da080e7          	jalr	1754(ra) # 80000cba <release>
}
  ...
  if(write)
    80006610:	0005e817          	auipc	a6,0x5e
    80006614:	9f080813          	addi	a6,a6,-1552 # 80064000 <disk>
  ...
  disk.desc[idx[0]].addr = (uint64) buf0;
    ...
    80006630:	00060697          	auipc	a3,0x60
    80006634:	9d068693          	addi	a3,a3,-1584 # 80066000 <disk+0x2000>
  ...
  disk.desc[idx[0]].next = idx[1];
    ...
    8000665e:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ff9700e>
  disk.desc[idx[1]].addr = (uint64) b->data;
  ...
  if(write)
    ...
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
    8000667c:	00060697          	auipc	a3,0x60
    80006680:	9846b683          	ld	a3,-1660(a3) # 80066000 <disk+0x2000>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    8000669a:	00060517          	auipc	a0,0x60
    8000669e:	a8e50513          	addi	a0,a0,-1394 # 80066128 <disk+0x2128>
    800066a2:	ffffa097          	auipc	ra,0xffffa
    800066a6:	564080e7          	jalr	1380(ra) # 80000c06 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    800066b8:	00060797          	auipc	a5,0x60
    800066bc:	94878793          	addi	a5,a5,-1720 # 80066000 <disk+0x2000>
    ...
    800066ce:	0005e917          	auipc	s2,0x5e
    800066d2:	93290913          	addi	s2,s2,-1742 # 80064000 <disk>
    800066d6:	00060497          	auipc	s1,0x60
    800066da:	92a48493          	addi	s1,s1,-1750 # 80066000 <disk+0x2000>
    __sync_synchronize();
    ...
    80006710:	d28080e7          	jalr	-728(ra) # 80002434 <wakeup>
  ...
  release(&disk.vdisk_lock);
    8000672c:	00060517          	auipc	a0,0x60
    80006730:	9fc50513          	addi	a0,a0,-1540 # 80066128 <disk+0x2128>
    80006734:	ffffa097          	auipc	ra,0xffffa
    80006738:	586080e7          	jalr	1414(ra) # 80000cba <release>
}
    ...
    8000674c:	0b050513          	addi	a0,a0,176 # 800087f8 <syscalls+0x3d8>
    80006750:	ffffa097          	auipc	ra,0xffffa
    80006754:	dfa080e7          	jalr	-518(ra) # 8000054a <panic>
	...
