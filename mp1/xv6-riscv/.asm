...
void f3(void *arg)
{
   ...
   c:	1800                	addi	s0,sp,48
    ...
    while (1) {
        printf("thread 3: %d\n", i++);
   e:	6489                	lui	s1,0x2
  10:	71048593          	addi	a1,s1,1808 # 2710 <__global_pointer$+0x12ff>
  14:	00001517          	auipc	a0,0x1
  18:	ba450513          	addi	a0,a0,-1116 # bb8 <thread_start_threading+0x34>
  1c:	00000097          	auipc	ra,0x0
  20:	756080e7          	jalr	1878(ra) # 772 <printf>
  24:	71148493          	addi	s1,s1,1809
  28:	00001997          	auipc	s3,0x1
  2c:	b9098993          	addi	s3,s3,-1136 # bb8 <thread_start_threading+0x34>
        if(i == 10005){
  30:	6909                	lui	s2,0x2
  32:	71590913          	addi	s2,s2,1813 # 2715 <__global_pointer$+0x1304>
            return;
            //thread_exit();
        }
        thread_yield();
  36:	00001097          	auipc	ra,0x1
  3a:	b08080e7          	jalr	-1272(ra) # b3e <thread_yield>
        printf("thread 3: %d\n", i++);
  3e:	85a6                	mv	a1,s1
...
void f2(void *arg)
{
  ...
  74:	b5850513          	addi	a0,a0,-1192 # bc8 <thread_start_threading+0x44>
  78:	00000097          	auipc	ra,0x0
  7c:	6fa080e7          	jalr	1786(ra) # 772 <printf>
  80:	4485                	li	s1,1
  82:	00001a17          	auipc	s4,0x1
  86:	b46a0a13          	addi	s4,s4,-1210 # bc8 <thread_start_threading+0x44>
        if (i == 10) {
  8a:	49a9                	li	s3,10
  ...
  94:	aae080e7          	jalr	-1362(ra) # b3e <thread_yield>
        printf("thread 2: %d\n",i++);
  ...
  b0:	98a080e7          	jalr	-1654(ra) # a36 <thread_exit>
...
void f1(void *arg)
{
 ...
 102:	ada50513          	addi	a0,a0,-1318 # bd8 <thread_start_threading+0x54>
 106:	00000097          	auipc	ra,0x0
 10a:	66c080e7          	jalr	1644(ra) # 772 <printf>
 10e:	06500493          	li	s1,101
 112:	00001a17          	auipc	s4,0x1
 116:	ac6a0a13          	addi	s4,s4,-1338 # bd8 <thread_start_threading+0x54>
        if (i == 110) {
 ...
 126:	a1c080e7          	jalr	-1508(ra) # b3e <thread_yield>
        printf("thread 1: %d\n", i++);
 ...
 142:	8f8080e7          	jalr	-1800(ra) # a36 <thread_exit>
...
int main(int argc, char **argv)
{
 ...
 16e:	a1a080e7          	jalr	-1510(ra) # b84 <thread_start_threading>
    printf("\nexited\n");
 172:	00001517          	auipc	a0,0x1
 176:	a7650513          	addi	a0,a0,-1418 # be8 <thread_start_threading+0x64>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e2:	72250513          	addi	a0,a0,1826 # c00 <digits>
 4e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ae:	656b8b93          	addi	s7,s7,1622 # c00 <digits>
 ...
 6ee:	50e90913          	addi	s2,s2,1294 # bf8 <thread_start_threading+0x74>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b6:	4667b783          	ld	a5,1126(a5) # c18 <freep>
 ...
 7e4:	00e6ea63          	bltu	a3,a4,7f8 <free+0x50>
{
 ...
 826:	3ef73b23          	sd	a5,1014(a4) # c18 <freep>
}
 82a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 858:	3c453503          	ld	a0,964(a0) # c18 <freep>
 ...
 880:	39c90913          	addi	s2,s2,924 # c18 <freep>
  if(p == (char*)-1)
 884:	5afd                	li	s5,-1
 886:	a88d                	j	8f8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 888:	00000797          	auipc	a5,0x0
 88c:	3a078793          	addi	a5,a5,928 # c28 <base>
 890:	00000717          	auipc	a4,0x0
 894:	38f73423          	sd	a5,904(a4) # c18 <freep>
 898:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8ba:	36a73123          	sd	a0,866(a4) # c18 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 9c4:	25470713          	addi	a4,a4,596 # c14 <id>
 9c8:	431c                	lw	a5,0(a4)
...
void thread_add_runqueue(struct thread *t){
 ...
 9f8:	22c7b783          	ld	a5,556(a5) # c20 <current_thread>
 9fc:	cb89                	beqz	a5,a0e <thread_add_runqueue+0x20>
        current_thread = t;
        t->previous = t->next = t;
    }
    else{
        // TODO
        struct thread *Head = current_thread->previous;
 9fe:	6fd8                	ld	a4,152(a5)
        Head->next = t;
 a00:	f348                	sd	a0,160(a4)
        t->previous = Head;
 a02:	ed58                	sd	a4,152(a0)
        current_thread->previous = t;
 a04:	efc8                	sd	a0,152(a5)
 ...
 a12:	20a7b923          	sd	a0,530(a5) # c20 <current_thread>
        t->previous = t->next = t;
 a16:	f148                	sd	a0,160(a0)
 a18:	ed48                	sd	a0,152(a0)
 a1a:	b7fd                	j	a08 <thread_add_runqueue+0x1a>

0000000000000a1c <schedule>:
...
void schedule(void){
 ...
 a26:	1fe78793          	addi	a5,a5,510 # c20 <current_thread>
 a2a:	6398                	ld	a4,0(a5)
 a2c:	7358                	ld	a4,160(a4)
 a2e:	e398                	sd	a4,0(a5)
}
 a30:	6422                	ld	s0,8(sp)
...
void thread_exit(void){
 ...
 a46:	1de7b783          	ld	a5,478(a5) # c20 <current_thread>
 a4a:	73c4                	ld	s1,160(a5)
 a4c:	04978063          	beq	a5,s1,a8c <thread_exit+0x56>
        // TODO
        struct thread *NEXT = current_thread->next;
        struct thread *PREV = current_thread->previous;
 a50:	6fd8                	ld	a4,152(a5)
        PREV->next = NEXT;
 a52:	f344                	sd	s1,160(a4)
        NEXT->previous = PREV;
 a54:	ecd8                	sd	a4,152(s1)
        free(current_thread->stack);
 a56:	6b88                	ld	a0,16(a5)
 a58:	00000097          	auipc	ra,0x0
 a5c:	d50080e7          	jalr	-688(ra) # 7a8 <free>
        free(current_thread);
 a60:	00000917          	auipc	s2,0x0
 a64:	1c090913          	addi	s2,s2,448 # c20 <current_thread>
 a68:	00093503          	ld	a0,0(s2)
 a6c:	00000097          	auipc	ra,0x0
 a70:	d3c080e7          	jalr	-708(ra) # 7a8 <free>
        current_thread = NEXT;
 a74:	00993023          	sd	s1,0(s2)
        dispatch();
 a78:	00000097          	auipc	ra,0x0
 a7c:	042080e7          	jalr	66(ra) # aba <dispatch>
 ...
 a8a:	8082                	ret
        free(current_thread->stack);
 a8c:	6b88                	ld	a0,16(a5)
 a8e:	00000097          	auipc	ra,0x0
 a92:	d1a080e7          	jalr	-742(ra) # 7a8 <free>
        free(current_thread);
 a96:	00000517          	auipc	a0,0x0
 a9a:	18a53503          	ld	a0,394(a0) # c20 <current_thread>
 a9e:	00000097          	auipc	ra,0x0
 aa2:	d0a080e7          	jalr	-758(ra) # 7a8 <free>
        longjmp(env_st, 1);
 aa6:	4585                	li	a1,1
 aa8:	00000517          	auipc	a0,0x0
 aac:	19050513          	addi	a0,a0,400 # c38 <env_st>
 ab0:	00000097          	auipc	ra,0x0
 ab4:	e9c080e7          	jalr	-356(ra) # 94c <longjmp>
}
 ab8:	b7e1                	j	a80 <thread_exit+0x4a>

0000000000000aba <dispatch>:
void dispatch(void){
 ...
 ac6:	15e7b783          	ld	a5,350(a5) # c20 <current_thread>
 aca:	0947a783          	lw	a5,148(a5)
 ace:	c385                	beqz	a5,aee <dispatch+0x34>
    longjmp(current_thread->env, 1);
 ad0:	4585                	li	a1,1
 ad2:	00000517          	auipc	a0,0x0
 ad6:	14e53503          	ld	a0,334(a0) # c20 <current_thread>
 ada:	02050513          	addi	a0,a0,32
 ade:	00000097          	auipc	ra,0x0
 ae2:	e6e080e7          	jalr	-402(ra) # 94c <longjmp>
}
 ae6:	60a2                	ld	ra,8(sp)
 ae8:	6402                	ld	s0,0(sp)
 ...
 af2:	1ba50513          	addi	a0,a0,442 # ca8 <env_tmp>
 af6:	00000097          	auipc	ra,0x0
 afa:	e1e080e7          	jalr	-482(ra) # 914 <setjmp>
 afe:	cd09                	beqz	a0,b18 <dispatch+0x5e>
        current_thread->fp(current_thread->arg);
 b00:	00000797          	auipc	a5,0x0
 b04:	1207b783          	ld	a5,288(a5) # c20 <current_thread>
 b08:	6398                	ld	a4,0(a5)
 b0a:	6788                	ld	a0,8(a5)
 b0c:	9702                	jalr	a4
        thread_exit();
 b0e:	00000097          	auipc	ra,0x0
 b12:	f28080e7          	jalr	-216(ra) # a36 <thread_exit>
 b16:	bf6d                	j	ad0 <dispatch+0x16>
            env_tmp->sp = (unsigned long)current_thread->stack_p;
 b18:	00000797          	auipc	a5,0x0
 b1c:	1087b783          	ld	a5,264(a5) # c20 <current_thread>
 b20:	6f9c                	ld	a5,24(a5)
 b22:	00000717          	auipc	a4,0x0
 b26:	1ef73723          	sd	a5,494(a4) # d10 <env_tmp+0x68>
            longjmp(env_tmp, 1);
 b2a:	4585                	li	a1,1
 b2c:	00000517          	auipc	a0,0x0
 b30:	17c50513          	addi	a0,a0,380 # ca8 <env_tmp>
 b34:	00000097          	auipc	ra,0x0
 b38:	e18080e7          	jalr	-488(ra) # 94c <longjmp>
 b3c:	b7d1                	j	b00 <dispatch+0x46>

0000000000000b3e <thread_yield>:
void thread_yield(void){
 ...
 b4a:	0da53503          	ld	a0,218(a0) # c20 <current_thread>
 b4e:	02050513          	addi	a0,a0,32
 b52:	00000097          	auipc	ra,0x0
 b56:	dc2080e7          	jalr	-574(ra) # 914 <setjmp>
 b5a:	c509                	beqz	a0,b64 <thread_yield+0x26>
}
 b5c:	60a2                	ld	ra,8(sp)
 b5e:	6402                	ld	s0,0(sp)
 ...
 b68:	0bc7b783          	ld	a5,188(a5) # c20 <current_thread>
 b6c:	4705                	li	a4,1
 b6e:	08e7aa23          	sw	a4,148(a5)
        schedule();
 b72:	00000097          	auipc	ra,0x0
 b76:	eaa080e7          	jalr	-342(ra) # a1c <schedule>
        dispatch();
 b7a:	00000097          	auipc	ra,0x0
 b7e:	f40080e7          	jalr	-192(ra) # aba <dispatch>
}
 b82:	bfe9                	j	b5c <thread_yield+0x1e>

0000000000000b84 <thread_start_threading>:
void thread_start_threading(void){
 ...
 b90:	0ac50513          	addi	a0,a0,172 # c38 <env_st>
 b94:	00000097          	auipc	ra,0x0
 b98:	d80080e7          	jalr	-640(ra) # 914 <setjmp>
 b9c:	c509                	beqz	a0,ba6 <thread_start_threading+0x22>
        schedule();
        dispatch();
    }
}
 ...
 baa:	e76080e7          	jalr	-394(ra) # a1c <schedule>
        dispatch();
 bae:	00000097          	auipc	ra,0x0
 bb2:	f0c080e7          	jalr	-244(ra) # aba <dispatch>
}
 bb6:	b7e5                	j	b9e <thread_start_threading+0x1a>
