...
void thrdstop_test1()
{
  ...
  48:	04852503          	lw	a0,72(a0) # 108c <main_id>
...
void f1( void *k )
{
  ...
  7a:	c50080e7          	jalr	-944(ra) # cc6 <thread_exit>
}
  7e:	60a2                	ld	ra,8(sp)
  80:	6402                	ld	s0,0(sp)
...
00000000000000b6 <test1>:
{
  ...
  dc:	faa7ac23          	sw	a0,-72(a5) # 1090 <startTime>
 ...
 16a:	e4250513          	addi	a0,a0,-446 # fa8 <thread_start_threading+0xb6>
 ...
 19e:	eea7a783          	lw	a5,-278(a5) # 1084 <thrdstop_test_time>
 1a2:	00001717          	auipc	a4,0x1
 1a6:	eee72703          	lw	a4,-274(a4) # 1090 <startTime>
 ...
 1b8:	e3450513          	addi	a0,a0,-460 # fe8 <thread_start_threading+0xf6>
 ...
 1e2:	d9a50513          	addi	a0,a0,-614 # f78 <thread_start_threading+0x86>
 ...
 218:	da450513          	addi	a0,a0,-604 # fb8 <thread_start_threading+0xc6>
 ...
 274:	d0850513          	addi	a0,a0,-760 # f78 <thread_start_threading+0x86>
 ...
 2b2:	d3250513          	addi	a0,a0,-718 # fe0 <thread_start_threading+0xee>
 ...
 2cc:	cb050513          	addi	a0,a0,-848 # f78 <thread_start_threading+0x86>
...
void test2()
{
 ...
 312:	be4080e7          	jalr	-1052(ra) # ef2 <thread_start_threading>
    printf("test2k=%d\n", test2k);
 316:	fec42583          	lw	a1,-20(s0)
 31a:	00001517          	auipc	a0,0x1
 31e:	cd650513          	addi	a0,a0,-810 # ff0 <thread_start_threading+0xfe>
 322:	00000097          	auipc	ra,0x0
 326:	644080e7          	jalr	1604(ra) # 966 <printf>
    printf("PASS 2\n", test2k);
 32a:	fec42583          	lw	a1,-20(s0)
 32e:	00001517          	auipc	a0,0x1
 332:	cd250513          	addi	a0,a0,-814 # 1000 <thread_start_threading+0x10e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	93e50513          	addi	a0,a0,-1730 # 1010 <digits>
 6da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7a2:	872b8b93          	addi	s7,s7,-1934 # 1010 <digits>
 ...
 8e2:	72a90913          	addi	s2,s2,1834 # 1008 <thread_start_threading+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 9aa:	6f27b783          	ld	a5,1778(a5) # 1098 <freep>
 ...
 9d8:	00e6ea63          	bltu	a3,a4,9ec <free+0x50>
{
 ...
 a1a:	68f73123          	sd	a5,1666(a4) # 1098 <freep>
}
 a1e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a4c:	65053503          	ld	a0,1616(a0) # 1098 <freep>
 ...
 a74:	62890913          	addi	s2,s2,1576 # 1098 <freep>
  if(p == (char*)-1)
 a78:	5afd                	li	s5,-1
 a7a:	a88d                	j	aec <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a7c:	00000797          	auipc	a5,0x0
 a80:	63c78793          	addi	a5,a5,1596 # 10b8 <base>
 a84:	00000717          	auipc	a4,0x0
 a88:	60f73a23          	sd	a5,1556(a4) # 1098 <freep>
 a8c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 aae:	5ea73723          	sd	a0,1518(a4) # 1098 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg, int execution_time_slot){
 ...
 bce:	4d67a783          	lw	a5,1238(a5) # 10a0 <is_thread_start>
 ...
 bd8:	4a07a783          	lw	a5,1184(a5) # 1074 <__time_slot_size>
...
void thread_add_runqueue(struct thread *t){
 ...
 c1a:	46270713          	addi	a4,a4,1122 # 1078 <id>
 c1e:	431c                	lw	a5,0(a4)
 ...
 c2c:	4807b783          	ld	a5,1152(a5) # 10a8 <current_thread>
 ...
 c58:	4497ba23          	sd	s1,1108(a5) # 10a8 <current_thread>
        current_thread->previous = t;
...
void schedule(void){
 ...
 c76:	42e7a783          	lw	a5,1070(a5) # 10a0 <is_thread_start>
 c7a:	c3b9                	beqz	a5,cc0 <schedule+0x54>
#elif ALG == FCFS
 ...
 c80:	43470713          	addi	a4,a4,1076 # 10b0 <RR_tick_passed>
 c84:	431c                	lw	a5,0(a4)
 c86:	2785                	addiw	a5,a5,1
 c88:	0007861b          	sext.w	a2,a5
 c8c:	c31c                	sw	a5,0(a4)
        if (current_thread->is_exited == 1 || current_thread->is_yield == 1 || RR_tick_passed >= 3){
 c8e:	00000797          	auipc	a5,0x0
 c92:	41a7b783          	ld	a5,1050(a5) # 10a8 <current_thread>
 c96:	0c07a683          	lw	a3,192(a5)
 c9a:	4705                	li	a4,1
 c9c:	00e68963          	beq	a3,a4,cae <schedule+0x42>
 ca0:	0bc7a683          	lw	a3,188(a5)
 ca4:	00e68563          	beq	a3,a4,cae <schedule+0x42>
 ca8:	4709                	li	a4,2
 caa:	00c75b63          	bge	a4,a2,cc0 <schedule+0x54>
            current_thread = current_thread->next;
 cae:	77dc                	ld	a5,168(a5)
 cb0:	00000717          	auipc	a4,0x0
 cb4:	3ef73c23          	sd	a5,1016(a4) # 10a8 <current_thread>
            RR_tick_passed = 0;
 cb8:	00000797          	auipc	a5,0x0
 cbc:	3e07ac23          	sw	zero,1016(a5) # 10b0 <RR_tick_passed>
            }
...
void thread_exit(void){
 ...
 cd2:	00000497          	auipc	s1,0x0
 cd6:	3d648493          	addi	s1,s1,982 # 10a8 <current_thread>
 cda:	609c                	ld	a5,0(s1)
 cdc:	4585                	li	a1,1
 cde:	0b07a503          	lw	a0,176(a5)
 ce2:	00000097          	auipc	ra,0x0
 ce6:	99c080e7          	jalr	-1636(ra) # 67e <thrdresume>
    struct thread* to_remove = current_thread;
 cea:	6084                	ld	s1,0(s1)
    printf("thread id %d exec %d ticks\n", to_remove->ID, uptime() - to_remove->start_time);
 cec:	0904a903          	lw	s2,144(s1)
 cf0:	00000097          	auipc	ra,0x0
 cf4:	97e080e7          	jalr	-1666(ra) # 66e <uptime>
 cf8:	0b84a603          	lw	a2,184(s1)
 cfc:	40c5063b          	subw	a2,a0,a2
 d00:	85ca                	mv	a1,s2
 d02:	00000517          	auipc	a0,0x0
 d06:	32650513          	addi	a0,a0,806 # 1028 <digits+0x18>
 d0a:	00000097          	auipc	ra,0x0
 d0e:	c5c080e7          	jalr	-932(ra) # 966 <printf>

    to_remove->is_exited = 1;
 d12:	4785                	li	a5,1
 d14:	0cf4a023          	sw	a5,192(s1)

    if(to_remove->next != to_remove){
 d18:	74dc                	ld	a5,168(s1)
 d1a:	02978e63          	beq	a5,s1,d56 <thread_exit+0x90>
        //Still more thread to execute
        schedule() ;
 d1e:	00000097          	auipc	ra,0x0
 d22:	f4e080e7          	jalr	-178(ra) # c6c <schedule>
        //Connect the remaining threads
        struct thread* to_remove_next = to_remove->next;
 d26:	74d8                	ld	a4,168(s1)
        to_remove_next->previous = to_remove->previous;
 d28:	70dc                	ld	a5,160(s1)
 d2a:	f35c                	sd	a5,160(a4)
        to_remove->previous->next = to_remove_next;
 d2c:	f7d8                	sd	a4,168(a5)


        //free pointers
        free(to_remove->stack);
 d2e:	6888                	ld	a0,16(s1)
 d30:	00000097          	auipc	ra,0x0
 d34:	c6c080e7          	jalr	-916(ra) # 99c <free>
        free(to_remove);
 d38:	8526                	mv	a0,s1
 d3a:	00000097          	auipc	ra,0x0
 d3e:	c62080e7          	jalr	-926(ra) # 99c <free>
        dispatch();
 d42:	00000097          	auipc	ra,0x0
 d46:	028080e7          	jalr	40(ra) # d6a <dispatch>
    }
    else{
 ...
 d5c:	37050513          	addi	a0,a0,880 # 10c8 <env_st>
 d60:	00000097          	auipc	ra,0x0
 d64:	de0080e7          	jalr	-544(ra) # b40 <longjmp>
}
 d68:	b7cd                	j	d4a <thread_exit+0x84>

0000000000000d6a <dispatch>:
void dispatch(void){
 ...
 d76:	00000497          	auipc	s1,0x0
 d7a:	3324b483          	ld	s1,818(s1) # 10a8 <current_thread>
 d7e:	09c4a783          	lw	a5,156(s1)
 d82:	cfb1                	beqz	a5,dde <dispatch+0x74>
 ...
 d8c:	2ec7a783          	lw	a5,748(a5) # 1074 <__time_slot_size>
 d90:	0b44a503          	lw	a0,180(s1)
 d94:	0005069b          	sext.w	a3,a0
 d98:	0007871b          	sext.w	a4,a5
 d9c:	00d75363          	bge	a4,a3,da2 <dispatch+0x38>
 da0:	853e                	mv	a0,a5
        thrdstop( next_time, current_thread->thrdstop_context_id, my_thrdstop_handler); // after next_time ticks, my_thrdstop_handler will be called.
 da2:	00000617          	auipc	a2,0x0
 da6:	09860613          	addi	a2,a2,152 # e3a <my_thrdstop_handler>
 daa:	2501                	sext.w	a0,a0
 dac:	00000097          	auipc	ra,0x0
 db0:	8ca080e7          	jalr	-1846(ra) # 676 <thrdstop>
        thrdresume(current_thread->thrdstop_context_id, 0);
 db4:	4581                	li	a1,0
 db6:	00000797          	auipc	a5,0x0
 dba:	2f27b783          	ld	a5,754(a5) # 10a8 <current_thread>
 dbe:	0b07a503          	lw	a0,176(a5)
 dc2:	00000097          	auipc	ra,0x0
 dc6:	8bc080e7          	jalr	-1860(ra) # 67e <thrdresume>
    thread_exit();
 dca:	00000097          	auipc	ra,0x0
 dce:	efc080e7          	jalr	-260(ra) # cc6 <thread_exit>
}
 ...
 dde:	4785                	li	a5,1
 de0:	08f4ae23          	sw	a5,156(s1)
        new_stack_p = (unsigned long) current_thread->stack_p;      
 de4:	0184b903          	ld	s2,24(s1)
        current_thread->thrdstop_context_id = thrdstop( __time_slot_size, -1, my_thrdstop_handler);
 de8:	00000617          	auipc	a2,0x0
 dec:	05260613          	addi	a2,a2,82 # e3a <my_thrdstop_handler>
 df0:	55fd                	li	a1,-1
 df2:	00000517          	auipc	a0,0x0
 df6:	28252503          	lw	a0,642(a0) # 1074 <__time_slot_size>
 dfa:	00000097          	auipc	ra,0x0
 dfe:	87c080e7          	jalr	-1924(ra) # 676 <thrdstop>
 e02:	0aa4a823          	sw	a0,176(s1)
        if( current_thread->thrdstop_context_id < 0 )
 e06:	00000797          	auipc	a5,0x0
 e0a:	2a27b783          	ld	a5,674(a5) # 10a8 <current_thread>
 e0e:	0b07a703          	lw	a4,176(a5)
 e12:	00074763          	bltz	a4,e20 <dispatch+0xb6>
 ...
 e1a:	6788                	ld	a0,8(a5)
 e1c:	9702                	jalr	a4
 e1e:	b775                	j	dca <dispatch+0x60>
            printf("error: number of threads may exceed\n");
 e20:	00000517          	auipc	a0,0x0
 e24:	22850513          	addi	a0,a0,552 # 1048 <digits+0x38>
 e28:	00000097          	auipc	ra,0x0
 e2c:	b3e080e7          	jalr	-1218(ra) # 966 <printf>
            exit(1);
 e30:	4505                	li	a0,1
 e32:	fffff097          	auipc	ra,0xfffff
 e36:	7a4080e7          	jalr	1956(ra) # 5d6 <exit>

0000000000000e3a <my_thrdstop_handler>:
void my_thrdstop_handler(void){
 ...
 e42:	00000717          	auipc	a4,0x0
 e46:	26673703          	ld	a4,614(a4) # 10a8 <current_thread>
 e4a:	0b472783          	lw	a5,180(a4)
 e4e:	00000697          	auipc	a3,0x0
 e52:	2266a683          	lw	a3,550(a3) # 1074 <__time_slot_size>
 e56:	9f95                	subw	a5,a5,a3
 e58:	0007869b          	sext.w	a3,a5
 e5c:	0af72a23          	sw	a5,180(a4)
    if( current_thread->remain_execution_time <= 0 )
 e60:	00d05e63          	blez	a3,e7c <my_thrdstop_handler+0x42>
        schedule();
 e64:	00000097          	auipc	ra,0x0
 e68:	e08080e7          	jalr	-504(ra) # c6c <schedule>
        dispatch();
 e6c:	00000097          	auipc	ra,0x0
 e70:	efe080e7          	jalr	-258(ra) # d6a <dispatch>
}
 e74:	60a2                	ld	ra,8(sp)
 e76:	6402                	ld	s0,0(sp)
 ...
 e80:	e4a080e7          	jalr	-438(ra) # cc6 <thread_exit>
 e84:	bfc5                	j	e74 <my_thrdstop_handler+0x3a>

0000000000000e86 <thread_yield>:
void thread_yield(void){
 ...
 e90:	00000497          	auipc	s1,0x0
 e94:	21848493          	addi	s1,s1,536 # 10a8 <current_thread>
 e98:	609c                	ld	a5,0(s1)
 e9a:	0b07a503          	lw	a0,176(a5)
 e9e:	fffff097          	auipc	ra,0xfffff
 ea2:	7e8080e7          	jalr	2024(ra) # 686 <cancelthrdstop>
    if( current_thread->is_yield == 0 )
 ea6:	609c                	ld	a5,0(s1)
 ea8:	0bc7a703          	lw	a4,188(a5)
 eac:	ef05                	bnez	a4,ee4 <thread_yield+0x5e>
        current_thread->remain_execution_time -= consume_ticks ;
 eae:	0b47a703          	lw	a4,180(a5)
 eb2:	40a7053b          	subw	a0,a4,a0
 eb6:	0005071b          	sext.w	a4,a0
 eba:	0aa7aa23          	sw	a0,180(a5)
        current_thread->is_yield = 1;
 ebe:	4685                	li	a3,1
 ec0:	0ad7ae23          	sw	a3,188(a5)
        if( current_thread->remain_execution_time <= 0 )
 ec4:	00e05b63          	blez	a4,eda <thread_yield+0x54>
            schedule();
 ec8:	00000097          	auipc	ra,0x0
 ecc:	da4080e7          	jalr	-604(ra) # c6c <schedule>
            dispatch();
 ed0:	00000097          	auipc	ra,0x0
 ed4:	e9a080e7          	jalr	-358(ra) # d6a <dispatch>
 ed8:	a801                	j	ee8 <thread_yield+0x62>
            thread_exit();
 eda:	00000097          	auipc	ra,0x0
 ede:	dec080e7          	jalr	-532(ra) # cc6 <thread_exit>
 ee2:	a019                	j	ee8 <thread_yield+0x62>
        current_thread->is_yield = 0;
 ee4:	0a07ae23          	sw	zero,188(a5)
}
...
0000000000000ef2 <thread_start_threading>:
void thread_start_threading(int time_slot_size){
 ...
 efe:	16a7ad23          	sw	a0,378(a5) # 1074 <__time_slot_size>
    
    struct thread* tmp_thread = current_thread;
 f02:	00000697          	auipc	a3,0x0
 f06:	1a66b683          	ld	a3,422(a3) # 10a8 <current_thread>
 f0a:	87b6                	mv	a5,a3
    while (tmp_thread != NULL)
 f0c:	cb91                	beqz	a5,f20 <thread_start_threading+0x2e>
    {
        tmp_thread->remain_execution_time *= time_slot_size;
 f0e:	0b47a703          	lw	a4,180(a5)
 f12:	02a7073b          	mulw	a4,a4,a0
 f16:	0ae7aa23          	sw	a4,180(a5)
        tmp_thread = tmp_thread->next;
 f1a:	77dc                	ld	a5,168(a5)
        if( tmp_thread == current_thread )
 f1c:	fef698e3          	bne	a3,a5,f0c <thread_start_threading+0x1a>
            break;
    }
 ...
 f24:	1a850513          	addi	a0,a0,424 # 10c8 <env_st>
 f28:	00000097          	auipc	ra,0x0
 f2c:	be0080e7          	jalr	-1056(ra) # b08 <setjmp>
    
    if(current_thread != NULL && r==0){
 f30:	00000797          	auipc	a5,0x0
 f34:	1787b783          	ld	a5,376(a5) # 10a8 <current_thread>
 f38:	c391                	beqz	a5,f3c <thread_start_threading+0x4a>
 f3a:	c509                	beqz	a0,f44 <thread_start_threading+0x52>
        schedule() ;
        is_thread_start = 1;
        dispatch();
    }
 ...
 f48:	d28080e7          	jalr	-728(ra) # c6c <schedule>
        is_thread_start = 1;
 f4c:	4785                	li	a5,1
 f4e:	00000717          	auipc	a4,0x0
 f52:	14f72923          	sw	a5,338(a4) # 10a0 <is_thread_start>
        dispatch();
 f56:	00000097          	auipc	ra,0x0
 f5a:	e14080e7          	jalr	-492(ra) # d6a <dispatch>
}
 f5e:	bff9                	j	f3c <thread_start_threading+0x4a>
